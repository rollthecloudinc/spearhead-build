...
function _document(injector) {
  ...
  if (config2 && config2.document) {
    ...
    document2 = _getDOM().createHtmlDocument();
  }
  _setDocument(document2);
  return document2;
}
...
var lib, Event_1, hasRequiredEvent, UIEvent_1, hasRequiredUIEvent, MouseEvent_1, hasRequiredMouseEvent, utils, config, hasRequiredConfig, hasRequiredUtils, EventTarget_1, hasRequiredEventTarget, LinkedList, hasRequiredLinkedList, NodeUtils, hasRequiredNodeUtils, Node_1, hasRequiredNode, NodeList_es6, hasRequiredNodeList_es6, NodeList_es5, hasRequiredNodeList_es5, NodeList_1, hasRequiredNodeList, ContainerNode_1, hasRequiredContainerNode, xmlnames, hasRequiredXmlnames, attributes, hasRequiredAttributes, FilteredElementList_1, hasRequiredFilteredElementList, DOMTokenList_1, hasRequiredDOMTokenList, select, hasRequiredSelect, ChildNode_1, hasRequiredChildNode, NonDocumentTypeChildNode_1, hasRequiredNonDocumentTypeChildNode, NamedNodeMap_1, hasRequiredNamedNodeMap, Element_1, hasRequiredElement, Leaf_1, hasRequiredLeaf, CharacterData_1, hasRequiredCharacterData, Text_1, hasRequiredText, Comment_1, hasRequiredComment, DocumentFragment_1, hasRequiredDocumentFragment, ProcessingInstruction_1, hasRequiredProcessingInstruction, NodeFilter_1, hasRequiredNodeFilter, NodeTraversal, hasRequiredNodeTraversal, TreeWalker_1, hasRequiredTreeWalker, NodeIterator_1, hasRequiredNodeIterator, URL_1, hasRequiredURL, CustomEvent_1, hasRequiredCustomEvent, events, hasRequiredEvents, htmlelts, style_parser, hasRequiredStyle_parser, CSSStyleDeclaration_1, hasRequiredCSSStyleDeclaration, URLUtils_1, hasRequiredURLUtils, defineElement, hasRequiredDefineElement, hasRequiredHtmlelts, svg, hasRequiredSvg, MutationConstants, hasRequiredMutationConstants, Document_1, hasRequiredDocument, DocumentType_1, hasRequiredDocumentType, HTMLParser_1, hasRequiredHTMLParser, DOMImplementation_1, hasRequiredDOMImplementation, Location_1, hasRequiredLocation, NavigatorID_1, hasRequiredNavigatorID, WindowTimers_1, hasRequiredWindowTimers, impl, hasRequiredImpl, Window_1, hasRequiredWindow, hasRequiredLib, libExports, index, DominoAdapter, INITIAL_CONFIG, BEFORE_APP_SERIALIZED, ENABLE_DOM_EMULATION, PlatformState, ServerXhr, SERVER_HTTP_PROVIDERS, RESOLVE_PROTOCOL, ServerPlatformLocation, ServerEventManagerPlugin, TRANSFER_STATE_STATUS, TRANSFER_STATE_SERIALIZATION_PROVIDERS, INTERNAL_SERVER_PLATFORM_PROVIDERS, SERVER_RENDER_PROVIDERS, PLATFORM_SERVER_PROVIDERS, ServerModule;
var init_server = __esm({
  "node_modules/@angular/platform-server/fesm2022/server.mjs"() {
    ...
    index = /* @__PURE__ */ getDefaultExportFromCjs(libExports);
    DominoAdapter = class _DominoAdapter extends _BrowserDomAdapter {
      static makeCurrent() {
        setDomTypes();
        _setRootDomAdapter(new _DominoAdapter());
      }
    ...
    INITIAL_CONFIG = new InjectionToken("Server.INITIAL_CONFIG");
    BEFORE_APP_SERIALIZED = new InjectionToken("Server.RENDER_MODULE_HOOK");
    ENABLE_DOM_EMULATION = new InjectionToken("ENABLE_DOM_EMULATION");
    PlatformState = class _PlatformState {
      _doc;
      /* @internal */
      ...
      static \u0275fac = function PlatformState_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || _PlatformState)(i0.\u0275\u0275inject(DOCUMENT));
      };
      ...
      \u0275loadImpl() {
        return __async(this, null, function* () {
          if (!this.xhrImpl) {
            const {
              default: xhr
            } = yield import("./chunk-UOSPLARK.mjs");
            this.xhrImpl = xhr;
          }
        });
      }
    ...
    RESOLVE_PROTOCOL = "resolve:";
    ServerPlatformLocation = class _ServerPlatformLocation {
      _doc;
      href = "/";
      hostname = "/";
      protocol = "/";
      ...
      static \u0275fac = function ServerPlatformLocation_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || _ServerPlatformLocation)(i0.\u0275\u0275inject(DOCUMENT), i0.\u0275\u0275inject(INITIAL_CONFIG, 8));
      };
      static \u0275prov = /* @__PURE__ */ i0.\u0275\u0275defineInjectable({
    ...
    ServerEventManagerPlugin = class _ServerEventManagerPlugin extends EventManagerPlugin {
      doc;
      constructor(doc) {
        super(doc);
        this.doc = doc;
      ...
      static \u0275fac = function ServerEventManagerPlugin_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || _ServerEventManagerPlugin)(i0.\u0275\u0275inject(DOCUMENT));
      };
      static \u0275prov = /* @__PURE__ */ i0.\u0275\u0275defineInjectable({
    ...
    TRANSFER_STATE_STATUS = new InjectionToken(typeof ngDevMode === "undefined" || ngDevMode ? "TRANSFER_STATE_STATUS" : "", {
      providedIn: "root",
      factory: () => ({
        serialized: false
      })
    ...
    ServerModule = class _ServerModule {
...
import { makeEnvironmentProviders, InjectionToken as InjectionToken2, ApplicationRef, \u0275startMeasuring as _startMeasuring2, \u0275stopMeasuring as _stopMeasuring2, \u0275IS_HYDRATION_DOM_REUSE_ENABLED as _IS_HYDRATION_DOM_REUSE_ENABLED, \u0275annotateForHydration as _annotateForHydration, CSP_NONCE, APP_ID as APP_ID2, \u0275SSR_CONTENT_INTEGRITY_MARKER as _SSR_CONTENT_INTEGRITY_MARKER, Renderer2, Version } from "@angular/core";
...
function prepareForHydration(platformState, applicationRef) {
  ...
  _startMeasuring2(measuringLabel);
  ...
  if (eventTypesToReplay.regular.size || eventTypesToReplay.capture.size) {
    insertEventRecordScript(environmentInjector.get(APP_ID2), doc, eventTypesToReplay, environmentInjector.get(CSP_NONCE, null));
  } else {
    removeEventDispatchScript(doc);
  }
  _stopMeasuring2(measuringLabel);
}
function appendSsrContentIntegrityMarker(doc) {
  const comment2 = doc.createComment(_SSR_CONTENT_INTEGRITY_MARKER);
...
var EVENT_DISPATCH_SCRIPT_ID, DEFAULT_SERVER_CONTEXT, SERVER_CONTEXT, VERSION;
var init_platform_server = __esm({
  "node_modules/@angular/platform-server/fesm2022/platform-server.mjs"() {
    init_server();
    init_server();
    EVENT_DISPATCH_SCRIPT_ID = "ng-event-dispatch-contract";
    DEFAULT_SERVER_CONTEXT = "other";
    SERVER_CONTEXT = new InjectionToken2("SERVER_CONTEXT");
    VERSION = new Version("20.3.9");
  }
});
...
var access, copyFile, cp, open, opendir, rename, truncate, rm, rmdir, mkdir, readdir, readlink, symlink, lstat, stat, link, unlink, chmod, lchmod, lchown, chown, utimes, lutimes, realpath, mkdtemp, writeFile$1, appendFile, readFile$1, statfs, readFile, writeFile, _DRIVE_LETTER_START_RE, _UNC_REGEX, _IS_ABSOLUTE_RE, _DRIVE_LETTER_RE, _ROOT_FOLDER_RE, sep, delimiter, normalize, join, resolve, isAbsolute, toNamespacedPath, _EXTNAME_RE, extname, relative, dirname, format, basename, parse$3, path, _path, _pathModule, picocolors_browser, hasRequiredPicocolors_browser, _nodeResolve_empty, _nodeResolve_empty$1, require$$2, cssSyntaxError, hasRequiredCssSyntaxError, stringifier, hasRequiredStringifier, stringify_1, hasRequiredStringify, symbols, hasRequiredSymbols, node, hasRequiredNode$1, comment, hasRequiredComment2, declaration, hasRequiredDeclaration, container, hasRequiredContainer$1, atRule, hasRequiredAtRule, document, hasRequiredDocument2, nonSecure, hasRequiredNonSecure, previousMap, hasRequiredPreviousMap, input, hasRequiredInput, root, hasRequiredRoot, list_1, hasRequiredList, rule, hasRequiredRule, fromJSON_1, hasRequiredFromJSON, mapGenerator, hasRequiredMapGenerator, tokenize, hasRequiredTokenize, parser, hasRequiredParser, parse_1, hasRequiredParse, warning, hasRequiredWarning, result, hasRequiredResult, warnOnce, hasRequiredWarnOnce, lazyResult, hasRequiredLazyResult, noWorkResult, hasRequiredNoWorkResult, processor, hasRequiredProcessor, postcss_1, hasRequiredPostcss, postcssExports, postcss, stringify, parse$2, dist, Container, Node$1, hasRequiredNode2, hasRequiredContainer, parsers, hasRequiredParsers, hasRequiredDist, distExports, mediaParser, boolbase$1, hasRequiredBoolbase, boolbaseExports, boolbase, SelectorType, AttributeAction, reName, reEscape, CharCode, actionTypes, unpackPseudos, pseudosToPseudoElements, stripQuotesFromPseudos, ElementType, Root, Text$1, Directive, Comment$1, Script, Style, Tag, CDATA$1, Doctype, Node, DataNode, Text, Comment, ProcessingInstruction, NodeWithChildren, CDATA, Document, Element, defaultOpts, DomHandler, xmlReplacer, xmlCodeMap, getCodePoint, escapeAttribute, escapeText, elementNames, attributeNames, unencodedElements, singleTag, foreignModeIntegrationPoints, foreignElements, Checks, DocumentPosition, MEDIA_KEYS_STRING, MEDIA_KEYS_INT, DomUtils, reChars, caseInsensitiveAttributes, attributeRules, textControl, aliases, whitespace, ZERO, NINE, filters, isDocumentWhiteSpace, pseudos, PLACEHOLDER_ELEMENT, is, subselects, DESCENDANT_TOKEN, FLEXIBLE_DESCENDANT_TOKEN, SCOPE_TOKEN, defaultEquals, defaultOptions, selectAll, selectOne, htmlDecodeTree, xmlDecodeTree, _a, decodeMap, fromCodePoint, CharCodes$1, TO_LOWER_BIT, BinTrieFlags, EntityDecoderState, DecodingMode, EntityDecoder, CharCodes, State, QuoteType, Sequences, Tokenizer, formTags, pTag, tableSectionTags, ddtTags, rtpTags, openImpliesClose, voidElements, foreignContextElements, htmlIntegrationElements, reNameEnd, Parser, picocolors_browserExports, pc, MEDIA_TYPES, MEDIA_KEYWORDS, MEDIA_FEATURES, classCache, idCache, extended, selectorTokensCache, LOG_LEVELS, defaultLogger, removePseudoClassesAndElementsPattern, implicitUniversalPattern, emptyCombinatorPattern, removeTrailingCommasPattern, Beasties;
var init_beasties = __esm({
  "node_modules/@angular/ssr/third_party/beasties/index.js"() {
    ...
    readlink = notImplemented("fs.readlink");
    symlink = notImplemented("fs.symlink");
    lstat = notImplemented("fs.lstat");
    ...
    realpath = notImplemented("fs.realpath");
    mkdtemp = notImplemented("fs.mkdtemp");
    writeFile$1 = notImplemented("fs.writeFile");
    appendFile = notImplemented("fs.appendFile");
    readFile$1 = notImplemented("fs.readFile");
    notImplemented("fs.watch");
    statfs = notImplemented("fs.statfs");
    callbackify(access);
    ...
    callbackify(opendir);
    callbackify(readdir);
    readFile = callbackify(readFile$1);
    ...
    callbackify(unlink);
    callbackify(utimes);
    writeFile = callbackify(writeFile$1);
    callbackify(statfs);
    ...
    _pathModule = __spreadProps(__spreadValues({}, _path), {
      platform: "posix",
      posix: void 0,
      win32: void 0
    });
    ...
    _nodeResolve_empty = {};
    _nodeResolve_empty$1 = /* @__PURE__ */ Object.freeze({
      __proto__: null,
      default: _nodeResolve_empty
    });
    require$$2 = /* @__PURE__ */ getAugmentedNamespace(_nodeResolve_empty$1);
    symbols = {};
    postcssExports = requirePostcss();
    postcss = /* @__PURE__ */ getDefaultExportFromCjs2(postcssExports);
    stringify = postcss.stringify;
    postcss.fromJSON;
    postcss.plugin;
    parse$2 = postcss.parse;
    postcss.list;
    postcss.document;
    postcss.comment;
    postcss.atRule;
    ...
    mediaParser = /* @__PURE__ */ getDefaultExportFromCjs2(distExports);
    boolbaseExports = requireBoolbase();
    boolbase = /* @__PURE__ */ getDefaultExportFromCjs2(boolbaseExports);
    ...
    DomUtils = /* @__PURE__ */ Object.freeze({
      __proto__: null,
    ...
    selectAll = getSelectorFunc((query, elems, options) => query === boolbaseExports.falseFunc || !elems || elems.length === 0 ? [] : findAll(query, elems, options));
    selectOne = getSelectorFunc((query, elems, options) => query === boolbaseExports.falseFunc || !elems || elems.length === 0 ? null : findOne(query, elems, options));
    ...
    picocolors_browserExports = /* @__PURE__ */ requirePicocolors_browser();
    pc = /* @__PURE__ */ getDefaultExportFromCjs2(picocolors_browserExports);
    MEDIA_TYPES = /* @__PURE__ */ new Set(["all", "print", "screen", "speech"]);
    MEDIA_KEYWORDS = /* @__PURE__ */ new Set(["and", "not", ","]);
    MEDIA_FEATURES = new Set(
      [
        "width",
        "aspect-ratio",
        "color",
    ...
    idCache = null;
    extended = false;
    selectorTokensCache = /* @__PURE__ */ new Map();
    LOG_LEVELS = ["trace", "debug", "info", "warn", "error", "silent"];
    defaultLogger = {
      trace(msg) {
        console.trace(msg);
      },
    ...
    removePseudoClassesAndElementsPattern = /(?<!\\)::?[a-z-]+(?:\(.+\))?/gi;
    implicitUniversalPattern = /([>+~])\s*(?!\1)([>+~])/g;
    emptyCombinatorPattern = /([>+~])\s*(?=\1|$)/g;
    removeTrailingCommasPattern = /\(\s*,|,\s*\)/g;
    Beasties = class {
...
import { \u0275Console as _Console, ApplicationRef as ApplicationRef2, InjectionToken as InjectionToken3, provideEnvironmentInitializer, inject as inject2, makeEnvironmentProviders as makeEnvironmentProviders2, \u0275ENABLE_ROOT_COMPONENT_BOOTSTRAP as _ENABLE_ROOT_COMPONENT_BOOTSTRAP, Compiler, createEnvironmentInjector, EnvironmentInjector, runInInjectionContext, \u0275resetCompiledComponents as _resetCompiledComponents, REQUEST, REQUEST_CONTEXT, RESPONSE_INIT, LOCALE_ID } from "@angular/core";
import { ActivatedRoute, Router, ROUTES, \u0275loadChildren as _loadChildren } from "@angular/router";
import { PlatformLocation as PlatformLocation2, APP_BASE_HREF } from "@angular/common";
  ...
  return __async(this, null, function* () {
    ...
    try {
      ...
      if (isNgModule(bootstrap)) {
        ...
        applicationRef = moduleRef.injector.get(ApplicationRef2);
      } else {
      ...
      if (!routerIsProvided) {
        ...
        hasNavigationError = false;
        const { pathname, search, hash } = envInjector.get(PlatformLocation2);
...
function getRoutesFromAngularRouterConfig(bootstrap, document2, url, invokeGetPrerenderParams = false, includePrerenderFallbackRoutes = true, entryPointToBrowserMapping = void 0) {
  return __async(this, null, function* () {
    ...
    try {
      ...
      yield applicationRef.whenStable();
      const errors = [];
      const rawBaseHref = injector.get(APP_BASE_HREF, null, { optional: true }) ?? injector.get(PlatformLocation2).getBaseHrefFromDOM();
...
var ServerAssets, IGNORED_LOGS, Console, angularAppManifest, angularAppEngineManifest, MATRIX_PARAMS_REGEX, ServerRenderingFeatureKind, RenderMode, PrerenderFallback, SERVER_ROUTES_CONFIG, RouteTree, MODULE_PRELOAD_MAX, CATCH_ALL_REGEXP, URL_PARAMETER_REGEXP, VALID_REDIRECT_RESPONSE_CODES, Hooks, ServerRouter, MEDIA_SET_HANDLER_PATTERN, CSP_MEDIA_ATTR, LINK_LOAD_SCRIPT_CONTENT, BeastiesBase, InlineCriticalCssProcessor, LRUCache, MAX_INLINE_CSS_CACHE_ENTRIES, SERVER_CONTEXT_VALUE, AngularServerApp, angularServerApp, AngularAppEngine;
var init_ssr = __esm({
  "node_modules/@angular/ssr/fesm2022/ssr.mjs"() {
    init_platform_server();
    init_beasties();
    ServerAssets = class {
      manifest;
      /**
    ...
    IGNORED_LOGS = /* @__PURE__ */ new Set(["Angular is running in development mode."]);
    Console = class extends _Console {
      /**
    ...
    SERVER_ROUTES_CONFIG = new InjectionToken3("SERVER_ROUTES_CONFIG");
    RouteTree = class _RouteTree {
      /**
    ...
    MODULE_PRELOAD_MAX = 10;
    CATCH_ALL_REGEXP = /\/(\*\*)$/;
    URL_PARAMETER_REGEXP = /(?<!\\):([^/]+)/g;
    VALID_REDIRECT_RESPONSE_CODES = /* @__PURE__ */ new Set([301, 302, 303, 307, 308]);
    Hooks = class {
      /**
    ...
    ServerRouter = class _ServerRouter {
      routeTree;
      /**
    ...
    MEDIA_SET_HANDLER_PATTERN = /^this\.media=["'](.*)["'];?$/;
    CSP_MEDIA_ATTR = "ngCspMedia";
    LINK_LOAD_SCRIPT_CONTENT = /* @__PURE__ */ (() => `(() => {
  ...
  documentElement.addEventListener('load', listener, true);
    ...
    BeastiesBase = class extends Beasties {
    };
    InlineCriticalCssProcessor = class _InlineCriticalCssProcessor extends BeastiesBase {
      readFile;
      outputPath;
    ...
    MAX_INLINE_CSS_CACHE_ENTRIES = 50;
    SERVER_CONTEXT_VALUE = {
      [RenderMode.Prerender]: "ssg",
      [RenderMode.Server]: "ssr",
      [RenderMode.Client]: ""
    };
    AngularServerApp = class {
      options;
      /**
    ...
    AngularAppEngine = class _AngularAppEngine {
      /**
...
//# sourceMappingURL=chunk-YZ5DX444.mjs.map
