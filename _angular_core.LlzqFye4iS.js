...
function Ki(e) { if (e.index < e.removes.length) {
    ...
    return e.stack.length === 0 ? null : (e.removes = e.stack.pop(), e.index = e.stack.pop(), Ki(e)); }
...
function nS(e, t, n, o) { let r = e ? ["ng-version", "20.3.7"] : LN(t.selectors[0]), i = null, s = null, a = 0; if (n)
    for (let u of n)
