import { a as A } from "@nf-internal/chunk-63HOYYOF";
import { a as T } from "@nf-internal/chunk-YACJ2ZK5";
import { b as I } from "@nf-internal/chunk-F5JC75QQ";
import { a as O, b as w, e as M, f as S, g as k, h as u } from "@nf-internal/chunk-IAJTM7NZ";
import { f as x, g as D } from "@nf-internal/chunk-OA2EVVL5";
...
var Ie = new b("MAT_SELECT_CONFIG"), Te = { provide: Q, deps: [], useFactory: De }, Y = new b("MatSelectTrigger"), v = class {
    ...
    class r {
        ...
        _idGenerator = s(ie);
        _renderer = s($);
        _parentFormField = s(D, { optional: !0 });
        ...
        _scrollOptionIntoView(e) { let i = this.options.toArray()[e]; if (i) {
            let a = this.panel.nativeElement, n = S(e, this.options, this.optionGroups), l = i._getHostElement();
            e === 0 && n === 1 ? a.scrollTop = 0 : a.scrollTop = k(l.offsetTop, l.offsetHeight, a.scrollTop, a.offsetHeight);
        } }
        ...
        valueChange = new _;
        constructor() { let e = s(I), i = s(ue, { optional: !0 }), a = s(_e, { optional: !0 }), n = s(new Z("tabindex"), { optional: !0 }); this.ngControl && (this.ngControl.valueAccessor = this), this._defaultOptions?.typeaheadDebounceInterval != null && (this.typeaheadDebounceInterval = this._defaultOptions.typeaheadDebounceInterval), this._errorStateTracker = new T(e, this.ngControl, a, i, this.stateChanges), this._scrollStrategy = this._scrollStrategyFactory(), this.tabIndex = n == null ? 0 : parseInt(n) || 0, this.id = this.id; }
        ...
        static \u0275cmp = t.\u0275\u0275defineComponent({ type: r, selectors: [["mat-select"]], contentQueries: function (i, a, n) { if (i & 1 && (t.\u0275\u0275contentQuery(n, Y, 5), t.\u0275\u0275contentQuery(n, M, 5), t.\u0275\u0275contentQuery(n, w, 5)), i & 2) {
                let l;
...
//# sourceMappingURL=chunk-EUKZKSDT.js.map
