...
import { Validators as g, NG_VALUE_ACCESSOR as C, NG_VALIDATORS as w, ReactiveFormsModule as T, FormsModule as b } from "@angular/forms";
import * as l from "angular-split";
import { AngularSplitModule as M } from "angular-split";
import { MaterialModule as k } from "@rollthecloudinc/material";
import { NgxJsonViewerModule as E } from "ngx-json-viewer";
import * as _ from "ngx-markdown";
import { MarkdownModule as j } from "ngx-markdown";
import * as v from "@rollthecloudinc/utils";
import { UtilsModule as I } from "@rollthecloudinc/utils";
import { distinctUntilChanged as D, debounceTime as N, map as O } from "rxjs/operators";
...
var c = class {
    ...
    ngOnInit() { this.contentForm.get("content").valueChanges.pipe(D(), N(500), O(e => this.tokens !== void 0 ? this.replaceTokens(e) : e)).subscribe(e => { this.preview = e; }), this.contentForm.get("contentType").valueChanges.subscribe(e => { this.isMarkdown = e === "text/markdown"; }); }
...
//# sourceMappingURL=_rollthecloudinc_snippet.Wky_WjU2eU.js.map
