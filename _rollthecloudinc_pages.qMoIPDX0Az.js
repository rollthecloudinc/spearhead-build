import { a as ui } from "@nf-internal/chunk-CAFTJBEE";
import { a as W } from "@nf-internal/chunk-7XNIKSHD";
import { a as Ct } from "@nf-internal/chunk-SMWSTNHZ";
import { a as _, b as S, h as pi, k as _t } from "@nf-internal/chunk-GL2BOVXA";
import * as e from "@angular/core";
import { EventEmitter as E, forwardRef as Y, InjectionToken as mi } from "@angular/core";
import * as v from "@angular/common";
import { CommonModule as gi } from "@angular/common";
import * as se from "@angular/router";
import { UrlSegment as ot, RouterModule as fi } from "@angular/router";
import * as l from "@angular/forms";
import { UntypedFormArray as q, UntypedFormControl as p, Validators as g, NG_VALUE_ACCESSOR as Ae, NG_VALIDATORS as ze, FormsModule as hi, ReactiveFormsModule as vi } from "@angular/forms";
import * as Gt from "ngx-markdown";
import { MarkdownModule as bi, MarkdownComponent as yi } from "ngx-markdown";
import * as Be from "angular-split";
import { AngularSplitModule as _i } from "angular-split";
import * as he from "ngx-dropzone";
import { NgxDropzoneModule as Ci } from "ngx-dropzone";
import { MaterialModule as Si } from "@rollthecloudinc/material";
import { NgxJsonViewerModule as xi } from "ngx-json-viewer";
import * as At from "@rollthecloudinc/ngx-angular-query-builder";
import { NgxAngularQueryBuilderModule as wi } from "@rollthecloudinc/ngx-angular-query-builder";
import * as ut from "@rollthecloudinc/media";
import { MEDIA_SETTINGS as Pi, MediaFile as Fi, MediaModule as $i } from "@rollthecloudinc/media";
import * as X from "@rollthecloudinc/utils";
import { SITE_NAME as Le, UtilsModule as Ii, EMBEDDABLE_COMPONENT as it } from "@rollthecloudinc/utils";
...
import { AttributeValue as ae, AttributeTypes as ie, Attribute as zt, ATTRIBUTE_WIDGET as Bt, AttributesModule as Mi } from "@rollthecloudinc/attributes";
import * as Lt from "@rollthecloudinc/layout";
import { GridLayoutComponent as Ei, SplitLayoutComponent as Di, LayoutModule as Ri } from "@rollthecloudinc/layout";
import * as mt from "@rollthecloudinc/rest";
import { RestSourceFormComponent as qt, RestModule as ji } from "@rollthecloudinc/rest";
import * as qe from "@rollthecloudinc/snippet";
import { Snippet as St, SnippetModule as Oi } from "@rollthecloudinc/snippet";
import * as ve from "@rollthecloudinc/content";
import { ContentBinding as Ue, ContentPluginEditorOptions as le, ContentPlugin as $e, CONTENT_PLUGIN as de } from "@rollthecloudinc/content";
import * as G from "@rollthecloudinc/context";
import { InlineContext as ue, ContextFormComponent as ki, ContextPlugin as Ie, ResolvedContextPlugin as Ni, ContextModule as Vi } from "@rollthecloudinc/context";
import { DisplayGrid as Gi, GridType as Ai, GridsterModule as zi } from "angular-gridster2";
...
import * as He from "@angular/material/grid-list";
import * as Z from "@angular/material/list";
import * as B from "@angular/material/tabs";
import { Observable as ke, of as f, Subject as z, BehaviorSubject as J, combineLatest as fe, forkJoin as Qe, iif as we, from as Bi, merge as Ht } from "rxjs";
import { map as m, switchMap as b, tap as F, filter as I, debounceTime as pe, delay as Re, take as V, withLatestFrom as xt, distinctUntilChanged as gt, defaultIfEmpty as ft, skip as Li, catchError as qi } from "rxjs/operators";
import * as Qt from "@rollthecloudinc/datasource";
import { Dataset as H, Rest as me, SelectMapping as Wt, SelectOption as Ui, DatasourcePlugin as Hi, DatasourceModule as Qi } from "@rollthecloudinc/datasource";
var Ke = pi(ui(), 1);
import * as y from "@rollthecloudinc/panels";
import { PropertiesFormPayload as xe, PanelPropsFormPayload as Jt, PanePropsFormPayload as Kt, PaneState as Fe, LayoutSetting as O, Pane as j, PanelPage as ye, PanelPageStateSlice as Ne, selectDataset as je, Panel as We, FormDatasource as st, StylePlugin as lt, PanelPageForm as Ve, PaneDatasourceService as Yt, PanelStyleRendererBaseComponent as Wi, PanelPageSelector as wt, PanelPageState as Pt, PanelState as Ji, STYLE_PLUGIN as De, PanelsModule as Ki } from "@rollthecloudinc/panels";
import { PersistenceFormPayload as nt, PersistenceDialogComponent as Yi } from "@rollthecloudinc/refinery";
import * as Je from "@rollthecloudinc/rules";
import * as L from "@angular/material/button";
import * as P from "@angular/material/input";
import { InteractionsFormPayload as rt, InteractionsDialogComponent as Xi } from "@rollthecloudinc/detour";
...
import { createSelector as Ft, select as K } from "@ngrx/store";
import * as T from "@ngrx/data";
import * as Zt from "@angular/cdk/drag-drop";
import { getRouterSelectors as ct } from "@ngrx/router-store";
import * as Te from "@rollthecloudinc/crud";
import { CrudAdaptorPlugin as Zi } from "@rollthecloudinc/crud";
import * as Me from "@rollthecloudinc/render";
import { RenderModule as en } from "@rollthecloudinc/render";
import * as ht from "@rollthecloudinc/durl";
import * as U from "@angular/material/autocomplete";
import * as vt from "@angular/material/checkbox";
import * as Ye from "@angular/material/select";
import * as Xe from "@angular/material/radio";
import * as Ze from "@rollthecloudinc/dparam";
import { ParamPlugin as tn, Param as $t, DparamModule as nn } from "@rollthecloudinc/dparam";
...
function un(r, d) { }
var mn = ["contentEditor"], tt = r => ({ settings: r }), gn = r => ({ visible: r });
function fn(r, d) { r & 1 && e.\u0275\u0275elementContainer(0); }
function hn(r, d) { if (r & 1) {
    let t = e.\u0275\u0275getCurrentView();
...
function xn(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "li"), e.\u0275\u0275text(1), e.\u0275\u0275template(2, _n, 3, 4, "span", 23)(3, Sn, 2, 4, "ul", 23), e.\u0275\u0275elementEnd()), r & 2) {
...
var Tn = ["extraActionsArea"], Mn = ["contextsMenuTpl"], En = ["editablePaneTpl"], Dn = ["panes"], ni = r => ({ nested: r });
function Rn(r, d) { }
function jn(r, d) { if (r & 1) {
    let t = e.\u0275\u0275getCurrentView();
    e.\u0275\u0275elementStart(0, "form", 7), e.\u0275\u0275listener("ngSubmit", function () { e.\u0275\u0275restoreView(t); let n = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(n.submit()); }), e.\u0275\u0275elementContainerStart(1), e.\u0275\u0275template(2, Rn, 0, 0, "ng-template", 8), e.\u0275\u0275elementContainerEnd(), e.\u0275\u0275elementEnd();
} if (r & 2) {
    let t = e.\u0275\u0275nextContext();
    e.\u0275\u0275property("formGroup", t.contentForm)("ngClass", e.\u0275\u0275pureFunction1(2, ni, t.nested));
} }
function On(r, d) { }
function kn(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "div", 9), e.\u0275\u0275elementContainerStart(1), e.\u0275\u0275template(2, On, 0, 0, "ng-template", 8), e.\u0275\u0275elementContainerEnd(), e.\u0275\u0275elementEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext();
    e.\u0275\u0275property("formGroup", t.contentForm)("ngClass", e.\u0275\u0275pureFunction1(2, ni, t.nested));
} }
function Nn(r, d) { r & 1 && e.\u0275\u0275element(0, "div", 12); }
function Vn(r, d) { if (r & 1) {
    let t = e.\u0275\u0275getCurrentView();
    e.\u0275\u0275elementStart(0, "classifieds-ui-editable-pane", 10), e.\u0275\u0275listener("delete", function () { let n = e.\u0275\u0275restoreView(t), a = n.i, o = n.j, s = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(s.onDeletePane(a, o)); })("rules", function () { let n = e.\u0275\u0275restoreView(t), a = n.i, o = n.j, s = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(s.onRulesPane(a, o)); })("nestedUpdate", function (n) { let a = e.\u0275\u0275restoreView(t), o = a.i, s = a.j, c = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(c.onNestedUpdate(n, o, s)); })("rendererOverride", function () { let n = e.\u0275\u0275restoreView(t), a = n.i, o = n.j, s = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(s.onOverrideRenderer(a, o)); })("removeRendererOverride", function () { let n = e.\u0275\u0275restoreView(t), a = n.i, o = n.j, s = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(s.onRemoveOverrideRenderer(a, o)); })("edit", function () { let n = e.\u0275\u0275restoreView(t), a = n.i, o = n.j, s = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(s.onPaneEdit(a, o)); })("props", function () { let n = e.\u0275\u0275restoreView(t), a = n.i, o = n.j, s = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(s.editPaneProps(a, o)); })("delete", function () { let n = e.\u0275\u0275restoreView(t), a = n.i, o = n.j, s = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(s.onPaneDelete(a, o)); }), e.\u0275\u0275template(1, Nn, 1, 0, "div", 11), e.\u0275\u0275elementEnd();
} if (r & 2) {
...
function Gn(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "button", 13), e.\u0275\u0275text(1, "( x )"), e.\u0275\u0275elementEnd()), r & 2) {
    e.\u0275\u0275nextContext();
...
function Hn(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "div"), e.\u0275\u0275template(1, Un, 1, 0, "ng-container", 5), e.\u0275\u0275elementEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext().$implicit;
    e.\u0275\u0275nextContext(2);
    let i = e.\u0275\u0275reference(3);
    e.\u0275\u0275advance(), e.\u0275\u0275property("ngTemplateOutlet", i)("ngTemplateOutletContext", e.\u0275\u0275pureFunction1(2, tt, t.attributes));
} }
function Qn(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "div"), e.\u0275\u0275template(1, Ln, 2, 1, "span", 3)(2, qn, 3, 4, "span", 3)(3, Hn, 2, 4, "div", 3), e.\u0275\u0275elementEnd()), r & 2) {
    let t = d.$implicit;
...
function Wn(r, d) { if (r & 1 && e.\u0275\u0275template(0, Qn, 4, 3, "div", 6), r & 2) {
    let t = d.settings;
    e.\u0275\u0275property("ngForOf", t);
} }
function Jn(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "div"), e.\u0275\u0275template(1, Bn, 1, 0, "ng-container", 5)(2, Wn, 1, 1, "ng-template", null, 1, e.\u0275\u0275templateRefExtractor), e.\u0275\u0275elementEnd()), r & 2) {
...
function Kn(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "div", 7), e.\u0275\u0275element(1, "classifieds-ui-attributes-builder", 8), e.\u0275\u0275elementEnd()), r & 2) {
...
function Yn(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "div"), e.\u0275\u0275template(1, Jn, 4, 4, "div", 3)(2, Kn, 2, 3, "div", 4), e.\u0275\u0275elementEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext();
    e.\u0275\u0275advance(), e.\u0275\u0275property("ngIf", t.displayType == "page"), e.\u0275\u0275advance(), e.\u0275\u0275property("ngIf", t.displayType == "form");
} }
function Xn(r, d) { if (r & 1 && e.\u0275\u0275element(0, "classifieds-ui-snippet-pane-renderer", 9), r & 2) {
    let t = e.\u0275\u0275nextContext();
...
var er = ["img"];
function tr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "mat-option", 26), e.\u0275\u0275text(1), e.\u0275\u0275elementEnd()), r & 2) {
    let t = d.$implicit;
    e.\u0275\u0275property("value", t), e.\u0275\u0275advance(), e.\u0275\u0275textInterpolate(t);
} }
function ir(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "div")(1, "mat-form-field", 23)(2, "mat-label"), e.\u0275\u0275text(3, "Pane"), e.\u0275\u0275elementEnd(), e.\u0275\u0275elementStart(4, "mat-select", 24), e.\u0275\u0275template(5, tr, 2, 2, "mat-option", 25), e.\u0275\u0275elementEnd()()()), r & 2) {
    let t = d.index, i = e.\u0275\u0275nextContext(2);
    e.\u0275\u0275advance(), e.\u0275\u0275property("formGroupName", t), e.\u0275\u0275advance(4), e.\u0275\u0275property("ngForOf", i.panes);
} }
function nr(r, d) { if (r & 1) {
    let t = e.\u0275\u0275getCurrentView();
    e.\u0275\u0275elementStart(0, "div", 20)(1, "button", 21), e.\u0275\u0275listener("click", function () { e.\u0275\u0275restoreView(t); let n = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(n.addPane()); }), e.\u0275\u0275text(2, "Add Pane"), e.\u0275\u0275elementEnd(), e.\u0275\u0275elementStart(3, "div"), e.\u0275\u0275template(4, ir, 6, 2, "div", 22), e.\u0275\u0275elementEnd()();
} if (r & 2) {
    let t = e.\u0275\u0275nextContext();
    e.\u0275\u0275advance(4), e.\u0275\u0275property("ngForOf", t.bindings.controls);
} }
function rr(r, d) { r & 1 && (e.\u0275\u0275elementStart(0, "div", 27)(1, "mat-form-field"), e.\u0275\u0275element(2, "input", 28), e.\u0275\u0275elementEnd(), e.\u0275\u0275elementStart(3, "mat-form-field"), e.\u0275\u0275element(4, "input", 29), e.\u0275\u0275elementEnd(), e.\u0275\u0275elementStart(5, "mat-form-field"), e.\u0275\u0275element(6, "input", 30), e.\u0275\u0275elementEnd(), e.\u0275\u0275elementStart(7, "div")(8, "mat-checkbox", 31), e.\u0275\u0275text(9, "Multiple"), e.\u0275\u0275elementEnd()(), e.\u0275\u0275elementStart(10, "mat-form-field"), e.\u0275\u0275element(11, "input", 32), e.\u0275\u0275elementEnd()()); }
function ar(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "mat-option", 8), e.\u0275\u0275text(1), e.\u0275\u0275elementEnd()), r & 2) {
    let t = d.$implicit;
    e.\u0275\u0275property("value", t.value), e.\u0275\u0275advance(), e.\u0275\u0275textInterpolate(t.label);
} }
function or(r, d) { if (r & 1 && (e.\u0275\u0275elementContainerStart(0), e.\u0275\u0275elementStart(1, "mat-form-field")(2, "mat-label"), e.\u0275\u0275text(3), e.\u0275\u0275elementEnd(), e.\u0275\u0275elementStart(4, "mat-select", 6), e.\u0275\u0275template(5, ar, 2, 2, "mat-option", 7), e.\u0275\u0275elementEnd()(), e.\u0275\u0275elementContainerEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext();
    e.\u0275\u0275advance(3), e.\u0275\u0275textInterpolate(t.label), e.\u0275\u0275advance(2), e.\u0275\u0275property("ngForOf", t.options);
} }
function sr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "mat-radio-button", 8), e.\u0275\u0275text(1), e.\u0275\u0275elementEnd()), r & 2) {
    let t = d.$implicit;
    e.\u0275\u0275property("value", t.value), e.\u0275\u0275advance(), e.\u0275\u0275textInterpolate(t.label);
} }
function lr(r, d) { if (r & 1 && (e.\u0275\u0275elementContainerStart(0), e.\u0275\u0275elementStart(1, "div")(2, "label"), e.\u0275\u0275text(3), e.\u0275\u0275elementEnd(), e.\u0275\u0275elementStart(4, "mat-radio-group", 6), e.\u0275\u0275template(5, sr, 2, 2, "mat-radio-button", 7), e.\u0275\u0275elementEnd()(), e.\u0275\u0275elementContainerEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext();
    e.\u0275\u0275advance(3), e.\u0275\u0275textInterpolate(t.label), e.\u0275\u0275advance(2), e.\u0275\u0275property("ngForOf", t.options);
} }
function cr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "div")(1, "div", 10)(2, "mat-checkbox", 11), e.\u0275\u0275text(3), e.\u0275\u0275elementEnd()()()), r & 2) {
    let t = d.$implicit, i = d.index;
    e.\u0275\u0275advance(), e.\u0275\u0275property("formGroupName", i), e.\u0275\u0275advance(2), e.\u0275\u0275textInterpolate(t.label);
} }
function dr(r, d) { if (r & 1 && (e.\u0275\u0275elementContainerStart(0), e.\u0275\u0275elementStart(1, "div")(2, "div", 2), e.\u0275\u0275template(3, cr, 4, 2, "div", 9), e.\u0275\u0275elementEnd()(), e.\u0275\u0275elementContainerEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext();
    e.\u0275\u0275advance(3), e.\u0275\u0275property("ngForOf", t.options);
} }
function pr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "mat-option", 8), e.\u0275\u0275text(1), e.\u0275\u0275elementEnd()), r & 2) {
    let t = d.$implicit;
    e.\u0275\u0275property("value", t), e.\u0275\u0275advance(), e.\u0275\u0275textInterpolate(t.label);
} }
function ur(r, d) { if (r & 1) {
    let t = e.\u0275\u0275getCurrentView();
    e.\u0275\u0275elementContainerStart(0), e.\u0275\u0275elementStart(1, "mat-form-field"), e.\u0275\u0275element(2, "input", 12), e.\u0275\u0275elementStart(3, "mat-autocomplete", 13, 0), e.\u0275\u0275listener("optionSelected", function (n) { e.\u0275\u0275restoreView(t); let a = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(a.onOptionSelected(n)); }), e.\u0275\u0275template(5, pr, 2, 2, "mat-option", 7), e.\u0275\u0275elementEnd()(), e.\u0275\u0275elementContainerEnd();
} if (r & 2) {
...
function fr(r, d) { if (r & 1 && e.\u0275\u0275element(0, "classifieds-ui-render-pane", 4), r & 2) {
...
function hr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "mat-tab"), e.\u0275\u0275template(1, fr, 1, 3, "ng-template", 3), e.\u0275\u0275element(2, "classifieds-ui-render-pane", 4), e.\u0275\u0275elementEnd()), r & 2) {
    let t = d.index, i = e.\u0275\u0275nextContext(2);
...
function vr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "mat-tab-group", 1), e.\u0275\u0275template(1, hr, 3, 3, "mat-tab", 2), e.\u0275\u0275elementEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext();
    e.\u0275\u0275advance(), e.\u0275\u0275property("for", t.panes.length / 2);
} }
function br(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "mat-tab", 6), e.\u0275\u0275element(1, "classifieds-ui-render-pane", 4), e.\u0275\u0275elementEnd()), r & 2) {
    let t = d.$implicit;
    e.\u0275\u0275advance(), e.\u0275\u0275property("pluginName", t.contentPlugin)("settings", t.settings)("contexts", t.contexts);
} }
function yr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "mat-tab-group", 1), e.\u0275\u0275template(1, br, 2, 3, "mat-tab", 5), e.\u0275\u0275elementEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext();
    e.\u0275\u0275advance(), e.\u0275\u0275property("ngForOf", t.panes);
} }
function _r(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "div", 2), e.\u0275\u0275element(1, "classifieds-ui-render-pane", 3), e.\u0275\u0275elementEnd()), r & 2) {
    let t = d.$implicit;
...
function Cr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "th", 7), e.\u0275\u0275text(1), e.\u0275\u0275elementEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext().$implicit;
    e.\u0275\u0275advance(), e.\u0275\u0275textInterpolate(t);
} }
function Sr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "td", 8), e.\u0275\u0275text(1), e.\u0275\u0275elementEnd()), r & 2) {
    let t = d.$implicit, i = e.\u0275\u0275nextContext().$implicit, n = e.\u0275\u0275nextContext();
    e.\u0275\u0275advance(), e.\u0275\u0275textInterpolate(n.rowData(i, t));
} }
function xr(r, d) { if (r & 1 && (e.\u0275\u0275elementContainerStart(0, 4), e.\u0275\u0275template(1, Cr, 2, 1, "th", 5)(2, Sr, 2, 1, "td", 6), e.\u0275\u0275elementContainerEnd()), r & 2) {
    let t = d.$implicit;
    e.\u0275\u0275property("matColumnDef", t);
} }
function wr(r, d) { r & 1 && e.\u0275\u0275element(0, "tr", 9); }
function Pr(r, d) { r & 1 && e.\u0275\u0275element(0, "tr", 10); }
var Fr = { GridLayout: { entityName: "GridLayout" }, PanelPageForm: { crud: { panelpageform_serialize: { plugins: { idb_keyval: { params: { prefix: "panelpageform__" } } } } } } }, Ge = (() => { class r {
    ...
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-content-selector"]], viewQuery: function (i, n) { if (i & 1 && e.\u0275\u0275viewQuery(Ge, 7), i & 2) {
            let a;
            e.\u0275\u0275queryRefresh(a = e.\u0275\u0275loadQuery()) && (n.selectionHost = a.first);
        } }, standalone: !1, decls: 10, vars: 6, consts: [[1, "content-selector-wrapper"], [3, "selectedIndex"], ["mat-list-item", "", "mat-list-item", "", 3, "click", 4, "ngFor", "ngForOf"], ["classifiedsUiContentSelectionHost", ""], ["mat-list-item", "", "mat-list-item", "", 3, "click"], ["mat-line", ""]], template: function (i, n) { i & 1 && (e.\u0275\u0275elementStart(0, "div", 0)(1, "mat-tab-group", 1)(2, "mat-tab")(3, "mat-nav-list"), e.\u0275\u0275template(4, sn, 3, 1, "a", 2), e.\u0275\u0275pipe(5, "async"), e.\u0275\u0275pipe(6, "keyvalue"), e.\u0275\u0275elementEnd()(), e.\u0275\u0275elementStart(7, "mat-tab"), e.\u0275\u0275elementContainerStart(8), e.\u0275\u0275template(9, ln, 0, 0, "ng-template", 3), e.\u0275\u0275elementContainerEnd(), e.\u0275\u0275elementEnd()()()), i & 2 && (e.\u0275\u0275advance(), e.\u0275\u0275property("selectedIndex", n.selectedIndex), e.\u0275\u0275advance(3), e.\u0275\u0275property("ngForOf", e.\u0275\u0275pipeBind1(6, 4, e.\u0275\u0275pipeBind1(5, 2, n.contentPlugins)))); }, dependencies: [v.NgForOf, He.MatLine, Z.MatNavList, Z.MatListItem, B.MatTab, B.MatTabGroup, Ge, v.AsyncPipe, v.KeyValuePipe], styles: [".content-selector-wrapper[_ngcontent-%COMP%]     .mat-mdc-tab-header{display:none}"] }); }
} return r; })(), ne = (() => { class r {
    constructor(t, i) { this.attributeSerializer = t, this.tokenizrService = i, this.types = ["text/markdown", "text/html"]; }
    handleFile(t) { return new ke(i => { let n = new FileReader; n.onload = () => { i.next(this.buildSettings(new St({ contentType: t.type, content: `${n.result}` }))), i.complete(); }, n.readAsText(t); }); }
    ...
    isData(t) { return !1; }
    getBindings(t, i, n) { return i === "context" ? this.toObject(t).pipe(m(a => this.tokenizrService.discoverTokens(a.content).map(s => new Ue({ id: s, type: "context" })))) : f([]); }
    ...
    constructor(t, i, n, a) { this.hostEl = t, this.handler = i, this.tokenizerService = n, this.markdownService = a, this.contexts = [], this.afterContentInit$ = new z, this.content = "", this.content$ = new J(""), this.settings$ = new J([]), this.snippet$ = new J(void 0), this.resolvedContext$ = new J(void 0), this.docRendered$ = new z, this.contentSub = fe([this.afterContentInit$, this.content$, this.snippet$, this.docRendered$]).subscribe(([o, s, c]) => { c && c.jsScript && c.jsScript !== "" && setTimeout(() => this.appendScript(c.jsScript)); }), this.renderContentSub = fe([this.settings$, this.resolvedContext$]).pipe(b(([o, s]) => this.handler.toObject(o)), b(o => this.resolveContexts().pipe(m(s => [o, s])))).subscribe(c => _t(this, [c], function* ([o, s]) { s !== void 0 && (this.tokens = s), this.contentType = o.contentType, this.snippet$.next(o); let u = this.replaceTokens(o.content), C; o.contentType && o.contentType.indexOf("markdown") !== -1 ? C = yield Promise.resolve(this.markdownService.parse(u)) : C = u, this.content$.next(C); })); }
    ngOnInit() { }
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(e.ElementRef), e.\u0275\u0275directiveInject(ne), e.\u0275\u0275directiveInject(k.TokenizerService), e.\u0275\u0275directiveInject(Gt.MarkdownService)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-snippet-pane-renderer"]], inputs: { settings: "settings", contexts: "contexts", tokens: "tokens", resolvedContext: "resolvedContext" }, standalone: !1, features: [e.\u0275\u0275NgOnChangesFeature], decls: 2, vars: 2, consts: [[3, "content", "docRendered", 4, "ngIf"], [3, "docRendered", "content"]], template: function (i, n) { i & 1 && e.\u0275\u0275template(0, cn, 2, 3, "classifieds-ui-dynamic-content-viewer", 0)(1, dn, 2, 3, "classifieds-ui-dynamic-content-viewer", 0), i & 2 && (e.\u0275\u0275property("ngIf", n.contentType == "text/markdown"), e.\u0275\u0275advance(), e.\u0275\u0275property("ngIf", n.contentType == "text/html")); }, dependencies: [v.NgIf, X.DynamicContentViewer, v.AsyncPipe], encapsulation: 2 }); }
} return r; })(), re = (() => { class r {
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(Ut), e.\u0275\u0275directiveInject(y.StylePluginManager), e.\u0275\u0275directiveInject(be.MatBottomSheetRef), e.\u0275\u0275directiveInject(h.MatDialog), e.\u0275\u0275directiveInject(e.ComponentFactoryResolver), e.\u0275\u0275directiveInject(l.UntypedFormBuilder)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-style-selector"]], viewQuery: function (i, n) { if (i & 1 && e.\u0275\u0275viewQuery(Ge, 7), i & 2) {
            let a;
            e.\u0275\u0275queryRefresh(a = e.\u0275\u0275loadQuery()) && (n.selectionHost = a.first);
        } }, standalone: !1, decls: 10, vars: 6, consts: [[1, "style-selector-wrapper"], [3, "selectedIndex"], ["mat-list-item", "", "mat-list-item", "", 3, "click", 4, "ngFor", "ngForOf"], ["classifiedsUiContentSelectionHost", ""], ["mat-list-item", "", "mat-list-item", "", 3, "click"], ["mat-line", ""]], template: function (i, n) { i & 1 && (e.\u0275\u0275elementStart(0, "div", 0)(1, "mat-tab-group", 1)(2, "mat-tab")(3, "mat-nav-list"), e.\u0275\u0275template(4, pn, 3, 1, "a", 2), e.\u0275\u0275pipe(5, "async"), e.\u0275\u0275pipe(6, "keyvalue"), e.\u0275\u0275elementEnd()(), e.\u0275\u0275elementStart(7, "mat-tab"), e.\u0275\u0275elementContainerStart(8), e.\u0275\u0275template(9, un, 0, 0, "ng-template", 3), e.\u0275\u0275elementContainerEnd(), e.\u0275\u0275elementEnd()()()), i & 2 && (e.\u0275\u0275advance(), e.\u0275\u0275property("selectedIndex", n.selectedIndex), e.\u0275\u0275advance(3), e.\u0275\u0275property("ngForOf", e.\u0275\u0275pipeBind1(6, 4, e.\u0275\u0275pipeBind1(5, 2, n.stylePlugins)))); }, dependencies: [v.NgForOf, He.MatLine, Z.MatNavList, Z.MatListItem, B.MatTab, B.MatTabGroup, Ge, v.AsyncPipe, v.KeyValuePipe], styles: [".style-selector-wrapper[_ngcontent-%COMP%]     .mat-mdc-tab-header{display:none}"] }); }
} return r; })(), Mr = (() => { class r {
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(A), e.\u0275\u0275directiveInject(h.MatDialogRef), e.\u0275\u0275directiveInject(l.UntypedFormBuilder), e.\u0275\u0275directiveInject(G.InlineContextResolverService), e.\u0275\u0275directiveInject(Je.RulesParserService)); }; }
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(A), e.\u0275\u0275directiveInject(h.MatDialogRef), e.\u0275\u0275directiveInject(l.UntypedFormBuilder)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-context-dialog"]], viewQuery: function (i, n) { if (i & 1 && e.\u0275\u0275viewQuery(ki, 5), i & 2) {
            let a;
    ...
    constructor(t, i, n) { this.data = t, this.dialogRef = i, this.fb = n, this.propsForm = this.fb.group({ name: this.fb.control(this.data.props.name), label: this.fb.control(this.data.props.label) }); }
    ngOnInit() { }
    submit() { this.dialogRef.close(new Kt(this.propsForm.value)); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(A), e.\u0275\u0275directiveInject(h.MatDialogRef), e.\u0275\u0275directiveInject(l.UntypedFormBuilder)); }; }
    ...
    resolve(t, i) { let n = c => c.entities, a = ({ id: c }) => Ft(n, u => u[c] ? u[c] : void 0), o = ({ id: c, path: u }) => Ft(a({ id: c }), C => Ke.JSONPath({ path: u, json: C })), s = "$." + i.selectionPath.map((c, u) => `${(u + 1) % 2 === 0 ? "panes" : (u === 0 ? "" : "nestedPage.") + "panels"}[${c}]`).join("."); return this.entityCollectionService.collection$.pipe(K(o({ id: i.id, path: s })), m(c => c && Array.isArray(c) && c.length !== 0 ? c[0] : this.defaultPaneState(i.value ? i.value : {})), m(c => this.attributeSerializer.deserialize(c.state)), m(c => c ? c.root ? c.root : c : {}), F(c => { console.log(`resolved panestate[id=${i.id}]${s}`), console.log(c); })); }
    defaultPaneState(t) { return new Fe({ state: this.attributeSerializer.serialize(t, "root") }); }
    ...
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-editable-pane"]], viewQuery: function (i, n) { if (i & 1 && (e.\u0275\u0275viewQuery(Et, 5), e.\u0275\u0275viewQuery(mn, 5)), i & 2) {
            let a;
            ...
            e.\u0275\u0275template(0, yn, 18, 13, "div", 5)(1, wn, 1, 1, "ng-template", null, 0, e.\u0275\u0275templateRefExtractor)(3, Fn, 5, 7, "ng-template", null, 1, e.\u0275\u0275templateRefExtractor), e.\u0275\u0275elementStart(5, "mat-menu", null, 2)(7, "button", 6), e.\u0275\u0275listener("click", function () { return e.\u0275\u0275restoreView(a), e.\u0275\u0275resetView(n.onEditClick()); }), e.\u0275\u0275text(8, "Edit"), e.\u0275\u0275elementEnd(), e.\u0275\u0275elementStart(9, "button", 6), e.\u0275\u0275listener("click", function () { return e.\u0275\u0275restoreView(a), e.\u0275\u0275resetView(n.onPropsClick()); }), e.\u0275\u0275text(10, "Props"), e.\u0275\u0275elementEnd(), e.\u0275\u0275elementStart(11, "button", 7), e.\u0275\u0275listener("click", function () { return e.\u0275\u0275restoreView(a), e.\u0275\u0275resetView(n.onRulesClick()); }), e.\u0275\u0275text(12, "Rules"), e.\u0275\u0275elementEnd(), e.\u0275\u0275template(13, $n, 2, 1, "button", 8)(14, In, 2, 0, "button", 9), e.\u0275\u0275elementStart(15, "button", 10), e.\u0275\u0275listener("click", function () { return e.\u0275\u0275restoreView(a), e.\u0275\u0275resetView(n.onDeleteClick()); }), e.\u0275\u0275text(16, "Delete"), e.\u0275\u0275elementEnd()();
        } if (i & 2) {
    ...
    constructor(t, i, n, a, o, s, c, u, C, x, D, N, ee, M) { this.siteName = t, this.cpm = i, this.spm = n, this.lpm = a, this.cxtm = o, this.fb = s, this.bs = c, this.dialog = u, this.panelHandler = C, this.tokenizerService = x, this.componentFactoryResolver = D, this.pageBuilderFacade = N, this.paneStateContextResolver = ee, this.panelsContextService = M, this.submitted = new E, this.nestedUpdate = new E, this.delete = new E, this.rules = new E, this.props = new E, this.savable = !0, this.nested = !1, this.locked = !1, this.pageBuilder = !1, this.contexts = [], this.contentAdded = new z, this.contentAdddedSub = this.contentAdded.subscribe(([R, Se]) => { this.resolvePaneContexts(R, Se); }), this.dashboard = [], this.pageProperties = new xe, this.persistence = new nt, this.interactions = new rt, this.layoutSetting = new O, this.rowSettings = [], this.ancestory$ = new J([]), this.onTouched = () => { }, this.contentForm = this.fb.group({ name: this.fb.control(""), title: this.fb.control(""), layoutType: this.fb.control("split", g.required), displayType: this.fb.control("page", g.required), panels: this.fb.array([]) }), this.options = { gridType: Ai.Fit, displayGrid: Gi.Always, pushItems: !0, draggable: { enabled: !0 }, resizable: { enabled: !0 }, mobileBreakpoint: 0, itemChangeCallback: (R, Se) => { }, itemInitCallback: (R, Se) => { if (this.nested && R.y !== 0) {
            let Ee = this.gridLayout.grid.findIndex(ce => ce.x === R.x && ce.y === R.y && ce.cols === R.cols && ce.rows === R.rows);
    ...
    ngOnInit() { this.contentForm.valueChanges.pipe(I(() => this.nested), pe(500)).subscribe(() => { this.nestedUpdate.emit(this.packageFormData()); }), this.contentForm.get("layoutType").valueChanges.pipe(I(t => t === "gridless"), Re(1)).subscribe(t => { this.panels.length === 0 && this.panels.push(this.fb.group({ name: new p(""), label: new p(""), stylePlugin: new p(""), styleTitle: new p(""), settings: new q([]), panes: this.fb.array([]), columnSetting: this.fb.group({ settings: this.fb.array([]) }) })); }), this.contentForm.valueChanges.pipe(I(() => !this.nested), pe(500)).subscribe(() => { let t = this.packageFormData(); this.pageBuilderFacade.setPage(t); }); }
    ...
    addContent(t) { console.log(this.panels.at(t)), this.pageBuilderFacade.getPage$.pipe(b(i => this.panelsContextService.allActivePageContexts({ panelPage: i })), V(1)).subscribe(i => { this.bs.open($r, { data: { panelForm: this.panels.at(t), panelIndex: t, contexts: [...this.rootContext ? [this.rootContext] : [], ...this.contexts, ...i] } }); }); }
    editPanelProps(t) { let i = this.panels.at(t).get("name"), n = this.panels.at(t).get("label"); this.dialog.open(Dr, { data: { props: new Jt({ name: i.value, label: n.value }) } }).afterClosed().subscribe(a => { a && (i.setValue(a.name), n.setValue(a.label)); }); }
    editPaneProps(t, i) { let n = this.panelPane(t, i).get("name"), a = this.panelPane(t, i).get("label"); this.dialog.open(Rr, { data: { props: new Kt({ name: n.value, label: a.value }) } }).afterClosed().subscribe(o => { o && (n.setValue(o.name), a.setValue(o.label)); }); }
    applyStyle(t) { this.bs.open(Tr, { data: { panelForm: this.panels.controls[t], panelIndex: t, contexts: this.contexts } }); }
    removeStyle(t) { this.panels.controls[t].get("stylePlugin").setValue(""), this.panels.controls[t].get("styleTitle").setValue(""); }
    onItemAdded() { console.log("item added"), this.panels.push(this.fb.group({ name: new p(""), label: new p(""), stylePlugin: new p(""), styleTitle: new p(""), settings: new q([]), panes: this.fb.array([]), columnSetting: this.fb.group({ settings: this.fb.array([]) }) })), this.nested && this.gridLayout !== void 0 && setTimeout(() => { this.paneContainers.forEach((t, i) => { this.gridLayout.setItemContentHeight(i, t.nativeElement.offsetHeight); }); }), this.panelPanes(this.panels.length - 1).valueChanges.pipe(I(() => this.nested && this.gridLayout !== void 0), pe(5), Re(1)).subscribe((t => () => { let i = this.paneContainers.find((n, a) => a === t); this.gridLayout.setItemContentHeight(t, i.nativeElement.offsetHeight); })(this.panels.length - 1)), this.layoutEditorRef && (this.layoutEditorRef.instance.columnSettings = this.columnSettings); }
    ...
    onOverrideRenderer(t, i) { let n = new j(this.panelPane(t, i).value); this.dialog.open(Ir, { data: { panelFormGroup: this.panels.at(t), paneIndex: i, pane: n } }); }
    ...
    onDeleteClick() { this.delete.emit(); }
    onRulesClick() { this.rules.emit(); }
    onPropertiesClick() { this.props.emit(), this.dialog.open(Er, { data: { props: this.pageProperties } }).afterClosed().subscribe(t => { t && (this.pageProperties = new xe(_({}, t)), this.contentForm.get("name").setValue(t.name), this.contentForm.get("title").setValue(t.title)); }); }
    onRulesPane(t, i) { let n = new j(this.panelPane(t, i).value), a = this.panelPane(t, i).get("rule").value !== "" ? this.panelPane(t, i).get("rule").value : void 0, [o] = this.editablePanes.filter((s, c) => s.name === n.name); this.pageBuilderFacade.getPage$.pipe(F(() => { this.pageBuilderFacade.setSelectionPath([...this.ancestory, t, i]); }), b(s => this.panelsContextService.allActivePageContexts({ panelPage: s })), b(s => this.dialog.open(Mr, { data: { rule: a, contexts: [...o.rootContext ? [o.rootContext] : this.rootContext ? [this.rootContext] : [], ...this.contexts, ...s] } }).afterClosed()), V(1)).subscribe(s => { this.panelPane(t, i).get("rule").setValue(s || a || void 0); }); }
    onDeletePane(t, i) { console.log(`delete nested pane: ${t} | ${i}`); }
    onAddContextClick() { let t = this.packageFormData(); this.pageBuilderFacade.setPage(t), this.dialog.open(Tt, { data: {} }).afterClosed().subscribe(i => { i && (this.contexts = [...this.contexts, i]); }); }
    onEditContext(t) { let i = this.contexts.find(n => n.name === t); if (console.log(i), i) {
        let n = this.packageFormData();
        this.pageBuilderFacade.setPage(n), this.dialog.open(Tt, { data: { context: i } }).afterClosed().subscribe(a => { a && (this.contexts = this.contexts.map(o => o.name === t ? new ue(a) : o)); });
    } }
    ...
    resolvePaneContexts(t, i) { let n = new j(this.panelPane(t, i).value), a = this.panelPanes(t).controls; this.cpm.getPlugin(n.contentPlugin).pipe(I(o => o.handler !== void 0 && o.handler.isDynamic(n.settings)), b(o => o.handler.fetchDynamicData(n.settings, new Map([["tag", W()], ["contexts", [...this.contexts]]])).pipe(m(s => new ue({ name: "_root", adaptor: "data", data: s.length !== 0 ? s.results[0] : {} })), b(s => o.handler.getBindings(n.settings, "pane").pipe(m(c => [s, c.map(u => a.findIndex(C => new j(C.value).name === u.id))])))))).subscribe(([o, s]) => { this.editablePanes.forEach((c, u) => { s.findIndex(C => C === u) > -1 && (c.rootContext = o); }); }); }
    onPersistenceClick() { this.dialog.open(Yi, { data: { persistence: this.persistence, contexts: this.contexts } }).afterClosed().subscribe(t => { console.log("persistence closed", t), this.persistence = t || this.persistence; }); }
    onInteractionsClick() { this.dialog.open(Xi, { data: { interactions: this.interactions, contexts: this.contexts }, maxWidth: "100vw", maxHeight: "100vh", height: "100%", width: "100%" }).afterClosed().subscribe(t => { console.log("interactions closed", t), this.interactions = t || this.interactions; }); }
    ...
    onPaneEdit(t, i) { let n = new j(this.panelPane(t, i).value), a = this.panelPanePlugin(t, i), [o] = this.editablePanes.filter((s, c) => s.name === n.name); this.cpm.getPlugin(a).pipe(I(s => s.editorComponent !== void 0), b(s => this.pageBuilderFacade.getPage$.pipe(b(c => this.panelsContextService.allActivePageContexts({ panelPage: c }).pipe(m(u => [s, u]), V(1))), V(1))), b(([s, c]) => s.handler ? s.handler.editorOptions(n.settings).pipe(m(u => [s, c, u])) : f([s, c, new le]))).subscribe(([s, c, u]) => { this.dialog.open(s.editorComponent, _({ data: { panelFormGroup: this.panels.at(t), panelIndex: t, paneIndex: i, contexts: [...o.rootContext ? [o.rootContext] : this.rootContext ? [this.rootContext] : [], ...this.contexts, ...c], contentAdded: this.contentAdded, pane: n } }, u.fullscreen ? { maxWidth: "100vw", maxHeight: "100vh", height: "100%", width: "100%" } : {})).afterClosed().subscribe(() => { this.resolvePaneContexts(t, i); }); }); }
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(Le), e.\u0275\u0275directiveInject(ve.ContentPluginManager), e.\u0275\u0275directiveInject(y.StylePluginManager), e.\u0275\u0275directiveInject(Lt.LayoutPluginManager), e.\u0275\u0275directiveInject(G.ContextPluginManager), e.\u0275\u0275directiveInject(l.UntypedFormBuilder), e.\u0275\u0275directiveInject(be.MatBottomSheet), e.\u0275\u0275directiveInject(h.MatDialog), e.\u0275\u0275directiveInject(y.PanelContentHandler), e.\u0275\u0275directiveInject(k.TokenizerService), e.\u0275\u0275directiveInject(e.ComponentFactoryResolver), e.\u0275\u0275directiveInject(y.PageBuilderFacade), e.\u0275\u0275directiveInject(dt), e.\u0275\u0275directiveInject(y.PanelsContextService)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-content-editor"]], contentQueries: function (i, n, a) { if (i & 1 && e.\u0275\u0275contentQuery(a, Tn, 5), i & 2) {
            let o;
            e.\u0275\u0275queryRefresh(o = e.\u0275\u0275loadQuery()) && (n.extraActionsAreaTmpl = o.first);
        } }, viewQuery: function (i, n) { if (i & 1 && (e.\u0275\u0275viewQuery(Ei, 5), e.\u0275\u0275viewQuery(Di, 5), e.\u0275\u0275viewQuery(Mt, 5), e.\u0275\u0275viewQuery(Mn, 7), e.\u0275\u0275viewQuery(En, 7), e.\u0275\u0275viewQuery(Dn, 5), e.\u0275\u0275viewQuery(Dt, 5)), i & 2) {
            let a;
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(A), e.\u0275\u0275directiveInject(l.UntypedFormBuilder), e.\u0275\u0275directiveInject(ne)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-snippet-editor2"]], standalone: !1, decls: 1, vars: 1, consts: [[3, "submitted", "snippet"]], template: function (i, n) { i & 1 && (e.\u0275\u0275elementStart(0, "classifieds-ui-snippet-form", 0), e.\u0275\u0275listener("submitted", function (o) { return n.onSubmit(o); }), e.\u0275\u0275elementEnd()), i & 2 && e.\u0275\u0275property("snippet", n.snippet); }, dependencies: [qe.SnippetFormComponent], encapsulation: 2 }); }
} return r; })(), ai = (() => { class r {
    constructor(t, i, n, a, o, s, c) { this.route = t, this.pageBuilderFacade = i, this.routerStore = n, this.asyncApiCallHelperSvc = a, this.crudDataHelperService = o, this.entityDefinitionService = s, this.paramMapSub = this.route.paramMap.pipe(F(() => console.log("param map panelPageId")), m(u => u.get("panelPageId")), I(u => u !== void 0), b(() => this.route.data), xt(this.routerStore.pipe(K(ct(u => u.router).selectCurrentRoute), m(u => u.params), V(1))), F(([u, C]) => { console.log("route page"); let x = "/pages/panelpage/" + u.panelPageListItem.id; this.pageBuilderFacade.setPageInfo(new Ne({ id: u.panelPageListItem.id, realPath: x, path: u.panelPageListItem.path, args: C })), this.panelPageId = u.panelPageListItem.id; })).subscribe(), this.panelPageService = c.getEntityCollectionService("PanelPage"); }
    ngOnInit() { let { selectCurrentRoute: t } = ct(i => i.router); this.route.paramMap.pipe(F(() => console.log("param map page builder facade info")), xt(this.pageBuilderFacade.getPageInfo$), I(([i, n]) => n !== void 0 && i.get("panelPageId") !== void 0 && i.get("panelPageId") === n.id), b(([i, n]) => this.routerStore.pipe(K(t), m(a => [n, a.params]), V(1)))).subscribe(([i, n]) => { this.pageBuilderFacade.setPageInfo(new Ne(S(_({}, i), { args: n }))); }); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(se.ActivatedRoute), e.\u0275\u0275directiveInject(y.PageBuilderFacade), e.\u0275\u0275directiveInject(oe.Store), e.\u0275\u0275directiveInject(X.AsyncApiCallHelperService), e.\u0275\u0275directiveInject(Te.CrudDataHelperService), e.\u0275\u0275directiveInject(T.EntityDefinitionService), e.\u0275\u0275directiveInject(T.EntityServices)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-panel-page-router"]], standalone: !1, decls: 1, vars: 1, consts: [[3, "id"]], template: function (i, n) { i & 1 && e.\u0275\u0275element(0, "classifieds-ui-panel-page", 0), i & 2 && e.\u0275\u0275property("id", n.panelPageId); }, dependencies: [Me.PanelPageComponent], encapsulation: 2 }); }
} return r; })(), Or = (() => { class r {
    ...
    ngOnInit() { this.route.paramMap.pipe(m(t => t.get("panelPageId")), I(t => t !== void 0), gt(), b(t => this.panelPageService.getByKey(t)), b(t => t ? Qe(t.contexts.filter(i => i.plugin === "module").map(i => this.moduleLoader.loadModule(() => Ct({ remoteEntry: i.data.remoteEntry, remoteName: "plugin", exposedModule: i.data.exposedModule }).then(n => n[i.data.moduleName])))).pipe(Re(1), m(() => t), ft(t)) : f(t)), b(t => this.routerStore.pipe(K(ct(i => i.router).selectCurrentRoute), m(i => [t, i.params]), V(1))), F(([t, i]) => this.pageBuilderFacade.setPageInfo(new Ne({ id: t.id, realPath: `/pages/panelpage/${t.id}`, path: t.path, args: i })))).subscribe(([t]) => { console.log(t), this.panelPage = t; }); }
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(se.ActivatedRoute), e.\u0275\u0275directiveInject(y.PageBuilderFacade), e.\u0275\u0275directiveInject(oe.Store), e.\u0275\u0275directiveInject(X.ModuleLoaderService), e.\u0275\u0275directiveInject(T.EntityServices)); }; }
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(be.MatBottomSheetRef), e.\u0275\u0275directiveInject(re), e.\u0275\u0275directiveInject(l.UntypedFormBuilder), e.\u0275\u0275directiveInject(h.MatDialog), e.\u0275\u0275directiveInject(ve.ContentPluginManager), e.\u0275\u0275directiveInject(w.WidgetPluginManager)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-attribute-selector"]], inputs: { panelFormGroup: "panelFormGroup" }, standalone: !1, decls: 4, vars: 5, consts: [["mat-list-item", "", "mat-list-item", "", 3, "click", 4, "ngFor", "ngForOf"], ["mat-list-item", "", "mat-list-item", "", 3, "click"], ["mat-line", ""]], template: function (i, n) { i & 1 && (e.\u0275\u0275elementStart(0, "mat-nav-list"), e.\u0275\u0275template(1, zn, 3, 1, "a", 0), e.\u0275\u0275pipe(2, "async"), e.\u0275\u0275pipe(3, "keyvalue"), e.\u0275\u0275elementEnd()), i & 2 && (e.\u0275\u0275advance(), e.\u0275\u0275property("ngForOf", e.\u0275\u0275pipeBind1(3, 3, e.\u0275\u0275pipeBind1(2, 1, n.attributeWidgets)))); }, dependencies: [v.NgForOf, He.MatLine, Z.MatNavList, Z.MatListItem, v.AsyncPipe, v.KeyValuePipe], encapsulation: 2 }); }
} return r; })(), Nr = (() => { class r {
    ...
    ngOnInit() { let t = this.data.pane.settings.find(a => a.name === "value"); this.attributes = [new zt(S(_({}, this.widget.schema), { widget: this.widget.name, label: "Value", name: "value" }))]; let i = this.data.panelFormGroup.get("panes").at(this.data.paneIndex).get("name").value, n = this.data.panelFormGroup.get("panes").at(this.data.paneIndex).get("label").value; this.attributesFormGroup.get("name").setValue(i), this.attributesFormGroup.get("label").setValue(n), t !== void 0 ? (this.attributeValues = this.handler.valueSettings(this.data.pane.settings), console.log(this.attributeValues)) : this.attributeValues = [new ae({ name: "value", type: this.widget.schema.type, displayName: "Value", value: "", computedValue: "", intValue: 0, attributes: [] })]; }
    ...
    ngOnInit() { this.attributes = [new zt(S(_({}, this.widgets.find(t => t.name === this.settings.find(i => i.name === "widget").value).schema), { name: "value", label: "Value" }))], this.attributeValues = this.handler.valueSettings(this.settings), this.tokens = this.tokenizerService.generateTokens(this.attributeValues), this.handler.rendererSnippet(this.settings).subscribe(t => { this.rendererOverride = t, t !== void 0 && (this.rendererSettings = this.handler.rendererOverrideSettings(t)[0].attributes); }); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(Bt), e.\u0275\u0275directiveInject(re), e.\u0275\u0275directiveInject(k.TokenizerService), e.\u0275\u0275directiveInject(l.UntypedFormBuilder), e.\u0275\u0275directiveInject(l.ControlContainer, 8)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-attribute-pane-renderer"]], inputs: { settings: "settings", appearance: "appearance", name: "name", label: "label", displayType: "displayType" }, standalone: !1, decls: 3, vars: 2, consts: [["overrideTpl", ""], ["settingsTmpl", ""], [4, "ngIf", "ngIfElse"], [4, "ngIf"], [3, "formGroup", 4, "ngIf"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], [4, "ngFor", "ngForOf"], [3, "formGroup"], ["formControlName", "settings", 3, "attributes", "attributeValues"], [3, "settings", "tokens"]], template: function (i, n) { if (i & 1 && e.\u0275\u0275template(0, Yn, 3, 2, "div", 2)(1, Xn, 1, 2, "ng-template", null, 0, e.\u0275\u0275templateRefExtractor), i & 2) {
            let a = e.\u0275\u0275reference(2);
    ...
    editorOptions(t) { return f(new le); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(ut.FilesService), e.\u0275\u0275inject(w.AttributeSerializerService)); }; }
    static { this.\u0275prov = e.\u0275\u0275defineInjectable({ token: r, factory: r.\u0275fac }); }
} return r; })(), Gr = (() => { class r {
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(Pi), e.\u0275\u0275directiveInject(ge), e.\u0275\u0275directiveInject(w.AttributeSerializerService), e.\u0275\u0275directiveInject(T.EntityServices)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-media-pane-renderer"]], viewQuery: function (i, n) { if (i & 1 && e.\u0275\u0275viewQuery(er, 7), i & 2) {
            let a;
    ...
    isData(t) { return !1; }
    fetchDynamicData(t, i) { let n = new z; return this.toObject(t).pipe(b(a => this.urlGeneratorService.getUrl(a.url, a.params, i).pipe(m(o => [a, o])))).subscribe(([a, o]) => { this.pageBuilderFacade.loadRestData(`${i.get("tag")}`, new me(S(_({}, a), { url: o }))), this.store.pipe(K(je(`${i.get("tag")}`)), I(s => s !== void 0)).subscribe(s => { n.next(s), n.complete(); }); }), n; }
    buildDynamicItems(t, i) { let n = new z; return console.log("build dynamic items rest"), this.toObject(t).pipe(b(a => this.urlGeneratorService.getUrl(a.url, a.params, i).pipe(m(o => [a, o])))).subscribe(([a, o]) => { console.log("Load in rest data"), this.pageBuilderFacade.loadRestData(`${i.get("tag")}`, new me(S(_({}, a), { url: o }))), this.store.pipe(K(je(`${i.get("tag")}`)), I(s => s !== void 0), b(s => this.getBindings(t, "pane").pipe(m(c => [s, c]))), b(([s, c]) => we(() => s.results.length !== 0 && c.length > 0, new ke(u => { Qe(s.results.map(C => Bi(c).pipe(m(x => i.get("panes").find(D => D.name === x.id)), b(x => we(() => x.rule && x.rule !== null && x.rule.condition !== "", this.rulesResolver.evaluate(x.rule, [...i.get("contexts"), ...x.contexts !== void 0 ? x.contexts : [], new ue({ name: "_root", adaptor: "data", data: C })]).pipe(m(D => [x, D])), f(!1).pipe(m(D => [x, D])))), I(([x, D]) => D), m(([x, D]) => x.name), ft(c[0].id), V(1)))).pipe(m(C => [s, C])).subscribe(C => { u.next(C), u.complete(); }); }), new ke(u => { u.next([s]), u.complete(); }))), m(([s, c]) => a.renderer.type === "pane" ? s.results.map((u, C) => { let x = i.get("panes").find(N => N.name === c[C]), D = W(); return new j(S(_({}, x), { rule: void 0, label: D, contexts: [...i.get("contexts"), new ue({ name: "_root", adaptor: "data", data: u })] })); }) : s.results.map(u => new j({ contentPlugin: "snippet", name: W(), label: void 0, contexts: [...i.get("contexts"), new ue({ name: "_root", adaptor: "data", data: u })], settings: this.snippetHandler.buildSettings(S(_({}, a.renderer.data), { content: a.renderer.data.content })) }))), m(s => new We({ stylePlugin: void 0, settings: [], panes: s, columnSetting: new O })), m(s => this.panelHandler.buildSettings(new ye({ id: void 0, layoutType: "grid", displayType: "page", site: this.siteName, gridItems: [], layoutSetting: new O, rowSettings: [], panels: [s] })))).subscribe(s => { n.next(s.find(c => c.name === "panels").attributes[0].attributes.find(c => c.name === "panes").attributes), n.complete(); }); }), n; }
    buildSelectOptionItems(t, i) { return this.toObject(t).pipe(b(n => this.urlGeneratorService.getUrl(n.url, n.params, i).pipe(m(a => [n, a]))), m(([n, a]) => new me(S(_({}, n), { url: a })))).subscribe(n => { this.pageBuilderFacade.loadRestData(`${i.get("tag")}`, n); }), this.store.pipe(K(je(`${i.get("tag")}`)), I(n => n !== void 0), m(n => [n, n.results.map(a => this.tokenizerService.generateGenericTokens(a))]), m(([n, a]) => [n, a, new Wt(JSON.parse(i.get("snippet").content))]), m(([n, a, o]) => a.map((s, c) => new Ui({ dataItem: n.results[c], value: o.value === "[.]" ? this.attributeSerializer.serialize(n.results[c], "value") : this.attributeSerializer.serialize(this.tokenizerService.replaceTokens(o.value, s), "value"), label: this.tokenizerService.replaceTokens(o.label, s) })))); }
    getBindings(t, i, n) { return i === "context" ? this.toObject(t).pipe(m(a => a.params.reduce((o, s) => [...o, ...s.mapping.type === "form" ? [new Ue({ id: `form__${s.mapping.value.split(".", 2)[0].trim()}`, type: "context" })] : []], []))) : this.toObject(t).pipe(b(a => we(() => a.renderer.type === i, f(a.renderer.bindings), f([])))); }
    toObject(t) { return f(this.attributeSerializer.deserializeAsObject(t)); }
    buildSettings(t) { return this.attributeSerializer.serialize(t, "root").attributes; }
    ...
    editorOptions(t) { return f(new le); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(Le), e.\u0275\u0275inject(ne), e.\u0275\u0275inject(y.PageBuilderFacade), e.\u0275\u0275inject(oe.Store), e.\u0275\u0275inject(k.TokenizerService), e.\u0275\u0275inject(y.PanelContentHandler), e.\u0275\u0275inject(ht.UrlGeneratorService), e.\u0275\u0275inject(w.AttributeSerializerService), e.\u0275\u0275inject(Je.RulesResolverService)); }; }
    static { this.\u0275prov = e.\u0275\u0275defineInjectable({ token: r, factory: r.\u0275fac }); }
} return r; })(), zr = (() => { class r {
    ...
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-selection"]], inputs: { name: "name", label: "label", values: "values", renderType: "renderType", selectMapping: "selectMapping" }, outputs: { searchChange: "searchChange" }, standalone: !1, features: [e.\u0275\u0275ProvidersFeature([{ provide: Ae, useExisting: Y(() => r), multi: !0 }, { provide: ze, useExisting: Y(() => r), multi: !0 }])], decls: 9, vars: 6, consts: [["autocomplete", "matAutocomplete"], [3, "formGroup"], ["formArrayName", "attributes"], ["formGroupName", "0"], [3, "ngSwitch"], [4, "ngSwitchCase"], ["formControlName", "attributes"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], [4, "ngFor", "ngForOf"], [3, "formGroupName"], ["formControlName", "_store"], ["matInput", "", "formControlName", "_proxy", 3, "placeholder", "matAutocomplete"], [3, "optionSelected", "displayWith"]], template: function (i, n) { i & 1 && (e.\u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "div", 3)(3, "div"), e.\u0275\u0275elementContainerStart(4, 4), e.\u0275\u0275template(5, or, 6, 2, "ng-container", 5)(6, lr, 6, 2, "ng-container", 5)(7, dr, 4, 1, "ng-container", 5)(8, ur, 6, 4, "ng-container", 5), e.\u0275\u0275elementContainerEnd(), e.\u0275\u0275elementEnd()()()()), i & 2 && (e.\u0275\u0275property("formGroup", n.selectionForm), e.\u0275\u0275advance(4), e.\u0275\u0275property("ngSwitch", n.renderType), e.\u0275\u0275advance(), e.\u0275\u0275property("ngSwitchCase", "select"), e.\u0275\u0275advance(), e.\u0275\u0275property("ngSwitchCase", "radiogroup"), e.\u0275\u0275advance(), e.\u0275\u0275property("ngSwitchCase", "checkboxgroup"), e.\u0275\u0275advance(), e.\u0275\u0275property("ngSwitchCase", "autocomplete")); }, dependencies: [v.NgForOf, v.NgSwitch, v.NgSwitchCase, l.DefaultValueAccessor, l.NgControlStatus, l.NgControlStatusGroup, l.FormGroupDirective, l.FormControlName, l.FormGroupName, l.FormArrayName, U.MatAutocomplete, U.MatOption, U.MatAutocompleteTrigger, vt.MatCheckbox, P.MatInput, P.MatFormField, P.MatLabel, Xe.MatRadioGroup, Xe.MatRadioButton, Ye.MatSelect], encapsulation: 2 }); }
} return r; })(), qr = (() => { class r {
    ...
    isData(t) { return !1; }
    fetchDynamicData(t, i) { return f(new H); }
    buildDynamicItems(t, i) { return this.toObject(t).pipe(m(n => [n, i.get("contexts").find(a => a.name === n.context)]), b(([n, a]) => this.extractDataArray(a, n.query).pipe(m(o => [n, a, o]))), b(([n, a, o]) => this.transformDataArray(o, n.plugin)), m(n => new We({ stylePlugin: void 0, settings: [], panes: n, columnSetting: new O })), m(n => this.panelHandler.buildSettings(new ye({ id: void 0, layoutType: "grid", displayType: "page", site: this.siteName, gridItems: [], layoutSetting: new O, rowSettings: [], panels: [n] }))), m(n => n.find(a => a.name === "panels").attributes[0].attributes.find(a => a.name === "panes").attributes)); }
    getBindings(t, i, n) { return i === "context" ? this.toObject(t).pipe(m(a => [new Ue({ id: a.context, type: "context" })])) : f([]); }
    toObject(t) { return f(this.attributeSerializer.deserializeAsObject(t)); }
    buildSettings(t) { return this.attributeSerializer.serialize(t, "root").attributes; }
    ...
    transformDataArray(t, i) { return i === "media" ? f(t.map(n => new Fi(n)).map(n => new j({ contentPlugin: "media", name: void 0, label: void 0, settings: this.mediaHandler.buildSettings(n) }))) : f(); }
    stateDefinition(t) { return f({}); }
    editorOptions(t) { return f(new le); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(Le), e.\u0275\u0275inject(k.TokenizerService), e.\u0275\u0275inject(y.PanelContentHandler), e.\u0275\u0275inject(ge), e.\u0275\u0275inject(w.AttributeSerializerService), e.\u0275\u0275inject(G.InlineContextResolverService)); }; }
    static { this.\u0275prov = e.\u0275\u0275defineInjectable({ token: r, factory: r.\u0275fac }); }
} return r; })(), pt = class {
    ...
    ngOnInit() { this.panes = new We(this.data.panelFormGroup.value).panes; }
    ...
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-tabs-panel-renderer"]], inputs: { settings: "settings", panes: "panes", originPanes: "originPanes", originMappings: "originMappings" }, standalone: !1, decls: 2, vars: 2, consts: [["mat-align-tabs", "start", 4, "ngIf"], ["mat-align-tabs", "start"], [4, "for"], ["mat-tab-label", ""], [3, "pluginName", "settings", "contexts"], ["label", "The Label", 4, "ngFor", "ngForOf"], ["label", "The Label"]], template: function (i, n) { i & 1 && e.\u0275\u0275template(0, vr, 2, 1, "mat-tab-group", 0)(1, yr, 2, 1, "mat-tab-group", 0), i & 2 && (e.\u0275\u0275property("ngIf", n.labelMappingsEnabled), e.\u0275\u0275advance(), e.\u0275\u0275property("ngIf", !n.labelMappingsEnabled)); }, dependencies: [v.NgForOf, v.NgIf, B.MatTabLabel, B.MatTab, B.MatTabGroup, X.ForDirective, Me.RenderPaneComponent], encapsulation: 2 }); }
} return r; })(), Rt = (() => { class r {
    set panelPage(t) { this.panelPage$.next(t); }
    set context(t) { this.context$.next(t); }
    constructor(t, i) { this.fb = t, this.controlContainer = i, this.panelPages = [], this.panelPage$ = new J(new ye), this.context$ = new J(void 0), this.formGroup = this.fb.group({ state: this.fb.control("", [g.required]) }), this.stateCtrl = this.fb.control(""), this.stateCtrlSub = this.stateCtrl.valueChanges.pipe(pe(250), gt(), I(n => { try {
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(l.UntypedFormBuilder), e.\u0275\u0275directiveInject(l.ControlContainer)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-page-state-form"]], inputs: { panelPage: "panelPage", context: "context" }, standalone: !1, features: [e.\u0275\u0275ProvidersFeature([{ provide: Ae, useExisting: Y(() => r), multi: !0 }, { provide: ze, useExisting: Y(() => r), multi: !0 }])], decls: 3, vars: 2, consts: [[3, "formGroup"], ["cols", "40", "rows", "20", "required", "", 3, "formControl"]], template: function (i, n) { i & 1 && (e.\u0275\u0275elementStart(0, "div", 0), e.\u0275\u0275text(1, " <"), e.\u0275\u0275element(2, "textarea", 1), e.\u0275\u0275elementEnd()), i & 2 && (e.\u0275\u0275property("formGroup", n.formGroup), e.\u0275\u0275advance(2), e.\u0275\u0275property("formControl", n.stateCtrl)); }, dependencies: [l.DefaultValueAccessor, l.NgControlStatus, l.NgControlStatusGroup, l.RequiredValidator, l.FormControlDirective, l.FormGroupDirective], encapsulation: 2 }); }
} return r; })(), Kr = (() => { class r {
    ...
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-form-datasource-form"]], inputs: { settings: "settings" }, standalone: !1, features: [e.\u0275\u0275ProvidersFeature([{ provide: Ae, useExisting: Y(() => r), multi: !0 }, { provide: ze, useExisting: Y(() => r), multi: !0 }])], decls: 11, vars: 1, consts: [[3, "formGroup"], ["matInput", "", "formControlName", "name", "required", ""], ["matInput", "", "formControlName", "field", "required", ""]], template: function (i, n) { i & 1 && (e.\u0275\u0275elementStart(0, "div", 0)(1, "div")(2, "mat-form-field")(3, "mat-label"), e.\u0275\u0275text(4, "Name"), e.\u0275\u0275elementEnd(), e.\u0275\u0275element(5, "input", 1), e.\u0275\u0275elementEnd()(), e.\u0275\u0275elementStart(6, "div")(7, "mat-form-field")(8, "mat-label"), e.\u0275\u0275text(9, "Field"), e.\u0275\u0275elementEnd(), e.\u0275\u0275element(10, "input", 2), e.\u0275\u0275elementEnd()()()), i & 2 && e.\u0275\u0275property("formGroup", n.formGroup); }, dependencies: [l.DefaultValueAccessor, l.NgControlStatus, l.NgControlStatusGroup, l.RequiredValidator, l.FormGroupDirective, l.FormControlName, P.MatInput, P.MatFormField, P.MatLabel], encapsulation: 2 }); }
} return r; })(), Xr = (() => { class r {
...
} return r; })(), Zr = r => new $e({ id: "snippet", title: "Snippet", selectionComponent: void 0, editorComponent: jr, renderComponent: ri, handler: r }), ea = r => new $e({ id: "attribute", title: "Attribute", selectionComponent: kr, editorComponent: Nr, renderComponent: Vr, handler: r }), ta = r => new $e({ id: "media", title: "Media", selectionComponent: void 0, editorComponent: Gr, renderComponent: Ar, handler: r }), ia = r => new $e({ id: "rest", title: "REST", selectionComponent: void 0, editorComponent: Br, renderComponent: qr, handler: r }), na = r => new $e({ id: "slice", title: "Slice", selectionComponent: void 0, editorComponent: Hr, renderComponent: void 0, handler: r }), ra = r => { let d = { path: "" }; return new Ie({ id: "page", name: "page", title: "Page", global: !0, group: "pages", baseObject: d, resolver: r }); }, aa = r => { let d = { dataset: new H }; return new Ie({ id: "rest", name: "rest", title: "Rest", baseObject: d, resolver: r, editorComponent: Qr }); }, oa = r => { let d = { dataset: new H }; return new Ie({ id: "form", name: "form", title: "Form", baseObject: d, resolver: r }); }, sa = r => { let d = new Fe({ state: new ae }); return new Ie({ id: "panestate", name: "panestate", title: "Pane State", internal: !0, baseObject: d, resolver: r }); }, la = r => { let d = new Fe({ state: new ae }); return new Ie({ id: "pagestate", name: "pagestate", title: "Page State", internal: !0, baseObject: d, resolver: r, editorComponent: Kr }); }, ca = r => new lt({ id: "tabs", name: "tabs", title: "Tabs", handler: r, editorComponent: Wr, renderComponent: Jr }), da = (r, d, t) => new tn({ id: "form", title: "Form", usedContexts: ({ param: i, metadata: n }) => f([`form__${i.mapping.value.substr(0, i.mapping.value.indexOf("."))}`]), evalParam: ({ param: i, metadata: n }) => { let a = i.mapping.value.substr(0, i.mapping.value.indexOf(".")), o = i.mapping.value.substr(i.mapping.value.indexOf(".") + 1); return console.log(`form: ${a} || ${o}`), t.getForm$(a).pipe(V(1), m(s => s || new Ve), m(s => d.serializeForm(s)), m(s => r.generateGenericTokens(s)), F(s => console.log(s)), m(s => s.has(`.${o}`) ? r.replaceTokens(`[.${o}]`, s) : ""), F(s => { console.log("form value"), console.log(s); })); } }), pa = r => new Ni({ id: "form", title: "Form", resolve: () => r.getFormNames$.pipe(b(d => d.length === 0 ? f([]) : fe(d.map(t => r.getForm$(t).pipe(m(i => [t, i]))))), m(d => d.reduce((t, [i, n]) => S(_({}, t), { [`form__${i}`]: n }), {}))), resolveSingle: () => r.getFormNames$.pipe(b(d => Ht(...d.map(t => r.getForm$(t).pipe(m(i => [`form__${t}`, i])))))) }), ua = r => new rn({ id: "pages_form", title: "Pages Form", build: () => { an.prototype.serializePageForm = d => new Promise(t => { t(r.serializeForm(d)); }); } }), ma = (r, d) => new Zi({ id: "panelpageform_serialize", title: "Panelpageform Serialize", create: ({ object: t }) => f({ success: !1, entity: d.serializeForm(new Ve(t)) }), read: ({}) => f({ success: !1 }), update: ({}) => f({ success: !1 }), delete: ({}) => f({ success: !1 }) }), ga = (r, d, t) => new Hi({ id: "form", title: "Form", editor: Xr, fetch: ({ settings: i }) => f(new H).pipe(m(() => new st(r.deserializeAsObject(i))), b(n => d.getForm$(n.name).pipe(m(a => [n, a || new Ve]), ft([n, new Ve]), V(1))), m(([n, a]) => [n, t.serializeForm(a)]), m(([n, a]) => new H({ results: Ke.JSONPath({ path: `$.${n.field}.*`, json: a }) }))), getBindings: ({ settings: i, metadata: n }) => f([]).pipe(m(() => new st(r.deserializeAsObject(i))), m(a => [new Ue({ id: `form__${a.name}`, type: "context" })])) }), fa = r => d => { if (("/" + d.map(t => t.path).join("/")).indexOf(r.path) === 0) {
    let t = r.path.substr(1).split("/").length;
    return { consumed: d, posParams: d.reduce((i, n, a) => a === 0 ? S(_({}, i), { panelPageId: new ot(r.id, {}) }) : a > t - 1 ? S(_({}, i), { [`arg${a - t}`]: new ot(n.path, {}) }) : _({}, i), {}) };
}
else
    return null; }, ha = r => d => { if (("/" + d.map(t => t.path).join("/")).indexOf(r.path) === 0 && d.map(t => t.path).join("/").indexOf("/manage") > -1) {
    let t = r.path.substr(1).split("/").length;
    return { consumed: d, posParams: d.reduce((i, n, a) => a === 0 ? S(_({}, i), { panelPageId: new ot(r.id, {}) }) : _({}, i), {}) };
}
else
    return null; };
var va = (() => { class r {
    ...
    ngOnInit() { this.paneDatasource.pageChange$.pipe(Li(1), b(t => this.panelResolverService.resolvePanes({ panes: this.originPanes.map(i => new j(S(_({}, i), { metadata: new Map([...i.metadata ? i.metadata : [], ["page", t], ["limit", this.paneDatasource.pageSize]]) }))), contexts: this.contexts, resolvedContext: this.resolvedContext })), b(({ resolvedPanes: t, originMappings: i }) => this.styleResolverService.alterResolvedPanes({ panel: this.panel, resolvedPanes: t, originMappings: i }))).subscribe(({ resolvedPanes: t, originMappings: i }) => { this.originMappings = i, this.paneDatasource.panes = t; }), this.paneDatasource.panes = this.panes, this.trackByTpl = "[._root.id]"; }
    ...
    ngOnInit() { }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(oe.Store), e.\u0275\u0275directiveInject(se.Router), e.\u0275\u0275directiveInject(T.EntityServices)); }; }
...
} return r; })(), ya = new mi("PagesSettings"), jt = class {
    ...
    canActivate(t, i) { return this.pagesSettings.disableRouting ? new Promise(n => n(!0)) : new Promise(n => { let a = i.url; a.indexOf("?") !== -1 && (a = i.url.substr(0, a.indexOf("?"))); let o = "path=" + a.substr(1).split("/").reduce((s, c, u) => [...s, u === 0 ? `/${c}` : `${s[u - 1]}/${c}`], []).map(s => this.encodePathComponent(s)).join("&path=") + `&site=${encodeURIComponent(`{"term":{"site.keyword":{"value":"${this.siteName}"}}}`)}`; setTimeout(() => { }), Qe([we(() => !this.routesLoaded, this.panelPageListItemsService.getWithQuery(`site=${encodeURIComponent(`{"term":{"site.keyword":{"value":"${this.siteName}"}}}`)}&path={"wildcard":{"path.keyword":{"value":"*"}}}`).pipe(F(() => console.log("loaded page list items")), m(s => s.filter(c => c.path !== void 0 && c.path !== "")), m(s => s.map(c => new ye(c)).sort((c, u) => c.path.split("/").length === u.path.split("/").length ? c.path.split("/")[c.path.split("/").length - 1] > u.path.split("/")[u.path.split("/").length - 1] ? -1 : 1 : c.path.split("/").length > u.path.split("/").length ? -1 : 1)), F(s => s.sort((c, u) => c.path.length > u.path.length ? 1 : -1)), F(s => { let c = this.router.config; s.forEach(u => { c.unshift({ matcher: ha(u), component: oi }), c.unshift({ matcher: fa(u), component: ai, data: { panelPageListItem: u } }), console.log(`panels matcher: ${u.path}`); }), this.routesLoaded = !0; }), m(() => [])), f([])), this.panelPageListItemsService.getWithQuery(o).pipe(qi(s => f([])), F(() => console.log("loaded specific matched")), m(s => s.reduce((c, u) => c === void 0 || c.path.split("/").length < u.path.split("/").length ? u : c, void 0)), m(s => { let c = i.url.substr(1).split("/").slice(s.path.split("/").length - 1).join("/"); return [s, c]; }))]).pipe(m(([s, [c, u]]) => [c, u])).subscribe(([s, c]) => { let u = `${s.path}${c === "" ? "" : `/${c}`}?${It.stringify(t.queryParams)}`, C = this.router.parseUrl(u); console.log(`panels garud navigate: ${s.path}${c === "" ? "" : `/${c}`}?${It.stringify(t.queryParams)}`), n(C); }); }); }
    encodePathComponent(t) { return `{"term":{"path.keyword":{"value":"${t}"}}}`; }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(Le), e.\u0275\u0275inject(ya), e.\u0275\u0275inject(se.Router), e.\u0275\u0275inject(T.EntityServices)); }; }
    static { this.\u0275prov = e.\u0275\u0275defineInjectable({ token: r, factory: r.\u0275fac }); }
} return r; })(), Ot = (() => { class r {
    ...
    resolve(t, i) { let n = new me(i); return (n.params && Array.isArray(n.params) && n.params.length > 0 ? this.changePipeline(n.params) : f([])).pipe(b(() => n.params && Array.isArray(n.params) && n.params.length > 0 ? this.rebuildParams(n.params) : f([])), m(a => [a, new Map([["tag", W()]])]), b(([a, o]) => this.urlGeneratorService.getUrl(n.url, a, o).pipe(m(s => [s, o]))), b(([a, o]) => (this.pageBuilderFacade.loadRestData(`${o.get("tag")}`, new me(S(_({}, n), { url: a }))), this.store.pipe(K(je(`${o.get("tag")}`)), I(s => s !== void 0), m(s => s.results), V(1))))); }
    ...
    testParams(t) { let i = [], n = t.length; for (let a = 0; a < n; a++)
        t[a].mapping.type === "route" ? i.push(new $t(S(_({}, t[a]), { mapping: { type: "static", value: t[a].mapping.testValue, context: void 0, testValue: void 0 } }))) : i.push(new $t(t[a])); return i; }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(y.PageBuilderFacade), e.\u0275\u0275inject(oe.Store), e.\u0275\u0275inject(ht.UrlGeneratorService), e.\u0275\u0275inject(oe.Store)); }; }
    static { this.\u0275prov = e.\u0275\u0275defineInjectable({ token: r, factory: r.\u0275fac }); }
} return r; })(), Nt = (() => { class r {
    constructor(t) { this.pageBuilderFacade = t; }
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(y.PageBuilderFacade)); }; }
    static { this.\u0275prov = e.\u0275\u0275defineInjectable({ token: r, factory: r.\u0275fac }); }
} return r; })(), Ca = (() => { class r extends Wi {
    ...
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["lib-table-panel-renderer"]], standalone: !1, features: [e.\u0275\u0275ProvidersFeature([Yt]), e.\u0275\u0275InheritDefinitionFeature], decls: 4, vars: 4, consts: [["mat-table", "", "matSort", "", 3, "dataSource"], [3, "matColumnDef", 4, "ngFor", "ngForOf"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], [3, "matColumnDef"], ["mat-header-cell", "", "mat-sort-header", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["mat-header-cell", "", "mat-sort-header", ""], ["mat-cell", ""], ["mat-header-row", ""], ["mat-row", ""]], template: function (i, n) { i & 1 && (e.\u0275\u0275elementStart(0, "table", 0), e.\u0275\u0275template(1, xr, 3, 1, "ng-container", 1)(2, wr, 1, 0, "tr", 2)(3, Pr, 1, 0, "tr", 3), e.\u0275\u0275elementEnd()), i & 2 && (e.\u0275\u0275property("dataSource", n.paneDatasource), e.\u0275\u0275advance(), e.\u0275\u0275property("ngForOf", n.displayedColumns), e.\u0275\u0275advance(), e.\u0275\u0275property("matHeaderRowDef", n.displayedColumns), e.\u0275\u0275advance(), e.\u0275\u0275property("matRowDefColumns", n.displayedColumns)); }, dependencies: [v.NgForOf, et.MatSort, et.MatSortHeader, $.MatTable, $.MatHeaderCellDef, $.MatHeaderRowDef, $.MatColumnDef, $.MatCellDef, $.MatRowDef, $.MatHeaderCell, $.MatCell, $.MatHeaderRow, $.MatRow], encapsulation: 2 }); }
} return r; })(), Sa = (() => { class r {
    ...
    wrapPanel(t) { return new We({ stylePlugin: void 0, settings: [], panes: t, columnSetting: new O }); }
    stateDefinition(t) { return f({}); }
    editorOptions(t) { return f(new le); }
    ...
    alterResolvedPanes({ settings: t, resolvedPanes: i, originMappings: n }) { let a = this.attributeSerializer.deserialize(new ae({ name: "", displayName: "", computedValue: "", type: ie.Complex, value: "", intValue: 0, attributes: t })), o = a && a.labels !== void 0 && Array.isArray(a.labels) ? a.labels.map(c => new wt(c.mapping)) : [], s = []; if (o.length === 0)
        return f({ resolvedPanes: i, originMappings: n }); return i.length !== o.length ? s = i.map((c, u) => new wt(S(_({}, u < o.length ? o[u] : o[o.length - 1]), { pane: u }))).map(c => this.flattenSelector(c)) : s = o.map(c => this.flattenSelector(c)), Qe(i.map((c, u) => this.panelsLoaderService.reducePanes([], c, 0)[0])).pipe(m(c => c.reduce((u, [C, x]) => [...u, x], [])), m(c => { let u = s.map(M => this.selectWithTarget(M)), C = s.map(M => this.selectWithoutTarget(M)), x = u.map((M, R) => this.panelsSelectorService.rebuildPage(c[s[R][0]], M.slice(1))), D = C.map((M, R) => this.panelsSelectorService.rebuildPage(c[s[R][0]], M.slice(1))), N = [], ee = i.length; for (let M = 0; M < ee; M++)
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(Sa), e.\u0275\u0275inject(w.AttributeSerializerService), e.\u0275\u0275inject(y.PanelsLoaderService), e.\u0275\u0275inject(y.PanelsSelectorService)); }; }
    static { this.\u0275prov = e.\u0275\u0275defineInjectable({ token: r, factory: r.\u0275fac }); }
} return r; })(), Vt = (() => { class r {
    get emptyPaneState() { return new Fe({ state: this.attributeSerializer.serialize({ displayAssociatedPane: "" }, "root") }); }
    ...
    get fakePageInfo() { return new Ne({ id: "948d6e7b-12ab-11ec-8ecd-661fdd19e6df", path: "", realPath: "", args: new Map }); }
    ...
    resolve$(t, i) { return fe([this.panelPage$, this.entities$]).pipe(m(([n, a]) => [n, n && a.findIndex(o => o.id === n.id) !== -1 ? a.find(o => o.id === n.id) : new Pt]), b(([n, a]) => this.pageBuilderFacade.getSelectionPath$.pipe(m(o => i && i.selectionPath ? i.selectionPath : o), F(o => o.join(",")), m(o => o.map((s, c) => `${(c + 1) % 2 === 0 ? "panes" : (c === 0 ? "" : "nestedPage.") + "panels"}[${s}]`)), m(o => o.length === 0 ? void 0 : "$." + o.join(".")), m(o => [n, a, o]))), F(([n, a, o]) => { console.log("page state context resolver"), console.log(n), console.log("query: " + o); }), b(([n, a, o]) => we(() => !!n && !a, this.panelStateConverterService.convertPageToState(n).pipe(m(s => new Pt(S(_({}, s), { panels: s.panels.map(c => new Ji(S(_({}, c), { panes: c.panes.map(u => new Fe(S(_({}, u), { state: this.attributeSerializer.serialize({ displayAssociatedPane: "y" }, "root") }))) }))) }))), m(s => [s, o])), f([a, o]))), F(([n, a]) => { console.log("rebuilt state from realtime page"), console.log(n); }), m(([n, a]) => a ? Ke.JSONPath({ path: a, json: n }) : this.emptyPaneState), m(n => n && Array.isArray(n) && n.length !== 0 ? n[0] : this.emptyPaneState), F(n => { console.log("json path match"), console.log(n); }), m(n => this.attributeSerializer.deserializeAsObject(n.state)), F(n => { console.log("final state"), console.log(n); })); }
...
var xa = [{ path: "pages", children: [{ path: "create-panel-page", component: Or }, { path: "panelpage/:panelPageId/manage", component: oi }] }], $o = (() => { class r {
    constructor(t, i, n, a, o, s, c, u, C, x, D, N, ee, M, R, Se, Ee, ce, yt, wa, Pa, Fa, si, $a, Ia, li, ci, di, Ta) { s.registerMetadataMap(Fr), [ra(M), aa(R), oa(Se), sa(Ee), la(ce)].forEach(te => { a.register(te); }), t.forEach(te => n.register(te)), i.forEach(te => o.register(te)), c.register(da(D, N, ee)), u.register(pa(ee)), yt.register(ua(N)), yt.getPlugin("pages_form").subscribe(te => te.build()), si.register(ma(li, N)), ci.register(ga(di, ee, N)); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(de), e.\u0275\u0275inject(De), e.\u0275\u0275inject(ve.ContentPluginManager), e.\u0275\u0275inject(G.ContextPluginManager), e.\u0275\u0275inject(y.StylePluginManager), e.\u0275\u0275inject(T.EntityDefinitionService), e.\u0275\u0275inject(Ze.ParamPluginManager), e.\u0275\u0275inject(G.ResolvedContextPluginManager), e.\u0275\u0275inject(ti.PluginConfigurationManager), e.\u0275\u0275inject(G.ContextManagerService), e.\u0275\u0275inject(k.TokenizerService), e.\u0275\u0275inject(y.FormService), e.\u0275\u0275inject(y.PageBuilderFacade), e.\u0275\u0275inject(Ot), e.\u0275\u0275inject(kt), e.\u0275\u0275inject(Nt), e.\u0275\u0275inject(dt), e.\u0275\u0275inject(Vt), e.\u0275\u0275inject(ei.BridgeBuilderPluginManager), e.\u0275\u0275inject(ii.HttpClient), e.\u0275\u0275inject(T.Pluralizer), e.\u0275\u0275inject(T.DefaultDataServiceConfig), e.\u0275\u0275inject(Te.CrudAdaptorPluginManager), e.\u0275\u0275inject(T.EntityDefinitionService), e.\u0275\u0275inject(T.EntityDataService), e.\u0275\u0275inject(Ze.ParamEvaluatorService), e.\u0275\u0275inject(Qt.DatasourcePluginManager), e.\u0275\u0275inject(w.AttributeSerializerService), e.\u0275\u0275inject(Te.CrudDataHelperService)); }; }
    static { this.\u0275mod = e.\u0275\u0275defineNgModule({ type: r }); }
    static { this.\u0275inj = e.\u0275\u0275defineInjector({ providers: [_a, Ot, kt, Nt, dt, Vt, { provide: it, useValue: ba, multi: !0 }, { provide: it, useValue: yi, multi: !0 }, { provide: it, useValue: ai, multi: !0 }, { provide: ne, useClass: ne }, { provide: re, useClass: re }, { provide: ge, useClass: ge }, { provide: Pe, useClass: Pe }, { provide: Oe, useClass: Oe }, { provide: at, useClass: at }, { provide: de, useFactory: Zr, multi: !0, deps: [ne] }, { provide: de, useFactory: ea, multi: !0, deps: [re] }, { provide: de, useFactory: ta, multi: !0, deps: [ge] }, { provide: de, useFactory: ia, multi: !0, deps: [Pe] }, { provide: de, useFactory: na, multi: !0, deps: [Oe] }, { provide: De, useValue: new lt({ id: "virtuallist", name: "virtuallist", title: "Virtual List", editorComponent: void 0, renderComponent: va }), multi: !0 }, { provide: De, useFactory: ca, multi: !0, deps: [at] }, { provide: De, useValue: new lt({ id: "table", name: "table", title: "Table", editorComponent: void 0, renderComponent: Ca }), multi: !0 }], imports: [gi, hi, vi, Si, _i, fi.forChild(xa), xi, bi.forChild(), Ci, zi, Ii, Ti, Vi, Mi, $i, Ri, wi, Ki, ji, Oi, nn, on, Qi, en] }); }
} return r; })();
export { _a as CatchAllGuard, Fo as CatchAllRouterComponent, oi as EditPanelPageComponent, ya as PAGES_SETTINGS, $o as PagesModule, jt as PagesSettings, ai as PanelPageRouterComponent, ea as attributeContentPluginFactory, ha as createEditMatcher, fa as createMatcher, oa as formContextFactory, ga as formDatasourcePluginFactory, da as formParamPluginFactory, pa as formResolvedContextPluginFactory, ma as formSerializationEntityCrudAdaptorPluginFactory, ta as mediaContentPluginFactory, ra as pageContextFactory, la as pageStateContextFactory, ua as pagesFormBridgeFactory, sa as paneStateContextFactory, ia as restContentPluginFactory, aa as restContextFactory, na as sliceContentPluginFactory, Zr as snippetContentPluginFactory, ca as tabsStylePluginFactory };
//# sourceMappingURL=_rollthecloudinc_pages.qMoIPDX0Az.js.map
