import { a as St } from "@nf-internal/chunk-ISPTYA4B";
import { a as K } from "@nf-internal/chunk-FM6WEN77";
import { a as v, b as S, f as bt, h as _e } from "@nf-internal/chunk-J4XOFOAH";
var ke = bt((be, Te) => {
    (function (n, s) { typeof define == "function" && define.amd ? define([], s) : typeof be == "object" ? Te.exports = s() : n.CSSJSON = s(); })(be, function () {
        var n = new function () {
            ...
            s.toJSON = function (b, I) { var P = { children: {}, attributes: {} }, x = null, N = 0; if (typeof I > "u")
                ...
                if (!w(x[u]) && I.comments) {
                    ...
                    if (w(x[d])) {
                        if (!w(x[g])) {
                            ...
                            if (Pe) {
                                ...
                                if (I.ordered) {
                                    var z = {};
                                    z.name = j, z.value = ye, z.type = "attr", P[N++] = z;
                                }
                    ...
                    if (I.ordered) {
                        var z = {};
                        z.name = j, z.value = ce, z.type = "rule", P[N++] = z;
                    }
                    else {
                        if (I.split)
                            var ge = j.split(",");
...
import * as E from "@rollthecloudinc/attributes";
...
import { ContentPluginEditorOptions as Ke, ContentBinding as Et, ContentPlugin as Qe, CONTENT_PLUGIN as Ie } from "@rollthecloudinc/content";
import * as U from "@rollthecloudinc/datasource";
import { Dataset as We, Datasource as Ye, DatasourceModule as Nt } from "@rollthecloudinc/datasource";
...
var gn = (n, s) => ({ PanelPageListItem: { entityName: "PanelPageListItem", crud: S(v({}, Se(n) ? {} : { idb_keyval: { params: { prefix: "panelpage__" }, queryMappings: new Map([["site", { defaultOperator: "term||wildcard" }], ["path", { defaultOperator: "term||wildcard" }]]) } }), { idb_keyval: { params: { prefix: "panelpage__" }, queryMappings: new Map([["site", { defaultOperator: "term||wildcard" }], ["path", { defaultOperator: "term||wildcard" }]]) } }) }, PanelPage: { entityName: "PanelPage", crud: v(S(v({}, Se(n) ? {} : { readPrimary: { fallback: !0, ops: ["create", "update", "query"], plugin: "idb_keyval", params: { prefix: "panelpage__" } } }), { readFallback: { fallback: !0, ops: ["query"], plugin: "rest", params: { entityName: "PanelPage", root: s.objectsRootUrl, suffix: ".json" } } }), Se(n) ? {} : { idb_keyval: { params: { prefix: "panelpage__" } } }) }, PanelPageState: { entityName: "PanelPageState" } }), Oe = class {
    ...
    static { this.\u0275fac = function (t) { return new (t || n)(r.\u0275\u0275inject(E.AttributeSerializerService)); }; }
    ...
    getBindings(e, t, a) { let o = a ? new Map(a.get("dataPanes").map(l => [l.name, l])) : new Map; return t === "context" ? this.toObject(e).pipe(f(l => [l, l.params ? l.params.reduce((c, u) => [...c, ...u.mapping.type === "form" ? [new Et({ id: `form__${u.mapping.value.split(".", 2)[0].trim()}`, type: "context" })] : []], []) : []]), h(([l, c]) => this.dpm.getPlugin(l.plugin).pipe(h(u => u.getBindings({ settings: l.settings, metadata: a }).pipe(f(p => [l, p]))))), h(([l, c]) => C(l.renderer.bindings.reduce((u, p) => [...u, ...o.has(p.id) ? [this.toObject(o.get(p.id).settings)] : []], [])).pipe(h(u => C(u.map(p => this.dpm.getPlugin(p.plugin).pipe(h(d => d.getBindings({ settings: p.settings, metadata: a }))))).pipe(f(p => p.reduce((d, g) => [...d, ...g], c)), we(c))), we(c)))) : this.toObject(e).pipe(h(l => D(() => l.renderer.type === t, m(l.renderer.bindings), m([])))); }
    toObject(e) { return m(this.attributeSerializer.deserializeAsObject(e)); }
    buildSettings(e) { return this.attributeSerializer.serialize(e, "root").attributes; }
    ...
    static { this.\u0275fac = function (t) { return new (t || n)(r.\u0275\u0275inject(it), r.\u0275\u0275inject(A), r.\u0275\u0275inject(E.AttributeSerializerService), r.\u0275\u0275inject(Me.RulesResolverService), r.\u0275\u0275inject(U.DatasourcePluginManager), r.\u0275\u0275inject(U.DatasourceEvaluator)); }; }
    static { this.\u0275prov = r.\u0275\u0275defineInjectable({ token: n, factory: n.\u0275fac, providedIn: "root" }); }
} return n; })(), yn = (() => { class n {
    ...
    static { this.\u0275fac = function (t) { return new (t || n)(r.\u0275\u0275directiveInject(Rt), r.\u0275\u0275directiveInject(fe.MatDialogRef), r.\u0275\u0275directiveInject(y.UntypedFormBuilder), r.\u0275\u0275directiveInject(E.AttributeSerializerService), r.\u0275\u0275directiveInject(ut)); }; }
...
var bi = new He("StylePlugin"), jn = new He("PanelsSettings"), Si = (() => { class n {
    ...
    static { this.\u0275fac = function (t) { return new (t || n)(r.\u0275\u0275inject(It), r.\u0275\u0275inject(Ie), r.\u0275\u0275inject(jn), r.\u0275\u0275inject(O.EntityDefinitionService), r.\u0275\u0275inject(de.ContentPluginManager), r.\u0275\u0275inject(O.EntityDataService), r.\u0275\u0275inject(at.BridgeBuilderPluginManager), r.\u0275\u0275inject(O.EntityServices), r.\u0275\u0275inject(E.AttributeSerializerService), r.\u0275\u0275inject(he.CrudAdaptorPluginManager), r.\u0275\u0275inject(O.EntityDefinitionService), r.\u0275\u0275inject(he.CrudDataHelperService)); }; }
    static { this.\u0275mod = r.\u0275\u0275defineNgModule({ type: n }); }
    static { this.\u0275inj = r.\u0275\u0275defineInjector({ providers: [{ provide: A, useClass: A }, { provide: Ie, useFactory: bn, multi: !0, deps: [A] }, { provide: Ie, useFactory: Sn, multi: !0, deps: [ut] }, { provide: Ct, useClass: xt }], imports: [wt, Ft, Dt, Yt.forFeature(Pt, Mn), Qt.forFeature([In]), Bt, Nt, Jt, Vt, qt, Ut] }); }
} return n; })(), ze = class n {
    ...
    return s.datasets[e][s.datasets[e].length - 1]; }), Tn = H(Z, n => n.pageInfo), kn = H(Z, n => n.page), An = H(Z, n => n.selectionPath), yt = H(Z, n => n.formNames), On = H(Z, n => n.forms), En = H(yt, On, (n, s, e) => { let t = n.findIndex(a => a === e.name); if (t > -1)
    return s[t]; }), Nn = (() => { class n {
    constructor(e) { this.store = e, this.getPageInfo$ = this.store.pipe(W(Tn)), this.getPage$ = this.store.pipe(W(kn)), this.getSelectionPath$ = this.store.pipe(W(An)), this.getFormNames$ = this.store.pipe(W(yt)), this.getForm$ = t => this.store.pipe(W(En, { name: t })); }
    ...
    static { this.\u0275fac = function (t) { return new (t || n)(r.\u0275\u0275inject(Nn), r.\u0275\u0275inject(Dn), r.\u0275\u0275inject(E.AttributeSerializerService), r.\u0275\u0275inject(O.EntityServices)); }; }
    static { this.\u0275prov = r.\u0275\u0275defineInjectable({ token: n, factory: n.\u0275fac, providedIn: "root" }); }
} return n; })(), Ai = (() => { class n {
    constructor(e) { this.attributeSerializer = e; }
    ...
    hasNestedPanelPage(e) { return !!e.nestedPage; }
    static { this.\u0275fac = function (t) { return new (t || n)(r.\u0275\u0275inject(E.AttributeSerializerService), r.\u0275\u0275inject(y.UntypedFormBuilder)); }; }
    static { this.\u0275prov = r.\u0275\u0275defineInjectable({ token: n, factory: n.\u0275fac, providedIn: "root" }); }
} return n; })(), Ni = (() => { class n {
...
export { Ni as CssHelperService, ut as DatasourceContentHandler, yn as DatasourceEditorComponent, $i as DynamicPaneService, Ue as FormDatasource, Ei as FormGroupConverterService, Ai as FormService, Oi as FormStateConverterService, pe as GridItem, Ne as GridLayout, wi as LayoutEditorBaseComponent, Ii as LayoutRendererBaseComponent, T as LayoutSetting, jn as PANELS_SETTINGS, Nn as PageBuilderFacade, B as Pane, _i as PaneDatasourceService, Le as PanePropsFormPayload, k as PaneState, ki as PaneStateService, V as Panel, A as PanelContentHandler, Pn as PanelEditorComponent, $ as PanelPage, ae as PanelPageForm, le as PanelPageFormPane, oe as PanelPageFormPanel, Pi as PanelPageLinkedlistComponent, Ee as PanelPageListItem, ue as PanelPagePermissions, ze as PanelPageSelector, _ as PanelPageState, Ce as PanelPageStateSlice, Ge as PanelPropsFormPayload, Di as PanelResolverService, vn as PanelSelectorComponent, G as PanelState, Dn as PanelStateArchitectService, Mi as PanelStateConverterService, xi as PanelStyleRendererBaseComponent, ji as PanelsContextService, $n as PanelsLoaderService, Si as PanelsModule, Ci as PanelsSelectorService, Oe as PanelsSettings, Fn as PanelsWalkerService, Re as PropertiesFormPayload, bi as STYLE_PLUGIN, Be as StylePlugin, _n as StylePluginManager, Fi as StyleResolverService, xn as initialState, dt as loadRestData, yi as loadRestDataError, ft as loadRestDataSuccess, Pt as pageBuilderFeatureKey, Mn as reducer, Ti as selectDataset, En as selectForm, yt as selectFormNames, On as selectForms, kn as selectPage, Z as selectPageBuilderState, Tn as selectPageInfo, An as selectSelectionPath, ht as setForm, gt as setPage, mt as setPageInfo, vt as setSelectionPath };
