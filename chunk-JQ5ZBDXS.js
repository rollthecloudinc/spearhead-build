import { a as $ } from "@nf-internal/chunk-4ACP43BH";
import { a as He, c as It, d as Nt, e as Ot } from "@nf-internal/chunk-B7FP7EZA";
import { a as h, b as S, d as he, k as f, l as _t, m as Ct } from "@nf-internal/chunk-J4XOFOAH";
...
var ee = (function (e) { return e.HTTP = "http", e.HTTPS = "https", e; })(ee || {});
var te = (function (e) { return e.MD5 = "md5", e.CRC32 = "crc32", e.CRC32C = "crc32c", e.SHA1 = "sha1", e.SHA256 = "sha256", e; })(te || {});
var re = "__smithy_context";
var ge = e => typeof e == "function" ? e() : e;
var As = e => ({ setHttpHandler(t) { e.httpHandler = t; }, httpHandler() { return e.httpHandler; }, updateHttpClientConfig(t, r) { e.httpHandler?.updateHttpClientConfig(t, r); }, httpHandlerConfigs() { return e.httpHandler.httpHandlerConfigs(); } }), bs = e => ({ httpHandler: e.httpHandler() });
var A = class e {
    method;
    protocol;
    hostname;
...
var qe = class {
    ...
    resolveMiddlewareWithContext(t, r, n, { middlewareFn: o, clientName: s, commandName: i, inputFilterSensitiveLog: a, outputFilterSensitiveLog: u, smithyContext: c, additionalContext: p, CommandCtor: d }) { for (let g of o.bind(this)(d, t, r, n))
        this.middlewareStack.use(g); let l = t.concat(this.middlewareStack), { logger: m } = r, y = h({ logger: m, clientName: s, commandName: i, inputFilterSensitiveLog: a, outputFilterSensitiveLog: u, [re]: h({ commandInstance: this }, c) }, p), { requestHandler: w } = r; return l.resolve(g => w.handle(g.request, n || {}), y); }
}, ze = class {
    _init = () => { };
    _ep = {};
    _middlewareFn = () => [];
...
} return t(r); }), zn = { name: "hostHeaderMiddleware", step: "build", priority: "low", tags: ["HOST"], override: !0 }, Ws = e => ({ applyToStack: t => { t.add(qn(e), zn); } });
...
} }), Vn = { name: "loggerMiddleware", tags: ["LOGGER"], step: "initialize", override: !0 }, Ks = e => ({ applyToStack: t => { t.add(Gn(), Vn); } });
...
var oi = e => ({ applyToStack: t => { t.add($t(), vt); } });
...
function xi(e, t, r) { return { applyToStack: n => { n.add(Lt(e, r), Xn), n.add(Ft(e, t), Ve); } }; }
...
var Jn = { step: "finalizeRequest", tags: ["HTTP_SIGNING"], name: "httpSigningMiddleware", aliases: ["apiKeyMiddleware", "tokenMiddleware", "awsAuthMiddleware"], override: !0, relation: "after", toMiddleware: "retryMiddleware" }, Ii = e => ({ applyToStack: t => { t.addRelativeTo(Ht(e), Jn); } });
...
var oa = e => f(null, null, function* () { return typeof Blob == "function" && e instanceof Blob || e.constructor?.name === "Blob" ? Blob.prototype.arrayBuffer !== void 0 ? new Uint8Array(yield e.arrayBuffer()) : no(e) : oo(e); });
...
var Jt = e => et(e, 32), Zt = e => et(e, 16), er = e => et(e, 8), et = (e, t) => { let r = Ze(e); if (r !== void 0 && ao(r, t) !== r)
    ...
    return e; let t = Array.isArray(e) ? "array" : typeof e; throw new TypeError(`Expected object, got ${t}: ${e}`); }, pa = e => { if (e != null) {
    if (typeof e == "string")
        return e;
...
} throw new TypeError("Invalid RFC-7231 date-time value"); }, Ta = e => { if (e == null)
...
function Qa(e) { let t = k(e.userAgentAppId ?? _o), { customUserAgent: r } = e; return Object.assign(e, { customUserAgent: typeof r == "string" ? [[r]] : r, userAgentAppId: () => f(null, null, function* () { let n = yield t(); if (!Co(n)) {
...
var ec = "***SensitiveInformation***";
var rc = (e, t) => { for (let r of Object.keys(e)) {
...
var yr = e => e != null;
var Er = e => !e;
var it = { [ee.HTTP]: 80, [ee.HTTPS]: 443 }, wr = e => { let t = (() => { try {
    if (e instanceof URL)
        return e;
    ...
    return null; let u = i.slice(0, -1); if (!Object.values(ee).includes(u))
...
var Nu = (e, t) => { let { endpointParams: r, logger: n } = t, { parameters: o, rules: s } = e; t.logger?.debug?.(`${L} Initial EndpointParams: ${N(r)}`); let i = Object.entries(o).filter(([, c]) => c.default != null).map(([c, p]) => [c, p.default]); if (i.length > 0)
    for (let [c, p] of i)
...
var Dd = e => (e.sigv4aSigningRegionSet = k(e.sigv4aSigningRegionSet), e);
...
var dn = typeof TextEncoder == "function" ? new TextEncoder : null, qf = e => { if (typeof e == "string") {
    if (dn)
...
var Ho = ({ output: e, parsedBody: t, exceptionCtor: r, errorCode: n }) => { let o = Bo(e), s = o.httpStatusCode ? o.httpStatusCode + "" : void 0, i = new r({ name: t?.code || t?.Code || n || s || "UnknownError", $fault: "client", $metadata: o }); throw pr(i, t); }, Yf = e => ({ output: t, parsedBody: r, errorCode: n }) => { Ho({ output: t, parsedBody: r, exceptionCtor: e, errorCode: n }); }, Bo = e => ({ httpStatusCode: e.statusCode, requestId: e.headers["x-amzn-requestid"] ?? e.headers["x-amzn-request-id"] ?? e.headers["x-amz-request-id"], extendedRequestId: e.headers["x-amz-id-2"], cfId: e.headers["x-amz-cf-id"] });
var Kf = e => { switch (e) {
...
var fn = e => { let t = []; for (let r in te) {
    let n = te[r];
...
var nl = e => Object.assign(fn(e), pn(e));
var ol = e => Object.assign(ln(e), mn(e));
var Pe = class {
    trace() { }
    debug() { }
    info() { }
...
var al = (e, t) => { let r = {}; for (let n in t)
...
var fl = (e, t) => Qe(e, t).then(r => (t?.utf8Encoder ?? Se)(r));
var Vo = /\d{12}\.ddb/;
...
var Wo = e => (t, r) => n => f(null, null, function* () { let { request: o } = n; if (!A.isInstance(o))
    ...
    case 1: return `${i}/${a}`;
    default: return `${i}#${a}`;
} }, ""); }, Yo = { name: "getUserAgentMiddleware", step: "build", priority: "low", tags: ["SET_USER_AGENT", "USER_AGENT"], override: !0 }, Tl = e => ({ applyToStack: t => { t.add(Wo(e), Yo); } });
...
var vl = e => { let { region: t, useFipsEndpoint: r } = e; if (!t)
...
var Ko = { step: "build", tags: ["SET_CONTENT_LENGTH", "CONTENT_LENGTH"], name: "contentLengthMiddleware", override: !0 }, Ll = e => ({ applyToStack: t => { t.add(Xo(e.bodyLengthChecker), Ko); } });
...
var Qo = { step: "serialize", tags: ["ENDPOINT_PARAMETERS", "ENDPOINT_V2", "ENDPOINT"], name: "endpointV2Middleware", override: !0, relation: "before", toMiddleware: Ve.name }, Yl = (e, t) => ({ applyToStack: r => { r.addRelativeTo(_n({ config: e, instructions: t }), Qo); } });
var Zl = e => { let t = e.tls ?? !0, { endpoint: r, useDualstackEndpoint: n, useFipsEndpoint: o } = e, s = r != null ? () => f(null, null, function* () { return Nt(yield M(r)()); }) : void 0, a = Object.assign(e, { endpoint: s, tls: t, isCustomEndpoint: !!r, useDualstackEndpoint: M(n ?? !1), useFipsEndpoint: M(o ?? !1) }), u; return a.serviceConfiguredEndpoint = () => f(null, null, function* () { return e.serviceId && !u && (u = It(e.serviceId)), u; }), a; };
...
var Np = e => { let { retryStrategy: t, retryMode: r, maxAttempts: n } = e, o = M(n ?? pe); return Object.assign(e, { maxAttempts: o, retryStrategy: () => f(null, null, function* () { return t || ((yield M(r)()) === j.ADAPTIVE ? new Fe(o) : new Z(o)); }) }); };
...
var Yp = ({ serviceId: e, clientVersion: t }) => r => f(null, null, function* () { let n = typeof window < "u" ? window.navigator : void 0, o = n?.userAgent ?? "", s = n?.userAgentData?.platform ?? Fn.os(o) ?? "other", i = void 0, a = n?.userAgentData?.brands ?? [], u = a[a.length - 1], c = u?.brand ?? Fn.browser(o) ?? "unknown", p = u?.version ?? "unknown", d = [["aws-sdk-js", t], ["ua", "2.1"], [`os/${s}`, i], ["lang/js"], ["md/browser", `${c}_${p}`]]; e && d.push([`api/${e}`, t]); let l = yield r?.userAgentAppId?.(); return l && d.push([`app/${l}`]), d; }), Fn = { os(e) { if (/iPhone|iPad|iPod/.test(e))
        ...
        return "Safari"; } };
var Qp = e => () => Promise.reject(e);
var Hn = ["in-region", "cross-region", "mobile", "standard", "legacy"];
var rm = ({ defaultsMode: e } = {}) => Hr(() => f(null, null, function* () { let t = typeof e == "function" ? yield e() : e; switch (t?.toLowerCase()) {
...
var sm = e => ({ setRegion(t) { e.region = t; }, region() { return e.region; } }), im = e => ({ region: e.region() });
var fs = {};
function cm() { return typeof window < "u" ? window : typeof self < "u" ? self : fs; }
export { As as a, bs as b, A as c, O as d, Ws as e, Ks as f, oi as g, Y as h, M as i, li as j, xi as k, Jn as l, Ii as m, eo as n, we as o, U as p, Se as q, Gt as r, Yt as s, oa as t, Kt as u, I as v, Qe as w, fa as x, Je as y, la as z, co as A, pa as B, ma as C, ha as D, ga as E, wa as F, xa as G, Ra as H, Ta as I, ir as J, Ao as K, Bt as L, ur as M, Qa as N, mr as O, ce as P, Nu as Q, vo as R, D as S, de as T, lt as U, Dd as V, nn as W, le as X, Mf as Y, qf as Z, Mt as _, qe as $, ec as aa, rc as ba, lr as ca, pr as da, Yf as ea, Kf as fa, nl as ga, ol as ha, Pe as ia, jo as ja, al as ka, fl as la, Tl as ma, zp as na, Vp as oa, vl as pa, Ll as qa, Yl as ra, Zl as sa, pe as ta, Jo as ua, Np as va, Bp as wa, cm as xa, Yp as ya, Qp as za, rm as Aa, sm as Ba, im as Ca };
