import { d as y, l as g } from "@nf-internal/chunk-KZ5YVTQT";
import "@nf-internal/chunk-HW4YTZHJ";
import "@nf-internal/chunk-FWFSUXKR";
import "@nf-internal/chunk-25MYFSOI";
import "@nf-internal/chunk-NYBEXTYC";
import { e as _ } from "@nf-internal/chunk-WGMYTBKB";
import { b } from "@nf-internal/chunk-V25VP2QH";
import { a as m } from "@nf-internal/chunk-GL2BOVXA";
import * as n from "@angular/core";
import { InjectionToken as B, inject as r, NgZone as T, ElementRef as E, ChangeDetectorRef as R, DOCUMENT as I, Injector as f, afterNextRender as A, TemplateRef as O } from "@angular/core";
import { Subject as d, of as P } from "rxjs";
import { _IdGenerator as j, LiveAnnouncer as F } from "@angular/cdk/a11y";
import { Platform as N } from "@angular/cdk/platform";
import { BasePortalOutlet as L, CdkPortalOutlet as x, ComponentPortal as S, TemplatePortal as z, PortalModule as V } from "@angular/cdk/portal";
import { BreakpointObserver as q, Breakpoints as H } from "@angular/cdk/layout";
...
}, C = new B("MatSnackBarData"), u = class {
    politeness = "polite";
    announcementMessage = "";
    viewContainerRef;
    duration = 0;
...
`), n.\u0275\u0275advance(), n.\u0275\u0275conditional(a.hasAction ? 2 : -1));
            }, dependencies: [y, J, tt, et], styles: [`.mat-mdc-simple-snack-bar{display:flex}.mat-mdc-simple-snack-bar .mat-mdc-snack-bar-label{max-height:50vh;overflow:auto}
`], encapsulation: 2, changeDetection: 0 });
    ...
    class i extends L {
        ...
        _label;
        _role;
        _liveElementId = r(j).getId("mat-snack-bar-container-live-");
        ...
        enter() { this._destroyed || (this._animationState = "visible", this._changeDetectorRef.markForCheck(), this._changeDetectorRef.detectChanges(), this._screenReaderAnnounce(), this._animationsDisabled ? A(() => { this._ngZone.run(() => queueMicrotask(() => this.onAnimationEnd(k))); }, { injector: this._injector }) : (clearTimeout(this._enterFallback), this._enterFallback = setTimeout(() => { this._elementRef.nativeElement.classList.add("mat-snack-bar-fallback-visible"), this.onAnimationEnd(k); }, 200))); }
        exit() { return this._destroyed ? P(void 0) : (this._ngZone.run(() => { this._animationState = "hidden", this._changeDetectorRef.markForCheck(), this._elementRef.nativeElement.setAttribute("mat-exit", ""), clearTimeout(this._announceTimeoutId), this._animationsDisabled ? A(() => { this._ngZone.run(() => queueMicrotask(() => this.onAnimationEnd(v))); }, { injector: this._injector }) : (clearTimeout(this._exitFallback), this._exitFallback = setTimeout(() => this.onAnimationEnd(v), 200)); }), this._onExit); }
...
var it = new B("mat-snack-bar-default-options", { providedIn: "root", factory: at }), st = (() => { class i {
    ...
    _attachSnackBarContainer(t, e) { let a = e && e.viewContainerRef && e.viewContainerRef.injector, s = f.create({ parent: a || this._injector, providers: [{ provide: u, useValue: e }] }), o = new S(this.snackBarContainerComponent, e.viewContainerRef, s), c = t.attach(o); return c.instance.snackBarConfig = e, c.instance; }
    _attach(t, e) { let a = m(m(m({}, new u), this._defaultConfig), e), s = this._createOverlay(a), o = this._attachSnackBarContainer(s, a), c = new p(o, s); if (t instanceof O) {
        let h = new z(t, null, { $implicit: a.data, snackBarRef: c });
        c.instance = o.attachTemplatePortal(h);
    }
    else {
        let h = this._createInjector(a, c), M = new S(t, void 0, h), D = o.attachComponentPortal(M);
        c.instance = D.instance;
    } return this._breakpointObserver.observe(H.HandsetPortrait).pipe(K(s.detachments())).subscribe(h => { s.overlayElement.classList.toggle(this.handsetCssClass, h.matches); }), a.announcementMessage && o._onAnnounce.subscribe(() => { this._live.announce(a.announcementMessage, a.politeness); }), this._animateSnackBar(c, a), this._openedSnackBarRef = c, this._openedSnackBarRef; }
    ...
    _createInjector(t, e) { let a = t && t.viewContainerRef && t.viewContainerRef.injector; return f.create({ parent: a || this._injector, providers: [{ provide: p, useValue: e }, { provide: C, useValue: t.data }] }); }
    static \u0275fac = function (e) { return new (e || i); };
...
var wt = (() => { class i {
    ...
    static \u0275inj = n.\u0275\u0275defineInjector({ providers: [st], imports: [W, V, g, b, w, b] });
} return i; })(), Mt = { snackBarState: { type: 7, name: "state", definitions: [{ type: 0, name: "void, hidden", styles: { type: 6, styles: { transform: "scale(0.8)", opacity: 0 }, offset: null } }, { type: 0, name: "visible", styles: { type: 6, styles: { transform: "scale(1)", opacity: 1 }, offset: null } }, { type: 1, expr: "* => visible", animation: { type: 4, styles: null, timings: "150ms cubic-bezier(0, 0, 0.2, 1)" }, options: null }, { type: 1, expr: "* => void, * => hidden", animation: { type: 4, styles: { type: 6, styles: { opacity: 0 }, offset: null }, timings: "75ms cubic-bezier(0.4, 0.0, 1, 1)" }, options: null }], options: {} } };
export { C as MAT_SNACK_BAR_DATA, it as MAT_SNACK_BAR_DEFAULT_OPTIONS, at as MAT_SNACK_BAR_DEFAULT_OPTIONS_FACTORY, st as MatSnackBar, et as MatSnackBarAction, tt as MatSnackBarActions, u as MatSnackBarConfig, nt as MatSnackBarContainer, J as MatSnackBarLabel, wt as MatSnackBarModule, p as MatSnackBarRef, w as SimpleSnackBar, Mt as matSnackBarAnimations };
//# sourceMappingURL=_angular_material_snack_bar.EE6PxRfZ9b.js.map
