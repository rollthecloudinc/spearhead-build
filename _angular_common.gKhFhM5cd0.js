import { a as Rt, b as Bt } from "@nf-internal/chunk-ZY6ORGP2";
import { a as Y, b as K } from "@nf-internal/chunk-GL2BOVXA";
...
var k = (() => { class e {
    ...
    _baseHref;
    _removeListenerFns = [];
    constructor(t, n) { super(), this._platformLocation = t, this._baseHref = n ?? this._platformLocation.getBaseHrefFromDOM() ?? q(xe).location?.origin ?? ""; }
    ...
    prepareExternalUrl(t) { return J(this._baseHref, t); }
    path(t = !1) { let n = this._platformLocation.pathname + v(this._platformLocation.search), r = this._platformLocation.hash; return r && t ? `${n}${r}` : n; }
    pushState(t, n, r, o) { let s = this.prepareExternalUrl(r + v(o)); this._platformLocation.pushState(t, n, s); }
    replaceState(t, n, r, o) { let s = this.prepareExternalUrl(r + v(o)); this._platformLocation.replaceState(t, n, s); }
    ...
    constructor(t) { this._locationStrategy = t; let n = this._locationStrategy.getBaseHref(); this._basePath = zt(Ne(ke(n))), this._locationStrategy.onPopState(r => { this._subject.next({ url: this.path(!0), pop: !0, state: r.state, type: r.type }); }); }
    ...
    isCurrentPathEqualTo(t, n = "") { return this.path() == this.normalize(t + v(n)); }
    normalize(t) { return e.stripTrailingSlash(Ut(this._basePath, ke(t))); }
    prepareExternalUrl(t) { return t && t[0] !== "/" && (t = "/" + t), this._locationStrategy.prepareExternalUrl(t); }
    go(t, n = "", r = null) { this._locationStrategy.pushState(r, "", t, n), this._notifyUrlChangeListeners(this.prepareExternalUrl(t + v(n)), r); }
    replaceState(t, n = "", r = null) { this._locationStrategy.replaceState(r, "", t, n), this._notifyUrlChangeListeners(this.prepareExternalUrl(t + v(n)), r); }
...
var Jt = (() => { class e extends k {
    ...
    prepareExternalUrl(t) { let n = J(this._baseHref, t); return n.length > 0 ? "#" + n : n; }
    pushState(t, n, r, o) { let s = this.prepareExternalUrl(r + v(o)) || this._platformLocation.pathname; this._platformLocation.pushState(t, n, s); }
    replaceState(t, n, r, o) { let s = this.prepareExternalUrl(r + v(o)) || this._platformLocation.pathname; this._platformLocation.replaceState(t, n, s); }
    forward() { this._platformLocation.forward(); }
    back() { this._platformLocation.back(); }
    getState() { return this._platformLocation.getState(); }
    historyGo(t = 0) { this._platformLocation.historyGo?.(t); }
...
function ot(e, i, t) { let n = y(e), r = [n[f.MonthsFormat], n[f.MonthsStandalone]], o = b(r, i); return b(o, t); }
function st(e, i) { let n = y(e)[f.Eras]; return b(n, i); }
function Qt(e) { return y(e)[f.FirstDayOfWeek]; }
function en(e) { return y(e)[f.WeekendRange]; }
function z(e, i) { let t = y(e); return b(t[f.DateFormat], i); }
function j(e, i) { let t = y(e); return b(t[f.TimeFormat], i); }
function V(e, i) { let n = y(e)[f.DateTimeFormat]; return b(n, i); }
function S(e, i) { let t = y(e), n = t[f.NumberSymbols][i]; if (typeof n > "u") {
...
function tn(e) { return y(e)[f.CurrencySymbol] || null; }
function nn(e) { return y(e)[f.CurrencyName] || null; }
function rn(e) { return jt(e); }
function on(e) { return y(e)[f.Currencies]; }
var at = Vt;
function ut(e) { if (!e[f.ExtraData])
    throw new _(2303, !1); }
function ct(e) { let i = y(e); return ut(i), (i[f.ExtraData][2] || []).map(n => typeof n == "string" ? pe(n) : [pe(n[0]), pe(n[1])]); }
function dt(e, i, t) { let n = y(e); ut(n); let r = [n[f.ExtraData][0], n[f.ExtraData][1]], o = b(r, i) || []; return b(o, t) || []; }
function sn(e) { return y(e)[f.Directionality]; }
function b(e, i) { for (let t = i; t > -1; t--)
    if (typeof e[t] < "u")
        return e[t]; throw new _(2304, !1); }
function pe(e) { let [i, t] = e.split(":"); return { hours: +i, minutes: +t }; }
function lt(e, i, t = "en") { let n = on(t)[e] || et[e] || [], r = n[1]; return i === "narrow" && typeof r == "string" ? r : n[0] || e; }
var an = 2;
function ft(e) { let i, t = et[e]; return t && (i = t[2]), typeof i == "number" ? i : an; }
var un = /^(\d{4,})-?(\d\d)-?(\d\d)(?:T(\d\d)(?::?(\d\d)(?::?(\d\d)(?:\.(\d+))?)?)?(Z|([+-])(\d\d):?(\d\d))?)?$/, ee = {}, cn = /((?:[^BEGHLMOSWYZabcdhmswyz']+)|(?:'(?:[^']|'')*')|(?:G{1,5}|y{1,4}|Y{1,4}|M{1,5}|L{1,5}|w{1,2}|W{1}|d{1,2}|E{1,6}|c{1,6}|a{1,5}|b{1,5}|B{1,5}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|S{1,3}|z{1,4}|Z{1,5}|O{1,4}))([\s\S]*)/;
function ht(e, i, t, n) { let r = Cn(e); i = T(t, i) || i; let s = [], u; for (; i;)
    if (u = cn.exec(i), u) {
        ...
        s.push(i);
        break;
    } let D = r.getTimezoneOffset(); n && (D = Dt(n, D), r = mn(r, n)); let h = ""; return s.forEach(g => { let c = Dn(g); h += c ? c(r, t, D) : g === "''" ? "'" : g.replace(/(^'|'$)/g, "").replace(/''/g, "'"); }), h; }
function oe(e, i, t) { let n = new Date(0); return n.setFullYear(e, i, t), n.setHours(0, 0, 0), n; }
function T(e, i) { let t = nt(e); if (ee[t] ??= {}, ee[t][i])
...
function I(e, i, t = "-", n, r) { let o = ""; (e < 0 || r && e <= 0) && (r ? e = -e + 1 : (e = -e, o = t)); let s = String(e); for (; s.length < i;)
    s = "0" + s; return n && (s = s.slice(s.length - i)), o + s; }
function dn(e, i) { return I(e, 3).substring(0, i); }
function C(e, i, t = 0, n = !1, r = !1) { return function (o, s) { let u = ln(e, o); if ((t > 0 || u > -t) && (u += t), e === 3)
    u === 0 && t === -12 && (u = 12);
else if (e === 6)
    return dn(u, i); let D = S(s, m.MinusSign); return I(u, i, D, n, r); }; }
function ln(e, i) { switch (e) {
    ...
    default: throw new _(2301, !1);
} }
function l(e, i, t = E.Format, n = !1) { return function (r, o) { return fn(r, o, e, i, t, n); }; }
function fn(e, i, t, n, r, o) { switch (t) {
    case 2: return ot(i, r, n)[e.getMonth()];
    case 1: return rt(i, r, n)[e.getDay()];
    case 0:
        let s = e.getHours(), u = e.getMinutes();
        if (o) {
            let h = ct(i), g = dt(i, r, n), c = h.findIndex(F => { if (Array.isArray(F)) {
                let [p, w] = F, x = s >= p.hours && u >= p.minutes, B = s < w.hours || s === w.hours && u < w.minutes;
                if (p.hours < w.hours) {
                    if (x && B)
                        return !0;
                }
        ...
        return it(i, r, n)[s < 12 ? 0 : 1];
    case 3: return st(i, n)[e.getFullYear() <= 0 ? 0 : 1];
    default:
        let D = t;
        throw new _(2302, !1);
} }
function ne(e) { return function (i, t, n) { let r = -1 * n, o = S(t, m.MinusSign), s = r > 0 ? Math.floor(r / 60) : Math.ceil(r / 60); switch (e) {
    case 0: return (r >= 0 ? "+" : "") + I(s, 2, o) + I(Math.abs(r % 60), 2, o);
    case 1: return "GMT" + (r >= 0 ? "+" : "") + I(s, 1, o);
    case 2: return "GMT" + (r >= 0 ? "+" : "") + I(s, 2, o) + ":" + I(Math.abs(r % 60), 2, o);
    case 3: return n === 0 ? "Z" : (r >= 0 ? "+" : "") + I(s, 2, o) + ":" + I(Math.abs(r % 60), 2, o);
    default: throw new _(2310, !1);
} }; }
var hn = 0, re = 4;
function gn(e) { let i = oe(e, hn, 1).getDay(); return oe(e, 0, 1 + (i <= re ? re : re + 7) - i); }
function gt(e) { let i = e.getDay(), t = i === 0 ? -3 : re - i; return oe(e.getFullYear(), e.getMonth(), e.getDate() + t); }
function me(e, i = !1) { return function (t, n) { let r; if (i) {
    ...
    let o = gt(t), s = gn(o.getFullYear()), u = o.getTime() - s.getTime();
    r = 1 + Math.round(u / 6048e5);
} return I(r, e, S(n, m.MinusSign)); }; }
function ie(e, i = !1) { return function (t, n) { let o = gt(t).getFullYear(); return I(o, e, S(n, m.MinusSign), i); }; }
var Ce = {};
function Dn(e) { if (Ce[e])
...
function pn(e, i) { return e = new Date(e.getTime()), e.setMinutes(e.getMinutes() + i), e; }
function mn(e, i, t) { let r = e.getTimezoneOffset(), o = Dt(i, r); return pn(e, -1 * (o - r)); }
function Cn(e) { if (He(e))
    ...
    throw new _(2311, !1); return i; }
function yn(e) { let i = new Date(0), t = 0, n = 0, r = e[8] ? i.setUTCFullYear : i.setFullYear, o = e[8] ? i.setUTCHours : i.setHours; e[9] && (t = Number(e[9] + e[10]), n = Number(e[9] + e[11])), r.call(i, Number(e[1]), Number(e[2]) - 1, Number(e[3])); let s = Number(e[4] || 0) - t, u = Number(e[5] || 0) - n, D = Number(e[6] || 0), h = Math.floor(parseFloat("0." + (e[7] || 0)) * 1e3); return o.call(i, s, u, D, h), i; }
function He(e) { return e instanceof Date && !isNaN(e.valueOf()); }
var Fn = /^(\d+)?\.((\d+)(-(\d+))?)?$/, Ze = 22, se = ".", G = "0", En = ";", wn = ",", ye = "#", We = "\xA4", An = "%";
function Se(e, i, t, n, r, o, s = !1) { let u = "", D = !1; if (!isFinite(e))
    u = S(t, m.Infinity);
else {
    let h = _n(e);
    s && (h = Sn(h));
    ...
    if (o) {
        ...
        if (N === null)
            throw new _(2306, !1);
        let Be = N[1], ge = N[3], Pe = N[5];
        Be != null && (g = Fe(Be)), ge != null && (c = Fe(ge)), Pe != null ? F = Fe(Pe) : ge != null && c > F && (F = c);
    }
    bn(h, c, F);
    let p = h.digits, w = h.integerLen, x = h.exponent, B = [];
    for (D = p.every(N => !N); w < g; w++)
        p.unshift(0);
    for (; w < 0; w++)
        p.unshift(0);
    ...
    p.length && W.unshift(p.join("")), u = W.join(S(t, n)), B.length && (u += S(t, r) + B.join("")), x && (u += S(t, m.Exponential) + "+" + x);
} return e < 0 && !D ? u = i.negPre + u + i.negSuf : u = i.posPre + u + i.posSuf, u; }
function pt(e, i, t, n, r) { let o = ce(i, Z.Currency), s = _e(o, S(i, m.MinusSign)); return s.minFrac = ft(n), s.maxFrac = s.minFrac, Se(e, s, i, m.CurrencyGroup, m.CurrencyDecimal, r).replace(We, t).replace(We, "").trim(); }
function mt(e, i, t) { let n = ce(i, Z.Percent), r = _e(n, S(i, m.MinusSign)); return Se(e, r, i, m.Group, m.Decimal, t, !0).replace(new RegExp(An, "g"), S(i, m.PercentSign)); }
function Ct(e, i, t) { let n = ce(i, Z.Decimal), r = _e(n, S(i, m.MinusSign)); return Se(e, r, i, m.Group, m.Decimal, t); }
function _e(e, i = "-") { let t = { minInt: 1, minFrac: 0, maxFrac: 0, posPre: "", posSuf: "", negPre: "", negSuf: "", gSize: 0, lgSize: 0 }, n = e.split(En), r = n[0], o = n[1], s = r.indexOf(se) !== -1 ? r.split(se) : [r.substring(0, r.lastIndexOf(G) + 1), r.substring(r.lastIndexOf(G) + 1)], u = s[0], D = s[1] || ""; t.posPre = u.substring(0, u.indexOf(ye)); for (let g = 0; g < D.length; g++) {
    let c = D.charAt(g);
    c === G ? t.minFrac = t.maxFrac = g + 1 : c === ye ? t.maxFrac = g + 1 : t.posSuf += c;
} let h = u.split(wn); if (t.gSize = h[1] ? h[1].length : 0, t.lgSize = h[2] || h[1] ? (h[2] || h[1]).length : 0, o) {
    let g = r.length - t.posPre.length - t.posSuf.length, c = o.indexOf(ye);
    t.negPre = o.substring(0, c).replace(/'/g, ""), t.negSuf = o.slice(c + g).replace(/'/g, "");
}
else
    t.negPre = i + t.posPre, t.negSuf = t.posSuf; return t; }
function Sn(e) { if (e.digits[0] === 0)
...
function _n(e) { let i = Math.abs(e) + "", t = 0, n, r, o, s, u; for ((r = i.indexOf(se)) > -1 && (i = i.replace(se, "")), (o = i.search(/e/i)) > 0 ? (r < 0 && (r = o), r += +i.slice(o + 1), i = i.substring(0, o)) : r < 0 && (r = i.length), o = 0; i.charAt(o) === G; o++)
    ; if (o === (u = i.length))
    n = [0], r = 1;
else {
    for (u--; i.charAt(u) === G;)
...
function bn(e, i, t) { if (i > t)
    throw new _(2307, !1); let n = e.digits, r = n.length - e.integerLen, o = Math.min(Math.max(i, r), t), s = o + e.integerLen, u = n[s]; if (s > 0) {
...
function yt(e, i, t, n) { let r = `=${e}`; if (i.indexOf(r) > -1 || (r = t.getPluralCategory(e, n), i.indexOf(r) > -1))
    ...
    return "other"; throw new _(2308, !1); }
var Ft = (() => { class e extends de {
    locale;
    constructor(t) { super(), this.locale = t; }
    getPluralCategory(t, n) { switch (at(n || this.locale)(t)) {
    ...
    set klass(t) { this.initialClasses = t != null ? t.trim().split(Ee) : Ye; }
    ...
    ngOnChanges(t) { if (this._needToReCreateComponentInstance(t) && (this._viewContainerRef.clear(), this._inputsUsed.clear(), this._componentRef = void 0, this.ngComponentOutlet)) {
        ...
        this._needToReCreateNgModuleInstance(t) && (this._moduleRef?.destroy(), this.ngComponentOutletNgModule ? this._moduleRef = Gt(this.ngComponentOutletNgModule, Ke(n)) : this.ngComponentOutletNgModuleFactory ? this._moduleRef = this.ngComponentOutletNgModuleFactory.create(Ke(n)) : this._moduleRef = void 0), this._componentRef = this._viewContainerRef.createComponent(this.ngComponentOutlet, { injector: n, ngModuleRef: this._moduleRef, projectableNodes: this.ngComponentOutletContent, environmentInjector: this.ngComponentOutletEnvironmentInjector });
    } }
...
var Ln = (() => { class e {
    ...
    set ngIfThen(t) { qe(t, !1), this._thenTemplateRef = t, this._thenViewRef = null, this._updateView(); }
    set ngIfElse(t) { qe(t, !1), this._elseTemplateRef = t, this._elseViewRef = null, this._updateView(); }
...
function qe(e, i) { if (e && !e.createEmbeddedView)
    throw new _(2020, !1); }
var H = class {
    _viewContainerRef;
    _templateRef;
...
var we = class {
    createSubscription(i, t, n) { return Ge(() => i.subscribe({ next: t, error: n })); }
    dispose(i) { Ge(() => i.unsubscribe()); }
}, Ae = class {
    createSubscription(i, t, n) { return i.then(r => t?.(r), r => n?.(r)), { unsubscribe: () => { t = null, n = null; } }; }
    dispose(i) { i.unsubscribe(); }
}, Pn = new Ae, Nn = new we, kn = (() => { class e {
    _ref;
    _latestValue = null;
    ...
    transform(t, n, r, o) { if (t == null || t === "" || t !== t)
        return null; try {
        let s = n ?? this.defaultOptions?.dateFormat ?? jn, u = r ?? this.defaultOptions?.timezone ?? this.defaultTimezone ?? void 0;
        return ht(t, s, o || this.locale, u);
    }
    catch (s) {
        throw L(e, s.message);
    } }
...
var Xn = (() => { class e {
    ...
    transform(t, n = this._defaultCurrencyCode, r = "symbol", o, s) { if (!ve(t))
        return null; s ||= this._locale, typeof r == "boolean" && (r = r ? "symbol" : "code"); let u = n || this._defaultCurrencyCode; r !== "code" && (r === "symbol" || r === "symbol-narrow" ? u = lt(u, r === "symbol" ? "wide" : "narrow", s) : u = r); try {
        let D = Ie(t);
        return pt(D, s, u, n, o);
    }
    catch (D) {
...
var gi = "browser", Di = "server";
function Dr(e) { return e === gi; }
function pr(e) { return e === Di; }
var mr = new ii("20.3.9"), Cr = (() => { class e {
    ...
    scrollToAnchor(i, t) { let n = pi(this.document, i); n && (this.scrollToElement(n, t), n.focus()); }
    setHistoryScrollRestoration(i) { try {
        this.window.history.scrollRestoration = i;
    }
    catch {
        console.warn(oi(2400, !1));
    } }
...
function pi(e, i) { let t = e.getElementById(i) || e.getElementsByName(i)[0]; if (t)
...
function Mt(e) { return /^https?:\/\//.test(e); }
function Tt(e) { if (!(typeof e == "string") || e.trim() === "")
    return !1; try {
    let t = new URL(e);
    return !0;
}
...
function Ci(e) { return e.startsWith("/") ? e.slice(1) : e; }
var Ot = e => e.src, Re = new Te("", { providedIn: "root", factory: () => Ot });
function he(e, i) { return function (n) { return Tt(n) || yi(n, i || []), n = mi(n), [{ provide: Re, useValue: s => (Mt(s.src) && Fi(n, s.src), e(n, K(Y({}, s), { src: Ci(s.src) }))) }]; }; }
function yi(e, i) { throw new Oe(2959, !1); }
function Fi(e, i) { throw new Oe(2959, !1); }
var yr = he(Ei, void 0);
function Ei(e, i) { let t = "format=auto"; return i.width && (t += `,width=${i.width}`), i.isPlaceholder && (t += `,quality=${fe}`), `${e}/cdn-cgi/image/${t}/${i.src}`; }
var Fr = he(wi, void 0);
function wi(e, i) { let n = `f_auto,${i.isPlaceholder ? "q_auto:low" : "q_auto"}`; return i.width && (n += `,w_${i.width}`), i.loaderParams?.rounded && (n += ",r_max"), `${e}/image/upload/${n}/${i.src}`; }
var Er = he(Ai, void 0);
function Ai(e, i) { let { src: t, width: n } = i, r = []; n && r.push(`w-${n}`), i.isPlaceholder && r.push(`q-${fe}`); let o = r.length ? [e, `tr:${r.join(",")}`, t] : [e, t]; return new URL(o.join("/")).href; }
var wr = he(Si, void 0);
function Si(e, i) { let t = new URL(`${e}/${i.src}`); return t.searchParams.set("auto", "format"), i.width && t.searchParams.set("w", i.width.toString()), i.isPlaceholder && t.searchParams.set("q", fe), t.href; }
function Ar(e) { if (e && !Tt(e))
    throw new Oe(2959, !1); return e && (e = new URL(e).origin), [{ provide: Re, useValue: n => _i(n, e) }]; }
var vt = new Map([["height", "h"], ["fit", "fit"], ["quality", "q"], ["q", "q"], ["position", "position"]]);
function _i(e, i) { let t = new URL(i ?? "https://a/"); t.pathname = "/.netlify/images", !Mt(e.src) && !e.src.startsWith("/") && (e.src = "/" + e.src), t.searchParams.set("url", e.src), e.width && t.searchParams.set("w", e.width.toString()); let n = e.loaderParams?.quality ?? e.loaderParams?.q; e.isPlaceholder && !n && t.searchParams.set("q", fe); for (let [r, o] of Object.entries(e.loaderParams ?? {}))
    vt.has(r) && t.searchParams.set(vt.get(r), o.toString()); return t.hostname === "a" ? t.href.replace(t.origin, "") : t.href; }
var Sr = new Te("");
var bi = new Te("", { providedIn: "root", factory: () => new Set }), vi = (() => { class e {
    preloadedImages = O(bi);
    document = O(Lt);
    errorShown = !1;
...
var _r = (() => { class e {
    ...
    getRewrittenSrcset() { let t = It.test(this.ngSrcset); return this.ngSrcset.split(",").filter(r => r !== "").map(r => { r = r.trim(); let o = t ? parseFloat(r) : parseFloat(r) * this.width; return `${this.callImageLoader({ src: this.ngSrc, width: o })} ${r}`; }).join(", "); }
    getAutomaticSrcset() { return this.sizes ? this.getResponsiveSrcset() : this.getFixedSrcset(); }
    getResponsiveSrcset() { let { breakpoints: t } = this.config, n = t; return this.sizes?.trim() === "100vw" && (n = t.filter(o => o >= Li)), n.map(o => `${this.callImageLoader({ src: this.ngSrc, width: o })} ${o}w`).join(", "); }
    ...
    getFixedSrcset() { return Ii.map(n => `${this.callImageLoader({ src: this.ngSrc, width: this.width * n })} ${n}x`).join(", "); }
    shouldGenerateAutomaticSrcset() { let t = !1; return this.sizes || (t = this.width > Mi || this.height > Ti), !this.disableOptimizedSrcset && !this.srcset && this.imageLoader !== Ot && !t; }
...
@angular/common/fesm2022/common.mjs:
   ...
   *)
*/
//# sourceMappingURL=_angular_common.gKhFhM5cd0.js.map
