...
import { AttributeValue as T, Attribute as y, AttributeTypes as h, AttributesModule as gt } from "@rollthecloudinc/attributes";
...
import { switchMap as ht, filter as xt } from "rxjs/operators";
...
var vn = (() => { class i {
    ...
    layoutSettings(e, o) { this.lpm.getPlugin("split").pipe(ht(n => this.dialog.open(Tn, { data: { layout: n, type: e, settingValues: this.settingValues(e, o) } }).afterClosed()), xt(n => !!n)).subscribe(n => { switch (e) {
        case "column":
    ...
    static { this.\u0275inj = t.\u0275\u0275defineInjector({ imports: [ot, lt, Et, st, ut, dt, _t, Ct, yt, ft, gt] }); }
} return i; })();
export { vn as FlexLayoutComponent, Mn as FlexLayoutRendererComponent, j as GridLayoutComponent, ri as GridLayoutEditorComponent, et as GridlessLayoutComponent, Ln as GridlessLayoutEditorComponent, Vn as GridlessLayoutRendererComponent, Tn as LayoutDialogComponent, Sn as LayoutFormComponent, ai as LayoutModule, E as LayoutPlugin, nt as LayoutPluginManager, it as LayoutSidenavComponent, En as SplitLayoutComponent, In as SplitLayoutEditorComponent };
//# sourceMappingURL=_rollthecloudinc_layout.wWAxLiGHaM.js.map
