import { a as G } from "@nf-internal/chunk-YACJ2ZK5";
import { b as x } from "@nf-internal/chunk-F5JC75QQ";
import { f as H, g as z } from "@nf-internal/chunk-OA2EVVL5";
import { a as Q } from "@nf-internal/chunk-HW4YTZHJ";
import { a as V } from "@nf-internal/chunk-FWFSUXKR";
import { e as O } from "@nf-internal/chunk-25MYFSOI";
import { a as C } from "@nf-internal/chunk-NYBEXTYC";
import { e as L } from "@nf-internal/chunk-WGMYTBKB";
import { b as I } from "@nf-internal/chunk-V25VP2QH";
import "@nf-internal/chunk-GL2BOVXA";
import { FocusMonitor as ci, _IdGenerator as N, FocusKeyManager as oi } from "@angular/cdk/a11y";
import { ENTER as m, SPACE as R, BACKSPACE as K, DELETE as ni, TAB as W, hasModifierKey as U, UP_ARROW as j, DOWN_ARROW as ri } from "@angular/cdk/keycodes";
import { _CdkPrivateStyleLoader as Z, _VisuallyHiddenLoader as di } from "@angular/cdk/private";
import * as t from "@angular/core";
import { InjectionToken as u, inject as r, ElementRef as v, booleanAttribute as d, numberAttribute as X, ChangeDetectorRef as J, HOST_TAG_NAME as si, NgZone as li, DOCUMENT as Y, EventEmitter as h, Injector as hi, afterNextRender as pi, QueryList as mi, forwardRef as ui } from "@angular/core";
import { Subject as y, merge as T } from "rxjs";
...
`, b = new u("mat-chips-default-options", { providedIn: "root", factory: () => ({ separatorKeyCodes: [m] }) }), E = new u("MatChipAvatar"), S = new u("MatChipTrailingIcon"), D = new u("MatChipEdit"), M = new u("MatChipRemove"), w = new u("MatChip"), p = (() => { class c {
    _elementRef = r(v);
    _parentChip = r(w);
    isInteractive = !0;
    _isPrimary = !0;
    ...
    constructor() { r(Z).load(C), this._elementRef.nativeElement.nodeName === "BUTTON" && this._elementRef.nativeElement.setAttribute("type", "button"); }
...
} return c; })(), bt = (() => { class c extends p {
    _isPrimary = !1;
    _isLeading = !0;
    _handleClick(i) { this.disabled || (i.stopPropagation(), i.preventDefault(), this._parentChip._edit()); }
    _handleKeydown(i) { (i.keyCode === m || i.keyCode === R) && !this.disabled && (i.stopPropagation(), i.preventDefault(), this._parentChip._edit()); }
    static \u0275fac = (() => { let i; return function (e) { return (i || (i = t.\u0275\u0275getInheritedFactory(c)))(e || c); }; })();
...
} return c; })(), wt = (() => { class c extends p {
    _isPrimary = !1;
    _handleClick(i) { this.disabled || (i.stopPropagation(), i.preventDefault(), this._parentChip.remove()); }
    _handleKeydown(i) { (i.keyCode === m || i.keyCode === R) && !this.disabled && (i.stopPropagation(), i.preventDefault(), this._parentChip.remove()); }
    static \u0275fac = (() => { let i; return function (e) { return (i || (i = t.\u0275\u0275getInheritedFactory(c)))(e || c); }; })();
    ...
    class c {
        ...
        _ngZone = r(li);
        _focusMonitor = r(ci);
        _globalRippleOptions = r(O, { optional: !0 });
        _document = r(Y);
        _onFocus = new y;
        _onBlur = new y;
        _isBasicChip;
        ...
        _rippleLoader = r(Q);
        _injector = r(hi);
        constructor() { let i = r(Z); i.load(C), i.load(di), this._monitorFocus(), this._rippleLoader?.configureRipple(this._elementRef.nativeElement, { className: "mat-mdc-chip-ripple", disabled: this._isRippleDisabled() }); }
        ...
        ngAfterContentInit() { this._actionChanges = T(this._allLeadingIcons.changes, this._allTrailingIcons.changes, this._allEditIcons.changes, this._allRemoveIcons.changes).subscribe(() => this._changeDetectorRef.markForCheck()); }
        ...
        _handleKeydown(i) { (i.keyCode === K && !i.repeat || i.keyCode === ni) && (i.preventDefault(), this.remove()); }
        ...
        static \u0275fac = function (a) { return new (a || c); };
        static \u0275cmp = t.\u0275\u0275defineComponent({ type: c, selectors: [["mat-basic-chip"], ["", "mat-basic-chip", ""], ["mat-chip"], ["", "mat-chip", ""]], contentQueries: function (a, e, n) { if (a & 1 && (t.\u0275\u0275contentQuery(n, E, 5), t.\u0275\u0275contentQuery(n, D, 5), t.\u0275\u0275contentQuery(n, S, 5), t.\u0275\u0275contentQuery(n, M, 5), t.\u0275\u0275contentQuery(n, E, 5), t.\u0275\u0275contentQuery(n, S, 5), t.\u0275\u0275contentQuery(n, D, 5), t.\u0275\u0275contentQuery(n, M, 5)), a & 2) {
                let o;
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    _handleKeydown(i) { i.keyCode === m && !this.disabled ? this._isEditing ? (i.preventDefault(), this._onEditFinish()) : this.editable && this._startEditing(i) : this._isEditing ? i.stopPropagation() : super._handleKeydown(i); }
    ...
    class c {
        ...
        _getChipStream(i) { return this._chips.changes.pipe(f(null), _i(() => T(...this._chips.map(i)))); }
...
`], encapsulation: 2, changeDetection: 0 });
...
}, Hi = { provide: gi, useExisting: ui(() => zi), multi: !0 }, zi = (() => { class c extends ai {
    _onTouched = () => { };
    _onChange = () => { };
    ...
    _keydown(i) { i.keyCode === W && super._allowFocusEscape(); }
    ...
    constructor() { super(); let i = r(bi, { optional: !0 }), a = r(wi, { optional: !0 }), e = r(x); this.ngControl && (this.ngControl.valueAccessor = this), this._errorStateTracker = new G(e, this.ngControl, a, i, this.stateChanges); }
    ngAfterContentInit() { this.chipBlurChanges.pipe(l(this._destroyed)).subscribe(() => { this._blur(), this.stateChanges.next(); }), T(this.chipFocusChanges, this._chips.changes).pipe(l(this._destroyed)).subscribe(() => this.stateChanges.next()); }
    ...
    _handleKeydown(i) { let a = i.keyCode, e = this._keyManager.activeItem; if (a === W)
        this._chipInput.focused && U(i, "shiftKey") && this._chips.length && !this._chips.last.disabled ? (i.preventDefault(), e ? this._keyManager.setActiveItem(e) : this._focusLastChip()) : super._allowFocusEscape();
    else if (!this._chipInput.focused)
        if ((a === j || a === ri) && e) {
            let n = this._chipActions.filter(P => P._isPrimary === e._isPrimary && !this._skipPredicate(P)), o = n.indexOf(e), g = i.keyCode === j ? -1 : 1;
    ...
    static \u0275cmp = t.\u0275\u0275defineComponent({ type: c, selectors: [["mat-chip-grid"]], contentQueries: function (a, e, n) { if (a & 1 && t.\u0275\u0275contentQuery(n, Oi, 5), a & 2) {
            let o;
            t.\u0275\u0275queryRefresh(o = t.\u0275\u0275loadQuery()) && (e._chips = o);
        } }, hostAttrs: [1, "mat-mdc-chip-set", "mat-mdc-chip-grid", "mdc-evolution-chip-set"], hostVars: 10, hostBindings: function (a, e) { a & 1 && t.\u0275\u0275listener("focus", function () { return e.focus(); })("blur", function () { return e._blur(); }), a & 2 && (t.\u0275\u0275attribute("role", e.role)("tabindex", e.disabled || e._chips && e._chips.length === 0 ? -1 : e.tabIndex)("aria-disabled", e.disabled.toString())("aria-invalid", e.errorState), t.\u0275\u0275classProp("mat-mdc-chip-list-disabled", e.disabled)("mat-mdc-chip-list-invalid", e.errorState)("mat-mdc-chip-list-required", e.required)); }, inputs: { disabled: [2, "disabled", "disabled", d], placeholder: "placeholder", required: [2, "required", "required", d], value: "value", errorStateMatcher: "errorStateMatcher" }, outputs: { change: "change", valueChange: "valueChange" }, features: [t.\u0275\u0275ProvidersFeature([{ provide: H, useExisting: c }]), t.\u0275\u0275InheritDefinitionFeature], ngContentSelectors: B, decls: 2, vars: 0, consts: [["role", "presentation", 1, "mdc-evolution-chip-set__chips"]], template: function (a, e) { a & 1 && (t.\u0275\u0275projectionDef(), t.\u0275\u0275domElementStart(0, "div", 0), t.\u0275\u0275projection(1), t.\u0275\u0275domElementEnd()); }, styles: [ei], encapsulation: 2, changeDetection: 0 });
} return c; })(), It = (() => { class c {
    _elementRef = r(v);
    focused = !1;
    ...
    chipEnd = new h;
    placeholder = "";
    id = r(N).getId("mat-mdc-chip-list-input-");
    ...
    inputElement;
    constructor() { let i = r(b), a = r(z, { optional: !0 }); this.inputElement = this._elementRef.nativeElement, this.separatorKeyCodes = i.separatorKeyCodes, this.disabledInteractive = i.inputDisabledInteractive ?? !1, a && this.inputElement.classList.add("mat-mdc-form-field-input-control"); }
    ngOnChanges() { this._chipGrid.stateChanges.next(); }
    ngOnDestroy() { this.chipEnd.complete(); }
    _keydown(i) { this.empty && i.keyCode === K ? (i.repeat || this._chipGrid._focusLastChip(), i.preventDefault()) : this._emitChipEnd(i); }
    ...
    _isSeparatorKey(i) { return !U(i) && new Set(this.separatorKeyCodes).has(i.keyCode); }
...
var xt = (() => { class c {
    ...
    static \u0275inj = t.\u0275\u0275defineInjector({ providers: [x, { provide: b, useValue: { separatorKeyCodes: [m] } }], imports: [I, V, I] });
} return c; })();
export { w as MAT_CHIP, b as MAT_CHIPS_DEFAULT_OPTIONS, E as MAT_CHIP_AVATAR, D as MAT_CHIP_EDIT, Hi as MAT_CHIP_LISTBOX_CONTROL_VALUE_ACCESSOR, M as MAT_CHIP_REMOVE, S as MAT_CHIP_TRAILING_ICON, _ as MatChip, ft as MatChipAvatar, bt as MatChipEdit, k as MatChipEditInput, Ct as MatChipGrid, F as MatChipGridChange, It as MatChipInput, zi as MatChipListbox, A as MatChipListboxChange, Li as MatChipOption, wt as MatChipRemove, Oi as MatChipRow, q as MatChipSelectionChange, ai as MatChipSet, yt as MatChipTrailingIcon, xt as MatChipsModule };
//# sourceMappingURL=_angular_material_chips.8GqgYecYvh.js.map
