import { a as wt } from "@nf-internal/chunk-CAFTJBEE";
import { a as K } from "@nf-internal/chunk-7XNIKSHD";
import { a as v, b as S, f as St, h as _e } from "@nf-internal/chunk-GL2BOVXA";
var ke = St((be, Te) => {
...
import { isPlatformServer as Se, CommonModule as It } from "@angular/common";
import * as r from "@angular/core";
import { forwardRef as Ae, InjectionToken as He, PLATFORM_ID as xt } from "@angular/core";
import * as O from "@ngrx/data";
import { DefaultPluralizer as Ct, Pluralizer as Mt } from "@ngrx/data";
import * as y from "@angular/forms";
import { NG_VALUE_ACCESSOR as jt, NG_VALIDATORS as $t, UntypedFormControl as M, Validators as Q, UntypedFormArray as Ft, FormsModule as Dt, ReactiveFormsModule as _t } from "@angular/forms";
import { of as m, BehaviorSubject as ie, iif as D, forkJoin as C, Observable as Ve, Subject as Tt, Subscription as kt } from "rxjs";
import { map as f, switchMap as h, filter as qe, defaultIfEmpty as we, catchError as Je, concatMap as At, tap as F, take as se } from "rxjs/operators";
...
import { PersistenceFormPayload as Ke } from "@rollthecloudinc/refinery";
import { InteractionsFormPayload as Ot } from "@rollthecloudinc/detour";
import * as de from "@rollthecloudinc/content";
import { ContentPluginEditorOptions as Qe, ContentBinding as Nt, ContentPlugin as We, CONTENT_PLUGIN as Ie } from "@rollthecloudinc/content";
import * as U from "@rollthecloudinc/datasource";
import { Dataset as Ye, Datasource as Ze, DatasourceModule as Et } from "@rollthecloudinc/datasource";
import * as et from "@angular/material/autocomplete";
import * as tt from "@angular/material/input";
import * as nt from "@angular/material/select";
import * as it from "@rollthecloudinc/utils";
import { SITE_NAME as st, NoopDataService as zt } from "@rollthecloudinc/utils";
import { MaterialModule as Bt } from "@rollthecloudinc/material";
var Ht = _e(ke(), 1), je = _e(wt(), 1);
import * as rt from "@angular/material/bottom-sheet";
import * as fe from "@angular/material/dialog";
import { MAT_DIALOG_DATA as Rt } from "@angular/material/dialog";
import * as at from "@angular/material/grid-list";
import * as me from "@angular/material/list";
import * as Y from "@angular/material/tabs";
import * as ot from "@rollthecloudinc/bridge";
...
import * as ut from "@rollthecloudinc/plugin";
...
var gn = (n, s) => ({ PanelPageListItem: { entityName: "PanelPageListItem", crud: S(v({}, Se(n) ? {} : { idb_keyval: { params: { prefix: "panelpage__" }, queryMappings: new Map([["site", { defaultOperator: "term||wildcard" }], ["path", { defaultOperator: "term||wildcard" }]]) } }), { idb_keyval: { params: { prefix: "panelpage__" }, queryMappings: new Map([["site", { defaultOperator: "term||wildcard" }], ["path", { defaultOperator: "term||wildcard" }]]) } }) }, PanelPage: { entityName: "PanelPage", crud: v(S(v({ save: { ops: ["create", "update"], plugin: "rest", params: { entityName: "PanelPage" } } }, Se(n) ? {} : { readPrimary: { fallback: !0, ops: ["create", "update", "query"], plugin: "idb_keyval", params: { prefix: "panelpage__" } } }), { readFallback: { fallback: !0, ops: ["query"], plugin: "rest", params: { entityName: "PanelPage", root: s.objectsRootUrl, suffix: ".json" } } }), Se(n) ? {} : { idb_keyval: { params: { prefix: "panelpage__" } } }) }, PanelPageState: { entityName: "PanelPageState" } }), Oe = class {
    ...
    editorOptions(e) { return m(new Qe); }
    ...
    isData(e) { return !0; }
    fetchDynamicData(e, t) { let a = t.has("dataPanes") ? new Map(t.get("dataPanes").map(l => [l.name, l])) : new Map([]), o = new Map(Array.from(a).map(([l, c]) => [l, new Ze(this.attributeSerializer.deserializeAsObject(c.settings))])); return this.toObject(e).pipe(h(l => this.datasourceEvalutator.evalDatasource({ datasource: l, metadata: t, datasources: o }))); }
    ...
    editorOptions(e) { return this.toObject(e).pipe(h(t => this.dpm.getPlugin(t && t.plugin ? t.plugin : "data").pipe(f(a => [t, a]))), h(([t, a]) => a.editorOptions ? a.editorOptions({ settings: t && t.settings ? t.settings : [] }) : m(void 0)), f(t => new Qe({ fullscreen: t ? t.fullscreen : !1 }))); }
    static { this.\u0275fac = function (t) { return new (t || n)(r.\u0275\u0275inject(st), r.\u0275\u0275inject(A), r.\u0275\u0275inject(N.AttributeSerializerService), r.\u0275\u0275inject(Me.RulesResolverService), r.\u0275\u0275inject(U.DatasourcePluginManager), r.\u0275\u0275inject(U.DatasourceEvaluator)); }; }
    static { this.\u0275prov = r.\u0275\u0275defineInjectable({ token: n, factory: n.\u0275fac, providedIn: "root" }); }
} return n; })(), yn = (() => { class n {
    constructor(e, t, a, o, l) { this.data = e, this.dialogRef = t, this.fb = a, this.attributeSerializer = o, this.datasourceHandler = l, this.datasource = new Ze, this.bindableOptions = [], this.contexts = [], this.formGroup = this.fb.group({ source: this.fb.control("") }); }
    ...
    static { this.\u0275fac = function (t) { return new (t || n)(r.\u0275\u0275directiveInject(Rt), r.\u0275\u0275directiveInject(fe.MatDialogRef), r.\u0275\u0275directiveInject(y.UntypedFormBuilder), r.\u0275\u0275directiveInject(N.AttributeSerializerService), r.\u0275\u0275directiveInject(dt)); }; }
...
} return n; })(), bn = n => new We({ id: "panel", title: "Panel", selectionComponent: vn, editorComponent: Pn, renderComponent: void 0, handler: n }), Sn = n => new We({ id: "datasource", title: "Datasource", selectionComponent: void 0, editorComponent: yn, renderComponent: void 0, handler: n }), wn = (n, s) => new Gt({ id: "panels", title: "Panels", build: () => { Lt.prototype.writePaneState = (e, t) => new Promise(a => { let o = n.getEntityCollectionService("PanelPageState"); o.getByKey(e.id).pipe(Je(() => m(new _({ id: e.id, panels: [] }))), f(l => l === void 0 ? new _({ id: e.id, panels: [] }) : l), f(l => { let c = s.serialize(t, "root"), u = new _(S(v({}, l), { panels: [] })); for (let p = 0; p < e.panelIndex + 1; p++) {
...
var ft = J("[PageBuilder] Load Rest Data", X()), mt = J("[PageBuilder] Load Rest Data Success", X()), yi = J("[PageBuilder] Load Rest Data Error", X()), ht = J("[PageBuilder] Set Page Info", X()), gt = J("[PageBuilder] Set Form", X()), vt = J("[PageBuilder] Set Page", X()), Pt = J("[PageBuilder] Selection Path", X()), In = (() => { class n {
    ...
    constructor(e, t, a) { this.actions$ = e, this.datasourceApi = t, this.snippetParserService = a, this.loadRestData$ = Xt(() => this.actions$.pipe(Kt(ft), At(o => this.fetchRestdata$(o.rest).pipe(Je(() => []), f(l => o.rest.renderer !== void 0 && o.rest.renderer.query !== void 0 && o.rest.renderer.query !== "" ? je.JSONPath({ path: o.rest.renderer.query, json: l }) : l), f(l => mt({ tag: o.tag, data: new Ye({ results: l }) })))))); }
    static { this.\u0275fac = function (t) { return new (t || n)(r.\u0275\u0275inject(lt.Actions), r.\u0275\u0275inject(U.DatasourceApiService), r.\u0275\u0275inject(pt.SnippetParserService)); }; }
...
}, yt = "pageBuilder", xn = { dataTags: [], datasets: [], pageInfo: void 0, formNames: [], forms: [], page: void 0, selectionPath: [] }, Cn = Wt(xn, ne(mt, (n, s) => { let e = n.dataTags.findIndex(t => t === s.tag); if (e > -1 && n.forms[e] !== void 0) {
    let t = v({}, n);
    return t.datasets[e].push(s.data), t;
}
else
    return S(v({}, n), { dataTags: [...n.dataTags, s.tag], datasets: [...n.datasets, [s.data]] }); }), ne(gt, (n, s) => { let e = n.formNames.findIndex(t => t === s.name); return e > -1 && n.forms[e] !== void 0 ? S(v({}, n), { forms: n.forms.map((t, a) => a === e ? s.form : t) }) : S(v({}, n), { formNames: [...n.formNames, s.name], forms: [...n.forms, s.form] }); }), ne(ht, (n, s) => S(v({}, n), { pageInfo: s.info !== void 0 ? new Ce(s.info) : void 0 })), ne(vt, (n, s) => S(v({}, n), { page: s.page !== void 0 ? new $(s.page) : void 0 })), ne(Pt, (n, s) => S(v({}, n), { selectionPath: s.path !== void 0 ? s.path : [] })));
...
var bi = new He("StylePlugin"), jn = new He("PanelsSettings"), Si = (() => { class n {
    ...
    static { this.\u0275fac = function (t) { return new (t || n)(r.\u0275\u0275inject(xt), r.\u0275\u0275inject(Ie), r.\u0275\u0275inject(jn), r.\u0275\u0275inject(O.EntityDefinitionService), r.\u0275\u0275inject(de.ContentPluginManager), r.\u0275\u0275inject(O.EntityDataService), r.\u0275\u0275inject(ot.BridgeBuilderPluginManager), r.\u0275\u0275inject(O.EntityServices), r.\u0275\u0275inject(N.AttributeSerializerService), r.\u0275\u0275inject(he.CrudAdaptorPluginManager), r.\u0275\u0275inject(O.EntityDefinitionService), r.\u0275\u0275inject(he.CrudDataHelperService)); }; }
    static { this.\u0275mod = r.\u0275\u0275defineNgModule({ type: n }); }
    static { this.\u0275inj = r.\u0275\u0275defineInjector({ providers: [{ provide: A, useClass: A }, { provide: Ie, useFactory: bn, multi: !0, deps: [A] }, { provide: Ie, useFactory: Sn, multi: !0, deps: [dt] }, { provide: Mt, useClass: Ct }], imports: [It, Dt, _t, Yt.forFeature(yt, Mn), Qt.forFeature([In]), Bt, Et, Jt, Vt, qt, Ut] }); }
} return n; })(), ze = class n {
    ...
    static { this.\u0275fac = function (t) { return new (t || n)(r.\u0275\u0275inject(ut.PluginConfigurationManager), r.\u0275\u0275inject(it.ModuleLoaderService)); }; }
    static { this.\u0275prov = r.\u0275\u0275defineInjectable({ token: n, factory: n.\u0275fac, providedIn: "root" }); }
} return n; })(), Fi = (() => { class n {
    ...
    constructor() { super(), this.pageChange$ = new Tt, this.pageSize = 20, this.dataStream = new ie([]), this.subscription = new kt, this.lastPage = 0, this.paneItems = []; }
    ...
    static { this.\u0275fac = function (t) { return new (t || n); }; }
    static { this.\u0275prov = r.\u0275\u0275defineInjectable({ token: n, factory: n.\u0275fac }); }
} return n; })(), Z = Zt(yt), Ti = n => H(Z, s => { let e = s.dataTags.findIndex(t => t === n); if (e > -1)
    return s.datasets[e][s.datasets[e].length - 1]; }), Tn = H(Z, n => n.pageInfo), kn = H(Z, n => n.page), An = H(Z, n => n.selectionPath), bt = H(Z, n => n.formNames), On = H(Z, n => n.forms), Nn = H(bt, On, (n, s, e) => { let t = n.findIndex(a => a === e.name); if (t > -1)
    return s[t]; }), En = (() => { class n {
    constructor(e) { this.store = e, this.getPageInfo$ = this.store.pipe(W(Tn)), this.getPage$ = this.store.pipe(W(kn)), this.getSelectionPath$ = this.store.pipe(W(An)), this.getFormNames$ = this.store.pipe(W(bt)), this.getForm$ = t => this.store.pipe(W(Nn, { name: t })); }
    loadRestData(e, t) { this.store.dispatch(ft({ tag: e, rest: t })); }
    setPageInfo(e) { this.store.dispatch(ht({ info: e })); }
    setPage(e) { this.store.dispatch(vt({ page: e })); }
    setSelectionPath(e) { this.store.dispatch(Pt({ path: e })); }
    setForm(e, t) { this.store.dispatch(gt({ name: e, form: t })); }
    static { this.\u0275fac = function (t) { return new (t || n)(r.\u0275\u0275inject(ct.Store)); }; }
    static { this.\u0275prov = r.\u0275\u0275defineInjectable({ token: n, factory: n.\u0275fac, providedIn: "root" }); }
} return n; })(), Re = class {
    ...
    constructor(s) { this.panels = [], s && (this.id = s.id, this.name = s.name, this.title = s.title, this.derivativeId = s.derivativeId, this.valid = !!s.valid, s.persistence && (this.persistence = new Ke(s.persistence)), s.panels && (this.panels = s.panels.map(e => new oe(e)))); }
}, oe = class {
