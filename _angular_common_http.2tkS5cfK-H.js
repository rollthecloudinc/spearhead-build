import { a as be, b as Pe } from "@nf-internal/chunk-HEYWCI7C";
import { a as V, d as Re, k as re } from "@nf-internal/chunk-GL2BOVXA";
...
import { of as Le, Observable as le, from as yt } from "rxjs";
var j = class {
}, L = class {
}, R = class e {
    headers;
...
var fe = (() => { class e {
    ...
    request(t, n, s = {}) { let i; if (t instanceof F)
        ...
        return o; let d = o.pipe(ft(a => a instanceof _)); switch (s.observe || "body") {
...
var ze = new D(""), W = (() => { class e {
    ...
    handle(t) { return new le(n => { let s = new AbortController; this.doRequest(t, s.signal, n).then(ie, o => n.error(new w({ error: o }))); let i; return t.timeout && (i = this.ngZone.runOutsideAngular(() => setTimeout(() => { s.signal.aborted || s.abort(new DOMException("signal timed out", "TimeoutError")); }, t.timeout))), () => { i !== void 0 && clearTimeout(i), s.abort(); }; }); }
    doRequest(t, n, s) { return re(this, null, function* () { let i = this.createRequestInit(t), o; try {
        ...
        return;
    } let d = new R(o.headers), a = o.statusText, f = Ie(o) ?? t.urlWithParams, m = o.status, p = null; if (t.reportProgress && s.next(new X({ headers: d, status: m, statusText: a, url: f })), o.body) {
        ...
        if (yield this.ngZone.runOutsideAngular(() => re(this, null, function* () { for (;;) {
            ...
            if (M.push(te), h += te.length, t.reportProgress) {
                ...
                let we = () => s.next({ type: N.DownloadProgress, total: c ? +c : void 0, loaded: h, partialText: b });
                y ? y.run(we) : we();
            }
        } })), P) {
            s.complete();
        ...
        try {
            ...
            s.error(new w({ error: x, headers: new R(o.headers), status: o.status, statusText: o.statusText, url: Ie(o) ?? t.urlWithParams }));
            return;
        }
    } m === 0 && (m = p ? he : 0); let g = m >= 200 && m < 300, E = o.redirected; g ? (s.next(new _({ body: p, headers: d, status: m, statusText: a, url: f, redirected: E })), s.complete()) : s.error(new w({ error: p, headers: d, status: m, statusText: a, url: f, redirected: E })); }); }
...
var pe = new D(""), J = new D(""), ye = new D(""), me = new D("", { providedIn: "root", factory: () => !0 });
function Mt() { let e = null; return (r, t) => { e === null && (e = (v(pe, { optional: !0 }) ?? []).reduceRight(Pt, Xe)); let n = v(xe); if (v(me)) {
    let i = n.add();
...
var ge = (() => { class e {
    ...
    handle(t) { if (t.method !== "JSONP")
        ...
        return;
    } n.next(new _({ body: d, status: he, statusText: "OK", url: i })), n.complete(); }); }, p = g => { f(), n.error(new w({ error: g, status: 0, statusText: "JSONP Error", url: i })); }; return o.addEventListener("load", m), o.addEventListener("error", p), this.document.body.appendChild(o), n.next({ type: N.Sent }), () => { a || this.removeListeners(o), f(); }; }); }
...
var ae = (() => { class e {
    ...
    handle(t) { if (t.method === "JSONP")
        throw new A(-2800, !1); let n = this.xhrFactory; return (typeof ngServerMode < "u" && ngServerMode && n.\u0275loadImpl ? yt(n.\u0275loadImpl()) : Le(null)).pipe(pt(() => new le(i => { let o = n.build(); if (o.open(t.method, t.urlWithParams), t.withCredentials && (o.withCredentials = !0), t.headers.forEach((u, h) => o.setRequestHeader(u, h.join(","))), t.headers.has(q) || o.setRequestHeader(q, Be), !t.headers.has(z)) {
        ...
        return a; let u = o.statusText || "OK", h = new R(o.getAllResponseHeaders()), T = xt(o) || t.url; return a = new X({ headers: h, status: o.status, statusText: u, url: T }), a; }, m = () => { let { headers: u, status: h, statusText: T, url: b } = f(), y = null; h !== wt && (y = typeof o.response > "u" ? o.responseText : o.response), h === 0 && (h = y ? he : 0); let P = h >= 200 && h < 300; if (t.responseType === "json" && typeof y == "string") {
        let I = y;
        y = y.replace(Dt, "");
        try {
...
function He() { return U(k.JsonpSupport, [ge, { provide: Q, useFactory: It }, { provide: J, useValue: Je, multi: !0 }]); }
...
function ee(e) { return function (t, n) { let s = n?.injector ?? S(St); return new Ee(s, () => Qt(t, e), n?.defaultValue, n?.parse, n?.equal); }; }
function Qt(e, r) { let t = typeof e == "function" ? e() : e; if (t === void 0)
...
var Ee = class extends zt {
    ...
    constructor(r, t, n, s, i) { super(t, ({ params: o, abortSignal: d }) => { let a, f = () => a.unsubscribe(); d.addEventListener("abort", f); let m = Jt({ value: void 0 }), p, g = new Promise(c => p = c), E = c => { m.set(c), p?.(m), p = void 0; }; return a = this.client.request(o).subscribe({ next: c => { switch (c.type) {
            ...
            case N.DownloadProgress:
                ...
                break;
        } }, error: c => { c instanceof w && (this._headers.set(c.headers), this._statusCode.set(c.status)), E({ error: c }), d.removeEventListener("abort", f); }, complete: () => { p && E({ error: new at(991, !1) }), d.removeEventListener("abort", f); } }), g; }, n, i, r), this.client = r.get(fe); }
    set(r) { super.set(r), this._headers.set(void 0), this._progress.set(void 0), this._statusCode.set(void 0); }
}, Ht = new ct(""), et = "b", tt = "h", rt = "s", nt = "st", st = "u", ot = "rt", ve = new ct(""), er = ["GET", "HEAD"];
function tr(e, r) { let E = S(ve), { isCacheActive: t } = E, n = Re(E, ["isCacheActive"]), { transferCache: s, method: i } = e; if (!t || s === !1 || i === "POST" && !n.includePostRequests && !s || i !== "POST" && !er.includes(i) || !n.includeRequestsWithAuthHeaders && rr(e) || n.filter?.(e) === !1)
    return r(e); let o = S(Kt), d = S(Ht, { optional: !0 }); if (typeof ngServerMode < "u" && !ngServerMode && d)
    throw new at(2803, !1); let a = typeof ngServerMode < "u" && ngServerMode && d ? ir(e.url, d) : e.url, f = sr(e, a), m = o.get(f, null), p = n.includeHeaders; if (typeof s == "object" && s.includeHeaders && (p = s.includeHeaders), m) {
    let { [et]: c, [ot]: M, [tt]: u, [rt]: h, [nt]: T, [st]: b } = m, y = c;
    switch (M) {
        case "arraybuffer":
    ...
    let P = new R(u);
    return qt(new _({ body: y, headers: P, status: h, statusText: T, url: b }));
} let g = r(e); return typeof ngServerMode < "u" && ngServerMode ? g.pipe(Zt(c => { c instanceof _ && o.set(f, { [et]: c.body, [tt]: nr(c.headers, p), [rt]: c.status, [nt]: c.statusText, [st]: a, [ot]: e.responseType }); })) : g; }
function rr(e) { return e.headers.has("authorization") || e.headers.has("proxy-authorization"); }
function nr(e, r) { if (!r)
    return {}; let t = {}; for (let n of r) {
    let s = e.getAll(n);
    s !== null && (t[n] = s);
} return t; }
function it(e) { return [...e.keys()].sort().map(r => `${r}=${e.getAll(r)}`).join("&"); }
function sr(e, r) { let { params: t, method: n, responseType: s } = e, i = it(t), o = e.serializeBody(); o instanceof URLSearchParams ? o = it(o) : typeof o != "string" && (o = ""); let d = [n, s, r, o, i].join("|"), a = or(d); return Yt(a); }
function or(e) { let r = 0; for (let t of e)
    r = Math.imul(31, r) + t.charCodeAt(0) << 0; return r += 2147483648, r.toString(); }
function Mr(e) { return [{ provide: ve, useFactory: () => ($t("NgHttpTransferCache"), V({ isCacheActive: !0 }, e)) }, { provide: ye, useValue: tr, multi: !0 }, { provide: Gt, multi: !0, useFactory: () => { let r = S(Wt), t = S(ve); return () => { r.whenStable().then(() => { t.isCacheActive = !1; }); }; } }]; }
function ir(e, r) { let t = new URL(e, "resolve://").origin, n = r[t]; return n ? e.replace(t, n) : e; }
export { W as FetchBackend, pe as HTTP_INTERCEPTORS, Ht as HTTP_TRANSFER_CACHE_ORIGIN_MAP, L as HttpBackend, fe as HttpClient, Bt as HttpClientJsonpModule, Ct as HttpClientModule, Ut as HttpClientXsrfModule, Y as HttpContext, se as HttpContextToken, w as HttpErrorResponse, N as HttpEventType, k as HttpFeatureKind, j as HttpHandler, X as HttpHeaderResponse, R as HttpHeaders, O as HttpParams, F as HttpRequest, _ as HttpResponse, C as HttpResponseBase, Se as HttpStatusCode, K as HttpUrlEncodingCodec, ae as HttpXhrBackend, B as HttpXsrfTokenExtractor, ge as JsonpClientBackend, _t as JsonpInterceptor, Nr as httpResource, qe as provideHttpClient, Lt as withFetch, Ft as withInterceptors, Ze as withInterceptorsFromDi, He as withJsonpSupport, Qe as withNoXsrfProtection, jt as withRequestsMadeViaParent, ce as withXsrfConfiguration, ye as \u0275HTTP_ROOT_INTERCEPTOR_FNS, Z as \u0275HttpInterceptingHandler, Z as \u0275HttpInterceptorHandler, me as \u0275REQUESTS_CONTRIBUTE_TO_STABILITY, Mr as \u0275withHttpTransferCache };
...
@angular/common/fesm2022/http.mjs:
   ...
   *)
*/
//# sourceMappingURL=_angular_common_http.2tkS5cfK-H.js.map
