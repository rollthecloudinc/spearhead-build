import { a as h } from "@nf-internal/chunk-RIYJEPFT";
import { a as v } from "@nf-internal/chunk-FWFSUXKR";
import { f as m } from "@nf-internal/chunk-25MYFSOI";
import { a as f } from "@nf-internal/chunk-NYBEXTYC";
import { e as p } from "@nf-internal/chunk-WGMYTBKB";
import { b as c } from "@nf-internal/chunk-V25VP2QH";
import "@nf-internal/chunk-GL2BOVXA";
import { _IdGenerator as _, FocusMonitor as S } from "@angular/cdk/a11y";
import { Directionality as M } from "@angular/cdk/bidi";
import { SelectionModel as w } from "@angular/cdk/collections";
import { hasModifierKey as G, RIGHT_ARROW as C, DOWN_ARROW as B, LEFT_ARROW as R, UP_ARROW as A, ENTER as E, SPACE as O } from "@angular/cdk/keycodes";
import { _CdkPrivateStyleLoader as D } from "@angular/cdk/private";
import * as a from "@angular/core";
import { InjectionToken as y, forwardRef as V, inject as r, ChangeDetectorRef as k, EventEmitter as u, booleanAttribute as s, ElementRef as F, HostAttributeToken as L, signal as N } from "@angular/core";
import { NG_VALUE_ACCESSOR as P } from "@angular/forms";
import "@angular/cdk/platform";
import "@angular/cdk/coercion";
import "@angular/cdk/layout";
var z = ["button"], U = ["*"];
function H(l, b) { if (l & 1 && (a.\u0275\u0275elementStart(0, "div", 2), a.\u0275\u0275element(1, "mat-pseudo-checkbox", 6), a.\u0275\u0275elementEnd()), l & 2) {
    let t = a.\u0275\u0275nextContext();
    a.\u0275\u0275advance(), a.\u0275\u0275property("disabled", t.disabled);
} }
var x = new y("MAT_BUTTON_TOGGLE_DEFAULT_OPTIONS", { providedIn: "root", factory: Q });
function Q() { return { hideSingleSelectionIndicator: !1, hideMultipleSelectionIndicator: !1, disabledInteractive: !1 }; }
var T = new y("MatButtonToggleGroup"), j = { provide: P, useExisting: V(() => W), multi: !0 }, d = class {
    source;
    value;
    constructor(b, t) { this.source = b, this.value = t; }
}, W = (() => { class l {
    _changeDetector = r(k);
    _dir = r(M, { optional: !0 });
    _multiple = !1;
    ...
    _name = r(_).getId("mat-button-toggle-group-");
    vertical;
    ...
    constructor() { let t = r(x, { optional: !0 }); this.appearance = t && t.appearance ? t.appearance : "standard", this.hideSingleSelectionIndicator = t?.hideSingleSelectionIndicator ?? !1, this.hideMultipleSelectionIndicator = t?.hideMultipleSelectionIndicator ?? !1; }
    ...
    _keydown(t) { if (this.multiple || this.disabled || G(t))
    ...
    class l {
        ...
        change = new u;
        constructor() { r(D).load(f); let t = r(T, { optional: !0 }), o = r(new L("tabindex"), { optional: !0 }) || "", e = r(x, { optional: !0 }); this._tabIndex = N(parseInt(o) || 0), this.buttonToggleGroup = t, this.appearance = e && e.appearance ? e.appearance : "standard", this.disabledInteractive = e?.disabledInteractive ?? !1; }
        ...
        static \u0275fac = function (o) { return new (o || l); };
        static \u0275cmp = a.\u0275\u0275defineComponent({ type: l, selectors: [["mat-button-toggle"]], viewQuery: function (o, e) { if (o & 1 && a.\u0275\u0275viewQuery(z, 5), o & 2) {
                let n;
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    static \u0275inj = a.\u0275\u0275defineInjector({ imports: [c, v, I, c] });
} return l; })();
export { x as MAT_BUTTON_TOGGLE_DEFAULT_OPTIONS, T as MAT_BUTTON_TOGGLE_GROUP, Q as MAT_BUTTON_TOGGLE_GROUP_DEFAULT_OPTIONS_FACTORY, j as MAT_BUTTON_TOGGLE_GROUP_VALUE_ACCESSOR, I as MatButtonToggle, d as MatButtonToggleChange, W as MatButtonToggleGroup, vt as MatButtonToggleModule };
//# sourceMappingURL=_angular_material_button_toggle.GxCklLQQ-9.js.map
