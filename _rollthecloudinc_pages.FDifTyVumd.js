...
import { EventEmitter as $, forwardRef as Y, InjectionToken as fi } from "@angular/core";
import * as v from "@angular/common";
import { CommonModule as hi } from "@angular/common";
import * as se from "@angular/router";
import { UrlSegment as lt, RouterModule as vi } from "@angular/router";
...
import * as Bt from "ngx-markdown";
import { MarkdownModule as _i, MarkdownComponent as Ci } from "ngx-markdown";
import * as Le from "angular-split";
import { AngularSplitModule as Si } from "angular-split";
import * as he from "ngx-dropzone";
import { NgxDropzoneModule as xi } from "ngx-dropzone";
import { MaterialModule as wi } from "@rollthecloudinc/material";
import { NgxJsonViewerModule as Pi } from "ngx-json-viewer";
import * as Lt from "@rollthecloudinc/ngx-angular-query-builder";
import { NgxAngularQueryBuilderModule as Fi } from "@rollthecloudinc/ngx-angular-query-builder";
import * as gt from "@rollthecloudinc/media";
...
import { SITE_NAME as qe, UtilsModule as Ei, EMBEDDABLE_COMPONENT as rt } from "@rollthecloudinc/utils";
import * as N from "@rollthecloudinc/token";
import { TokenModule as $i } from "@rollthecloudinc/token";
import * as P from "@rollthecloudinc/attributes";
import { AttributeValue as ae, AttributeTypes as ie, Attribute as qt, ATTRIBUTE_WIDGET as Ut, AttributesModule as Di } from "@rollthecloudinc/attributes";
import * as Ht from "@rollthecloudinc/layout";
import { GridLayoutComponent as Ri, SplitLayoutComponent as ji, LayoutModule as Oi } from "@rollthecloudinc/layout";
import * as ft from "@rollthecloudinc/rest";
import { RestSourceFormComponent as Qt, RestModule as Ni } from "@rollthecloudinc/rest";
import * as Ue from "@rollthecloudinc/snippet";
import { Snippet as wt, SnippetModule as ki } from "@rollthecloudinc/snippet";
import * as ve from "@rollthecloudinc/content";
import { ContentBinding as He, ContentPluginEditorOptions as le, ContentPlugin as Te, CONTENT_PLUGIN as de } from "@rollthecloudinc/content";
import * as A from "@rollthecloudinc/context";
import { InlineContext as ue, ContextFormComponent as Vi, ContextPlugin as Me, ResolvedContextPlugin as Gi, ContextModule as Ai } from "@rollthecloudinc/context";
import { DisplayGrid as zi, GridType as Bi, GridsterModule as Li } from "angular-gridster2";
import * as be from "@angular/material/bottom-sheet";
import { MAT_BOTTOM_SHEET_DATA as Wt } from "@angular/material/bottom-sheet";
...
import * as L from "@angular/material/tabs";
import { Observable as ke, of as f, Subject as B, BehaviorSubject as J, combineLatest as fe, forkJoin as We, iif as Pe, from as qi, merge as Jt } from "rxjs";
import { map as m, switchMap as b, tap as F, filter as T, debounceTime as pe, delay as je, take as G, withLatestFrom as Pt, distinctUntilChanged as ht, defaultIfEmpty as vt, skip as Ui, catchError as Hi } from "rxjs/operators";
import * as Je from "@rollthecloudinc/datasource";
import { Dataset as H, Datasource as Ft, Rest as me, SelectMapping as Kt, SelectOption as Qi, DatasourcePlugin as Wi, DatasourceModule as Ji } from "@rollthecloudinc/datasource";
var Xe = mi(gi(), 1);
import * as y from "@rollthecloudinc/panels";
import { PropertiesFormPayload as xe, PanelPropsFormPayload as Yt, PanePropsFormPayload as Xt, PrerenderFormPayload as we, PaneState as Ie, LayoutSetting as O, Pane as j, PanelPage as ye, PanelPageStateSlice as Ve, selectDataset as Oe, Panel as Ke, FormDatasource as ct, StylePlugin as dt, PanelPageForm as Ge, PaneDatasourceService as Zt, PanelStyleRendererBaseComponent as Ki, PanelPageSelector as It, PanelPageState as Tt, PanelState as Yi, STYLE_PLUGIN as Re, PanelsModule as Xi } from "@rollthecloudinc/panels";
import { PersistenceFormPayload as at, PersistenceDialogComponent as Zi } from "@rollthecloudinc/refinery";
import * as Ye from "@rollthecloudinc/rules";
import * as z from "@angular/material/button";
import * as x from "@angular/material/input";
import { InteractionsFormPayload as ot, InteractionsDialogComponent as en } from "@rollthecloudinc/detour";
...
import { createSelector as Mt, select as K } from "@ngrx/store";
import * as M from "@ngrx/data";
import * as ti from "@angular/cdk/drag-drop";
import { getRouterSelectors as pt } from "@ngrx/router-store";
import * as Ee from "@rollthecloudinc/crud";
import { CrudAdaptorPlugin as tn } from "@rollthecloudinc/crud";
import * as $e from "@rollthecloudinc/render";
import { RenderModule as nn } from "@rollthecloudinc/render";
...
import * as et from "@angular/material/radio";
import * as tt from "@rollthecloudinc/dparam";
import { ParamPlugin as rn, Param as Et, DparamModule as an } from "@rollthecloudinc/dparam";
import * as ii from "@rollthecloudinc/bridge";
import { BridgeBuilderPlugin as on, PublicApiBridgeService as sn, BridgeModule as ln } from "@rollthecloudinc/bridge";
import * as Ce from "@angular/cdk/scrolling";
import $t from "qs";
import * as it from "@angular/material/sort";
import * as I from "@angular/material/table";
import * as ni from "@rollthecloudinc/plugin";
import * as ri from "@angular/common/http";
function cn(r, d) { if (r & 1) {
...
function gn(r, d) { }
var fn = ["contentEditor"], nt = r => ({ settings: r }), hn = r => ({ visible: r });
function vn(r, d) { r & 1 && e.\u0275\u0275elementContainer(0); }
...
function Cn(r, d) { if (r & 1) {
    let t = e.\u0275\u0275getCurrentView();
    e.\u0275\u0275elementStart(0, "div", 11)(1, "div", 12)(2, "div", 13)(3, "button", 14)(4, "mat-icon"), e.\u0275\u0275text(5, "more_vert"), e.\u0275\u0275elementEnd()()(), e.\u0275\u0275elementStart(6, "mat-expansion-panel", 15), e.\u0275\u0275listener("afterCollapse", function () { e.\u0275\u0275restoreView(t); let n = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(n.onAfterCollapse()); })("afterExpand", function () { e.\u0275\u0275restoreView(t); let n = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(n.onAfterExpand()); }), e.\u0275\u0275elementStart(7, "mat-expansion-panel-header")(8, "mat-panel-title"), e.\u0275\u0275text(9), e.\u0275\u0275elementEnd()(), e.\u0275\u0275elementStart(10, "div", 16)(11, "ul"), e.\u0275\u0275template(12, vn, 1, 0, "ng-container", 17), e.\u0275\u0275elementEnd()(), e.\u0275\u0275elementStart(13, "div", 18), e.\u0275\u0275template(14, bn, 2, 0, "button", 19)(15, yn, 2, 0, "button", 19), e.\u0275\u0275elementContainerStart(16), e.\u0275\u0275template(17, _n, 0, 0, "ng-template", 20), e.\u0275\u0275elementContainerEnd(), e.\u0275\u0275elementEnd()()()();
} if (r & 2) {
    let t = e.\u0275\u0275nextContext(), i = e.\u0275\u0275reference(2), n = e.\u0275\u0275reference(6);
    e.\u0275\u0275advance(3), e.\u0275\u0275property("matMenuTriggerFor", n), e.\u0275\u0275advance(6), e.\u0275\u0275textInterpolate2("", t.contentPlugin.title, " : ", t.name), e.\u0275\u0275advance(), e.\u0275\u0275property("hidden", t.preview), e.\u0275\u0275advance(2), e.\u0275\u0275property("ngTemplateOutlet", i)("ngTemplateOutletContext", e.\u0275\u0275pureFunction1(9, nt, t.settings)), e.\u0275\u0275advance(), e.\u0275\u0275property("ngClass", e.\u0275\u0275pureFunction1(11, hn, t.preview)), e.\u0275\u0275advance(), e.\u0275\u0275property("ngIf", t.displayOverride && !t.hasOverride), e.\u0275\u0275advance(), e.\u0275\u0275property("ngIf", t.displayOverride && t.hasOverride);
} }
function Sn(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "span"), e.\u0275\u0275text(1), e.\u0275\u0275pipe(2, "attribute"), e.\u0275\u0275elementEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext().$implicit, i = e.\u0275\u0275nextContext().settings;
    e.\u0275\u0275advance(), e.\u0275\u0275textInterpolate(e.\u0275\u0275pipeBind2(2, 1, i, t.name));
} }
function xn(r, d) { r & 1 && e.\u0275\u0275elementContainer(0); }
function wn(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "ul"), e.\u0275\u0275template(1, xn, 1, 0, "ng-container", 17), e.\u0275\u0275elementEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext().$implicit;
    e.\u0275\u0275nextContext(2);
    let i = e.\u0275\u0275reference(2);
    e.\u0275\u0275advance(), e.\u0275\u0275property("ngTemplateOutlet", i)("ngTemplateOutletContext", e.\u0275\u0275pureFunction1(2, nt, t.attributes));
} }
function Pn(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "li"), e.\u0275\u0275text(1), e.\u0275\u0275template(2, Sn, 3, 4, "span", 23)(3, wn, 2, 4, "ul", 23), e.\u0275\u0275elementEnd()), r & 2) {
...
function Fn(r, d) { if (r & 1 && e.\u0275\u0275template(0, Pn, 4, 3, "li", 22), r & 2) {
    let t = d.settings;
...
var $n = ["extraActionsArea"], Dn = ["contextsMenuTpl"], Rn = ["editablePaneTpl"], jn = ["panes"], ai = r => ({ nested: r });
function On(r, d) { }
function Nn(r, d) { if (r & 1) {
    let t = e.\u0275\u0275getCurrentView();
    e.\u0275\u0275elementStart(0, "form", 7), e.\u0275\u0275listener("ngSubmit", function () { e.\u0275\u0275restoreView(t); let n = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(n.submit()); }), e.\u0275\u0275elementContainerStart(1), e.\u0275\u0275template(2, On, 0, 0, "ng-template", 8), e.\u0275\u0275elementContainerEnd(), e.\u0275\u0275elementEnd();
} if (r & 2) {
    let t = e.\u0275\u0275nextContext();
    e.\u0275\u0275property("formGroup", t.contentForm)("ngClass", e.\u0275\u0275pureFunction1(2, ai, t.nested));
} }
function kn(r, d) { }
function Vn(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "div", 9), e.\u0275\u0275elementContainerStart(1), e.\u0275\u0275template(2, kn, 0, 0, "ng-template", 8), e.\u0275\u0275elementContainerEnd(), e.\u0275\u0275elementEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext();
    e.\u0275\u0275property("formGroup", t.contentForm)("ngClass", e.\u0275\u0275pureFunction1(2, ai, t.nested));
} }
function Gn(r, d) { r & 1 && e.\u0275\u0275element(0, "div", 12); }
function An(r, d) { if (r & 1) {
    let t = e.\u0275\u0275getCurrentView();
    e.\u0275\u0275elementStart(0, "classifieds-ui-editable-pane", 10), e.\u0275\u0275listener("delete", function () { let n = e.\u0275\u0275restoreView(t), a = n.i, o = n.j, s = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(s.onDeletePane(a, o)); })("rules", function () { let n = e.\u0275\u0275restoreView(t), a = n.i, o = n.j, s = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(s.onRulesPane(a, o)); })("nestedUpdate", function (n) { let a = e.\u0275\u0275restoreView(t), o = a.i, s = a.j, c = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(c.onNestedUpdate(n, o, s)); })("rendererOverride", function () { let n = e.\u0275\u0275restoreView(t), a = n.i, o = n.j, s = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(s.onOverrideRenderer(a, o)); })("removeRendererOverride", function () { let n = e.\u0275\u0275restoreView(t), a = n.i, o = n.j, s = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(s.onRemoveOverrideRenderer(a, o)); })("edit", function () { let n = e.\u0275\u0275restoreView(t), a = n.i, o = n.j, s = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(s.onPaneEdit(a, o)); })("props", function () { let n = e.\u0275\u0275restoreView(t), a = n.i, o = n.j, s = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(s.editPaneProps(a, o)); })("delete", function () { let n = e.\u0275\u0275restoreView(t), a = n.i, o = n.j, s = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(s.onPaneDelete(a, o)); }), e.\u0275\u0275template(1, Gn, 1, 0, "div", 11), e.\u0275\u0275elementEnd();
} if (r & 2) {
...
function zn(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "button", 13), e.\u0275\u0275text(1, "( x )"), e.\u0275\u0275elementEnd()), r & 2) {
    e.\u0275\u0275nextContext();
...
function Un(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "span"), e.\u0275\u0275text(1), e.\u0275\u0275elementEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext().$implicit;
    e.\u0275\u0275advance(), e.\u0275\u0275textInterpolate1("", t.displayName, ": ");
} }
function Hn(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "span"), e.\u0275\u0275text(1), e.\u0275\u0275pipe(2, "attribute"), e.\u0275\u0275elementEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext().$implicit, i = e.\u0275\u0275nextContext().settings;
    e.\u0275\u0275advance(), e.\u0275\u0275textInterpolate(e.\u0275\u0275pipeBind2(2, 1, i, t.name));
} }
function Qn(r, d) { r & 1 && e.\u0275\u0275elementContainer(0); }
function Wn(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "div"), e.\u0275\u0275template(1, Qn, 1, 0, "ng-container", 5), e.\u0275\u0275elementEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext().$implicit;
    e.\u0275\u0275nextContext(2);
    let i = e.\u0275\u0275reference(3);
    e.\u0275\u0275advance(), e.\u0275\u0275property("ngTemplateOutlet", i)("ngTemplateOutletContext", e.\u0275\u0275pureFunction1(2, nt, t.attributes));
} }
function Jn(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "div"), e.\u0275\u0275template(1, Un, 2, 1, "span", 3)(2, Hn, 3, 4, "span", 3)(3, Wn, 2, 4, "div", 3), e.\u0275\u0275elementEnd()), r & 2) {
    let t = d.$implicit;
...
function Kn(r, d) { if (r & 1 && e.\u0275\u0275template(0, Jn, 4, 3, "div", 6), r & 2) {
    let t = d.settings;
    e.\u0275\u0275property("ngForOf", t);
} }
function Yn(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "div"), e.\u0275\u0275template(1, qn, 1, 0, "ng-container", 5)(2, Kn, 1, 1, "ng-template", null, 1, e.\u0275\u0275templateRefExtractor), e.\u0275\u0275elementEnd()), r & 2) {
    let t = e.\u0275\u0275reference(3), i = e.\u0275\u0275nextContext(2);
    e.\u0275\u0275advance(), e.\u0275\u0275property("ngTemplateOutlet", t)("ngTemplateOutletContext", e.\u0275\u0275pureFunction1(2, nt, i.attributeValues));
} }
function Xn(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "div", 7), e.\u0275\u0275element(1, "classifieds-ui-attributes-builder", 8), e.\u0275\u0275elementEnd()), r & 2) {
...
function Zn(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "div"), e.\u0275\u0275template(1, Yn, 4, 4, "div", 3)(2, Xn, 2, 3, "div", 4), e.\u0275\u0275elementEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext();
    e.\u0275\u0275advance(), e.\u0275\u0275property("ngIf", t.displayType == "page"), e.\u0275\u0275advance(), e.\u0275\u0275property("ngIf", t.displayType == "form");
} }
function er(r, d) { if (r & 1 && e.\u0275\u0275element(0, "classifieds-ui-snippet-pane-renderer", 9), r & 2) {
    let t = e.\u0275\u0275nextContext();
    e.\u0275\u0275property("settings", t.rendererSettings)("tokens", t.tokens);
} }
function tr(r, d) { if (r & 1) {
    let t = e.\u0275\u0275getCurrentView();
...
var ir = ["img"];
function nr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "mat-option", 26), e.\u0275\u0275text(1), e.\u0275\u0275elementEnd()), r & 2) {
    let t = d.$implicit;
    e.\u0275\u0275property("value", t), e.\u0275\u0275advance(), e.\u0275\u0275textInterpolate(t);
} }
function rr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "div")(1, "mat-form-field", 23)(2, "mat-label"), e.\u0275\u0275text(3, "Pane"), e.\u0275\u0275elementEnd(), e.\u0275\u0275elementStart(4, "mat-select", 24), e.\u0275\u0275template(5, nr, 2, 2, "mat-option", 25), e.\u0275\u0275elementEnd()()()), r & 2) {
    let t = d.index, i = e.\u0275\u0275nextContext(2);
    e.\u0275\u0275advance(), e.\u0275\u0275property("formGroupName", t), e.\u0275\u0275advance(4), e.\u0275\u0275property("ngForOf", i.panes);
} }
function ar(r, d) { if (r & 1) {
    let t = e.\u0275\u0275getCurrentView();
    e.\u0275\u0275elementStart(0, "div", 20)(1, "button", 21), e.\u0275\u0275listener("click", function () { e.\u0275\u0275restoreView(t); let n = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(n.addPane()); }), e.\u0275\u0275text(2, "Add Pane"), e.\u0275\u0275elementEnd(), e.\u0275\u0275elementStart(3, "div"), e.\u0275\u0275template(4, rr, 6, 2, "div", 22), e.\u0275\u0275elementEnd()();
} if (r & 2) {
    let t = e.\u0275\u0275nextContext();
    e.\u0275\u0275advance(4), e.\u0275\u0275property("ngForOf", t.bindings.controls);
} }
function or(r, d) { r & 1 && (e.\u0275\u0275elementStart(0, "div", 27)(1, "mat-form-field"), e.\u0275\u0275element(2, "input", 28), e.\u0275\u0275elementEnd(), e.\u0275\u0275elementStart(3, "mat-form-field"), e.\u0275\u0275element(4, "input", 29), e.\u0275\u0275elementEnd(), e.\u0275\u0275elementStart(5, "mat-form-field"), e.\u0275\u0275element(6, "input", 30), e.\u0275\u0275elementEnd(), e.\u0275\u0275elementStart(7, "div")(8, "mat-checkbox", 31), e.\u0275\u0275text(9, "Multiple"), e.\u0275\u0275elementEnd()(), e.\u0275\u0275elementStart(10, "mat-form-field"), e.\u0275\u0275element(11, "input", 32), e.\u0275\u0275elementEnd()()); }
function sr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "mat-option", 8), e.\u0275\u0275text(1), e.\u0275\u0275elementEnd()), r & 2) {
    let t = d.$implicit;
    e.\u0275\u0275property("value", t.value), e.\u0275\u0275advance(), e.\u0275\u0275textInterpolate(t.label);
} }
function lr(r, d) { if (r & 1 && (e.\u0275\u0275elementContainerStart(0), e.\u0275\u0275elementStart(1, "mat-form-field")(2, "mat-label"), e.\u0275\u0275text(3), e.\u0275\u0275elementEnd(), e.\u0275\u0275elementStart(4, "mat-select", 6), e.\u0275\u0275template(5, sr, 2, 2, "mat-option", 7), e.\u0275\u0275elementEnd()(), e.\u0275\u0275elementContainerEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext();
    e.\u0275\u0275advance(3), e.\u0275\u0275textInterpolate(t.label), e.\u0275\u0275advance(2), e.\u0275\u0275property("ngForOf", t.options);
} }
function cr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "mat-radio-button", 8), e.\u0275\u0275text(1), e.\u0275\u0275elementEnd()), r & 2) {
    let t = d.$implicit;
    e.\u0275\u0275property("value", t.value), e.\u0275\u0275advance(), e.\u0275\u0275textInterpolate(t.label);
} }
function dr(r, d) { if (r & 1 && (e.\u0275\u0275elementContainerStart(0), e.\u0275\u0275elementStart(1, "div")(2, "label"), e.\u0275\u0275text(3), e.\u0275\u0275elementEnd(), e.\u0275\u0275elementStart(4, "mat-radio-group", 6), e.\u0275\u0275template(5, cr, 2, 2, "mat-radio-button", 7), e.\u0275\u0275elementEnd()(), e.\u0275\u0275elementContainerEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext();
    e.\u0275\u0275advance(3), e.\u0275\u0275textInterpolate(t.label), e.\u0275\u0275advance(2), e.\u0275\u0275property("ngForOf", t.options);
} }
function pr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "div")(1, "div", 10)(2, "mat-checkbox", 11), e.\u0275\u0275text(3), e.\u0275\u0275elementEnd()()()), r & 2) {
    let t = d.$implicit, i = d.index;
    e.\u0275\u0275advance(), e.\u0275\u0275property("formGroupName", i), e.\u0275\u0275advance(2), e.\u0275\u0275textInterpolate(t.label);
} }
function ur(r, d) { if (r & 1 && (e.\u0275\u0275elementContainerStart(0), e.\u0275\u0275elementStart(1, "div")(2, "div", 2), e.\u0275\u0275template(3, pr, 4, 2, "div", 9), e.\u0275\u0275elementEnd()(), e.\u0275\u0275elementContainerEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext();
    e.\u0275\u0275advance(3), e.\u0275\u0275property("ngForOf", t.options);
} }
function mr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "mat-option", 8), e.\u0275\u0275text(1), e.\u0275\u0275elementEnd()), r & 2) {
    let t = d.$implicit;
    e.\u0275\u0275property("value", t), e.\u0275\u0275advance(), e.\u0275\u0275textInterpolate(t.label);
} }
function gr(r, d) { if (r & 1) {
    let t = e.\u0275\u0275getCurrentView();
    e.\u0275\u0275elementContainerStart(0), e.\u0275\u0275elementStart(1, "mat-form-field"), e.\u0275\u0275element(2, "input", 12), e.\u0275\u0275elementStart(3, "mat-autocomplete", 13, 0), e.\u0275\u0275listener("optionSelected", function (n) { e.\u0275\u0275restoreView(t); let a = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(a.onOptionSelected(n)); }), e.\u0275\u0275template(5, mr, 2, 2, "mat-option", 7), e.\u0275\u0275elementEnd()(), e.\u0275\u0275elementContainerEnd();
} if (r & 2) {
...
function fr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "mat-option", 8), e.\u0275\u0275text(1), e.\u0275\u0275elementEnd()), r & 2) {
    let t = d.$implicit;
    e.\u0275\u0275property("value", t.name), e.\u0275\u0275advance(), e.\u0275\u0275textInterpolate(t.name);
} }
function hr(r, d) { if (r & 1) {
    let t = e.\u0275\u0275getCurrentView();
...
function vr(r, d) { if (r & 1 && e.\u0275\u0275element(0, "classifieds-ui-render-pane", 4), r & 2) {
...
function br(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "mat-tab"), e.\u0275\u0275template(1, vr, 1, 3, "ng-template", 3), e.\u0275\u0275element(2, "classifieds-ui-render-pane", 4), e.\u0275\u0275elementEnd()), r & 2) {
    let t = d.index, i = e.\u0275\u0275nextContext(2);
...
function yr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "mat-tab-group", 1), e.\u0275\u0275template(1, br, 3, 3, "mat-tab", 2), e.\u0275\u0275elementEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext();
    e.\u0275\u0275advance(), e.\u0275\u0275property("for", t.panes.length / 2);
} }
function _r(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "mat-tab", 6), e.\u0275\u0275element(1, "classifieds-ui-render-pane", 4), e.\u0275\u0275elementEnd()), r & 2) {
    let t = d.$implicit;
    e.\u0275\u0275advance(), e.\u0275\u0275property("pluginName", t.contentPlugin)("settings", t.settings)("contexts", t.contexts);
} }
function Cr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "mat-tab-group", 1), e.\u0275\u0275template(1, _r, 2, 3, "mat-tab", 5), e.\u0275\u0275elementEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext();
    e.\u0275\u0275advance(), e.\u0275\u0275property("ngForOf", t.panes);
} }
function Sr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "div", 2), e.\u0275\u0275element(1, "classifieds-ui-render-pane", 3), e.\u0275\u0275elementEnd()), r & 2) {
    let t = d.$implicit;
...
function xr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "th", 7), e.\u0275\u0275text(1), e.\u0275\u0275elementEnd()), r & 2) {
    let t = e.\u0275\u0275nextContext().$implicit;
    e.\u0275\u0275advance(), e.\u0275\u0275textInterpolate(t);
} }
function wr(r, d) { if (r & 1 && (e.\u0275\u0275elementStart(0, "td", 8), e.\u0275\u0275text(1), e.\u0275\u0275elementEnd()), r & 2) {
    let t = d.$implicit, i = e.\u0275\u0275nextContext().$implicit, n = e.\u0275\u0275nextContext();
    e.\u0275\u0275advance(), e.\u0275\u0275textInterpolate(n.rowData(i, t));
} }
function Pr(r, d) { if (r & 1 && (e.\u0275\u0275elementContainerStart(0, 4), e.\u0275\u0275template(1, xr, 2, 1, "th", 5)(2, wr, 2, 1, "td", 6), e.\u0275\u0275elementContainerEnd()), r & 2) {
    let t = d.$implicit;
    e.\u0275\u0275property("matColumnDef", t);
} }
function Fr(r, d) { r & 1 && e.\u0275\u0275element(0, "tr", 9); }
...
var Tr = { GridLayout: { entityName: "GridLayout" }, PanelPageForm: { crud: { panelpageform_serialize: { plugins: { idb_keyval: { params: { prefix: "panelpageform__" } } } } } } }, Ae = (() => { class r {
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(Wt), e.\u0275\u0275directiveInject(be.MatBottomSheetRef), e.\u0275\u0275directiveInject(h.MatDialog), e.\u0275\u0275directiveInject(e.ComponentFactoryResolver), e.\u0275\u0275directiveInject(l.UntypedFormBuilder), e.\u0275\u0275directiveInject(ve.ContentPluginManager)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-content-selector"]], viewQuery: function (i, n) { if (i & 1 && e.\u0275\u0275viewQuery(Ae, 7), i & 2) {
        ...
        } }, standalone: !1, decls: 10, vars: 6, consts: [[1, "content-selector-wrapper"], [3, "selectedIndex"], ["mat-list-item", "", "mat-list-item", "", 3, "click", 4, "ngFor", "ngForOf"], ["classifiedsUiContentSelectionHost", ""], ["mat-list-item", "", "mat-list-item", "", 3, "click"], ["mat-line", ""]], template: function (i, n) { i & 1 && (e.\u0275\u0275elementStart(0, "div", 0)(1, "mat-tab-group", 1)(2, "mat-tab")(3, "mat-nav-list"), e.\u0275\u0275template(4, cn, 3, 1, "a", 2), e.\u0275\u0275pipe(5, "async"), e.\u0275\u0275pipe(6, "keyvalue"), e.\u0275\u0275elementEnd()(), e.\u0275\u0275elementStart(7, "mat-tab"), e.\u0275\u0275elementContainerStart(8), e.\u0275\u0275template(9, dn, 0, 0, "ng-template", 3), e.\u0275\u0275elementContainerEnd(), e.\u0275\u0275elementEnd()()()), i & 2 && (e.\u0275\u0275advance(), e.\u0275\u0275property("selectedIndex", n.selectedIndex), e.\u0275\u0275advance(3), e.\u0275\u0275property("ngForOf", e.\u0275\u0275pipeBind1(6, 4, e.\u0275\u0275pipeBind1(5, 2, n.contentPlugins)))); }, dependencies: [v.NgForOf, Qe.MatLine, Z.MatNavList, Z.MatListItem, L.MatTab, L.MatTabGroup, Ae, v.AsyncPipe, v.KeyValuePipe], styles: [".content-selector-wrapper[_ngcontent-%COMP%]     .mat-mdc-tab-header{display:none}"] }); }
} return r; })(), ne = (() => { class r {
    constructor(t, i) { this.attributeSerializer = t, this.tokenizrService = i, this.types = ["text/markdown", "text/html"]; }
    handleFile(t) { return new ke(i => { let n = new FileReader; n.onload = () => { i.next(this.buildSettings(new wt({ contentType: t.type, content: `${n.result}` }))), i.complete(); }, n.readAsText(t); }); }
    ...
    editorOptions(t) { return f(new le({ fullscreen: !0 })); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(P.AttributeSerializerService), e.\u0275\u0275inject(N.TokenizerService)); }; }
    ...
    constructor(t, i, n, a) { this.hostEl = t, this.handler = i, this.tokenizerService = n, this.markdownService = a, this.contexts = [], this.afterContentInit$ = new B, this.content = "", this.content$ = new J(""), this.settings$ = new J([]), this.snippet$ = new J(void 0), this.resolvedContext$ = new J(void 0), this.docRendered$ = new B, this.contentSub = fe([this.afterContentInit$, this.content$, this.snippet$, this.docRendered$]).subscribe(([o, s, c]) => { c && c.jsScript && c.jsScript !== "" && setTimeout(() => this.appendScript(c.jsScript)); }), this.renderContentSub = fe([this.settings$, this.resolvedContext$]).pipe(b(([o, s]) => this.handler.toObject(o)), b(o => this.resolveContexts().pipe(m(s => [o, s])))).subscribe(c => St(this, [c], function* ([o, s]) { s !== void 0 && (this.tokens = s), this.contentType = o.contentType, this.snippet$.next(o); let u = this.replaceTokens(o.content), C; o.contentType && o.contentType.indexOf("markdown") !== -1 ? C = yield Promise.resolve(this.markdownService.parse(u)) : C = u, this.content$.next(C); })); }
    ngOnInit() { }
    ...
    resolveContexts() { return new ke(t => { let i = new Map; if (this.resolvedContext$.value)
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(e.ElementRef), e.\u0275\u0275directiveInject(ne), e.\u0275\u0275directiveInject(N.TokenizerService), e.\u0275\u0275directiveInject(Bt.MarkdownService)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-snippet-pane-renderer"]], inputs: { settings: "settings", contexts: "contexts", tokens: "tokens", resolvedContext: "resolvedContext" }, standalone: !1, features: [e.\u0275\u0275NgOnChangesFeature], decls: 2, vars: 2, consts: [[3, "content", "docRendered", 4, "ngIf"], [3, "docRendered", "content"]], template: function (i, n) { i & 1 && e.\u0275\u0275template(0, pn, 2, 3, "classifieds-ui-dynamic-content-viewer", 0)(1, un, 2, 3, "classifieds-ui-dynamic-content-viewer", 0), i & 2 && (e.\u0275\u0275property("ngIf", n.contentType == "text/markdown"), e.\u0275\u0275advance(), e.\u0275\u0275property("ngIf", n.contentType == "text/html")); }, dependencies: [v.NgIf, X.DynamicContentViewer, v.AsyncPipe], encapsulation: 2 }); }
} return r; })(), re = (() => { class r {
    ...
    rendererOverrideSettings(t) { return [new ae({ name: "_renderer", type: ie.Complex, displayName: "Renderer Override", value: void 0, computedValue: void 0, intValue: 0, attributes: this.snippetHandler.buildSettings(t) })]; }
    widgetSettings(t) { return [new ae({ name: "widget", type: t.schema.type, displayName: "Widget", value: t.name, computedValue: t.name, intValue: 0, attributes: [] })]; }
    stateDefinition(t) { return f({}); }
    editorOptions(t) { return f(new le); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(ne)); }; }
    static { this.\u0275prov = e.\u0275\u0275defineInjectable({ token: r, factory: r.\u0275fac }); }
} return r; })(), Er = (() => { class r {
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(k), e.\u0275\u0275directiveInject(h.MatDialogRef), e.\u0275\u0275directiveInject(N.TokenizerService), e.\u0275\u0275directiveInject(re), e.\u0275\u0275directiveInject(l.UntypedFormBuilder)); }; }
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(Wt), e.\u0275\u0275directiveInject(y.StylePluginManager), e.\u0275\u0275directiveInject(be.MatBottomSheetRef), e.\u0275\u0275directiveInject(h.MatDialog), e.\u0275\u0275directiveInject(e.ComponentFactoryResolver), e.\u0275\u0275directiveInject(l.UntypedFormBuilder)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-style-selector"]], viewQuery: function (i, n) { if (i & 1 && e.\u0275\u0275viewQuery(Ae, 7), i & 2) {
            let a;
            e.\u0275\u0275queryRefresh(a = e.\u0275\u0275loadQuery()) && (n.selectionHost = a.first);
        } }, standalone: !1, decls: 10, vars: 6, consts: [[1, "style-selector-wrapper"], [3, "selectedIndex"], ["mat-list-item", "", "mat-list-item", "", 3, "click", 4, "ngFor", "ngForOf"], ["classifiedsUiContentSelectionHost", ""], ["mat-list-item", "", "mat-list-item", "", 3, "click"], ["mat-line", ""]], template: function (i, n) { i & 1 && (e.\u0275\u0275elementStart(0, "div", 0)(1, "mat-tab-group", 1)(2, "mat-tab")(3, "mat-nav-list"), e.\u0275\u0275template(4, mn, 3, 1, "a", 2), e.\u0275\u0275pipe(5, "async"), e.\u0275\u0275pipe(6, "keyvalue"), e.\u0275\u0275elementEnd()(), e.\u0275\u0275elementStart(7, "mat-tab"), e.\u0275\u0275elementContainerStart(8), e.\u0275\u0275template(9, gn, 0, 0, "ng-template", 3), e.\u0275\u0275elementContainerEnd(), e.\u0275\u0275elementEnd()()()), i & 2 && (e.\u0275\u0275advance(), e.\u0275\u0275property("selectedIndex", n.selectedIndex), e.\u0275\u0275advance(3), e.\u0275\u0275property("ngForOf", e.\u0275\u0275pipeBind1(6, 4, e.\u0275\u0275pipeBind1(5, 2, n.stylePlugins)))); }, dependencies: [v.NgForOf, Qe.MatLine, Z.MatNavList, Z.MatListItem, L.MatTab, L.MatTabGroup, Ae, v.AsyncPipe, v.KeyValuePipe], styles: [".style-selector-wrapper[_ngcontent-%COMP%]     .mat-mdc-tab-header{display:none}"] }); }
} return r; })(), Dr = (() => { class r {
    ...
    ngOnInit() { }
    submit() { this.dialogRef.close(new xe(S(_({}, this.propertiesForm.value), { readUserIds: this.propertiesForm.value.readUserIds.map(t => t.userId) }))); }
    ...
    resolve(t, i) { let n = c => c.entities, a = ({ id: c }) => Mt(n, u => u[c] ? u[c] : void 0), o = ({ id: c, path: u }) => Mt(a({ id: c }), C => Xe.JSONPath({ path: u, json: C })), s = "$." + i.selectionPath.map((c, u) => `${(u + 1) % 2 === 0 ? "panes" : (u === 0 ? "" : "nestedPage.") + "panels"}[${c}]`).join("."); return this.entityCollectionService.collection$.pipe(K(o({ id: i.id, path: s })), m(c => c && Array.isArray(c) && c.length !== 0 ? c[0] : this.defaultPaneState(i.value ? i.value : {})), m(c => this.attributeSerializer.deserialize(c.state)), m(c => c ? c.root ? c.root : c : {}), F(c => { console.log(`resolved panestate[id=${i.id}]${s}`), console.log(c); })); }
    defaultPaneState(t) { return new Ie({ state: this.attributeSerializer.serialize(t, "root") }); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(M.EntityServices), e.\u0275\u0275inject(P.AttributeSerializerService)); }; }
    static { this.\u0275prov = e.\u0275\u0275defineInjectable({ token: r, factory: r.\u0275fac }); }
} return r; })(), Ot = (() => { class r {
    set panelIndex(t) { this.panelIndex$.next(t); }
    set paneIndex(t) { this.paneIndex$.next(t); }
    set ancestory(t) { this.ancestory$.next(t); }
    constructor(t, i, n) { this.componentFactoryResolver = t, this.panelHandler = i, this.cpm = n, this.settings = [], this.locked = !1, this.contexts = [], this.edit = new $, this.props = new $, this.delete = new $, this.rules = new $, this.rendererOverride = new $, this.removeRendererOverride = new $, this.nestedUpdate = new $, this.heightChange = new $, this.displayOverride = !1, this.hasOverride = !1, this.preview = !1, this.schedulePluginChange = new B, this.pluginChangeSub = this.schedulePluginChange.pipe(b(a => this.cpm.getPlugin(this.pluginName).pipe(b(o => o.handler.hasRendererOverride(this.settings).pipe(m(s => [a, o, s])))))).subscribe(([a, o, s]) => { this.contentPlugin = o, this.displayOverride = o.handler.implementsRendererOverride(), this.hasOverride = !!s, a && this.pluginName === "panel" && this.panelHandler.toObject(this.settings).subscribe(c => { this.panelPage = c; }); }), this.ancestory$ = new B, this.panelIndex$ = new B, this.paneIndex$ = new B, this.paneAncestoryWithSelf = [], this.paneAncestoryWithSelfSub = fe([this.ancestory$, this.panelIndex$, this.paneIndex$]).pipe(m(([a, o, s]) => [...a, o, s])).subscribe(a => { this.paneAncestoryWithSelf = a; }); }
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(e.ComponentFactoryResolver), e.\u0275\u0275directiveInject(y.PanelContentHandler), e.\u0275\u0275directiveInject(ve.ContentPluginManager)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-editable-pane"]], viewQuery: function (i, n) { if (i & 1 && (e.\u0275\u0275viewQuery(jt, 5), e.\u0275\u0275viewQuery(fn, 5)), i & 2) {
            let a;
    ...
    constructor(t, i, n, a, o, s, c, u, C, w, D, V, ee, E) { this.siteName = t, this.cpm = i, this.spm = n, this.lpm = a, this.cxtm = o, this.fb = s, this.bs = c, this.dialog = u, this.panelHandler = C, this.tokenizerService = w, this.componentFactoryResolver = D, this.pageBuilderFacade = V, this.paneStateContextResolver = ee, this.panelsContextService = E, this.submitted = new $, this.nestedUpdate = new $, this.delete = new $, this.rules = new $, this.props = new $, this.savable = !0, this.nested = !1, this.locked = !1, this.pageBuilder = !1, this.contexts = [], this.contentAdded = new B, this.contentAdddedSub = this.contentAdded.subscribe(([R, Se]) => { this.resolvePaneContexts(R, Se); }), this.dashboard = [], this.pageProperties = new xe, this.persistence = new at, this.interactions = new ot, this.prerenderProperties = new we, this.layoutSetting = new O, this.rowSettings = [], this.ancestory$ = new J([]), this.onTouched = () => { }, this.contentForm = this.fb.group({ name: this.fb.control(""), title: this.fb.control(""), layoutType: this.fb.control("split", g.required), displayType: this.fb.control("page", g.required), panels: this.fb.array([]) }), this.options = { gridType: Bi.Fit, displayGrid: zi.Always, pushItems: !0, draggable: { enabled: !0 }, resizable: { enabled: !0 }, mobileBreakpoint: 0, itemChangeCallback: (R, Se) => { }, itemInitCallback: (R, Se) => { if (this.nested && R.y !== 0) {
            let De = this.gridLayout.grid.findIndex(ce => ce.x === R.x && ce.y === R.y && ce.cols === R.cols && ce.rows === R.rows);
            this.panelPanes(De).length === 0 && this.gridLayout.setItemContentHeight(De, 200);
        } } }, this.ancestorySub = this.ancestory$.pipe(T(() => !!this.layoutEditorRef)).subscribe(R => { this.layoutEditorRef.instance.ancestory = R; }); }
    ngOnInit() { this.contentForm.valueChanges.pipe(T(() => this.nested), pe(500)).subscribe(() => { this.nestedUpdate.emit(this.packageFormData()); }), this.contentForm.get("layoutType").valueChanges.pipe(T(t => t === "gridless"), je(1)).subscribe(t => { this.panels.length === 0 && this.panels.push(this.fb.group({ name: new p(""), label: new p(""), stylePlugin: new p(""), styleTitle: new p(""), settings: new q([]), panes: this.fb.array([]), columnSetting: this.fb.group({ settings: this.fb.array([]) }) })); }), this.contentForm.valueChanges.pipe(T(() => !this.nested), pe(500)).subscribe(() => { let t = this.packageFormData(); this.pageBuilderFacade.setPage(t); }); }
    ngAfterViewInit() { this.layoutType.valueChanges.pipe(T(() => !!this.layoutEditorHost)).subscribe(t => { this.renderEditorLayout(t); }), this.layoutType.value && this.renderEditorLayout(this.layoutType.value); }
    ngAfterContentInit() { setTimeout(() => { this.panelPage || this.contentForm.get("layoutType").setValue("split"); }, 1e3); }
    ngOnChanges(t) { t.panelPage && t.panelPage.previousValue !== t.panelPage.currentValue && (this.panels.clear(), this.panelPageId = t.panelPage.currentValue.panelPageId, this.dashboard = t.panelPage.currentValue.gridItems.map(i => Object.assign({}, i)), this.layoutType.setValue(t.panelPage.currentValue.layoutType), this.layoutSetting = new O(t.panelPage.currentValue.layoutSetting), this.rowSettings = t.panelPage.currentValue.rowSettings ? t.panelPage.currentValue.rowSettings.map(i => new O(i)) : [], this.persistence = t.panelPage.currentValue.persistence ? new at(t.panelPage.currentValue.persistence) : new at, this.interactions = t.panelPage.currentValue.interactions ? new ot(t.panelPage.currentValue.interactions) : new ot, this.prerenderProperties = t.panelPage.currentValue.prerender ? new we(t.panelPage.currentValue.prerender) : new we, this.nested ? (this.pageProperties = new xe({ name: t.panelPage.currentValue.name, title: t.panelPage.currentValue.title, path: "", readUserIds: [], cssFile: "" }), this.contentForm.get("name").setValue(t.panelPage.currentValue.name), this.contentForm.get("title").setValue(t.panelPage.currentValue.title)) : (this.pageProperties = new xe({ name: t.panelPage.currentValue.name, title: t.panelPage.currentValue.title, path: t.panelPage.currentValue.path, readUserIds: t.panelPage.currentValue.entityPermissions.readUserIds, cssFile: t.panelPage.currentValue.cssFile }), this.contexts = t.panelPage.currentValue.contexts), t.panelPage.currentValue.panels.forEach((i, n) => { this.panels.push(this.fb.group({ name: new p(i.name), label: new p(i.label), stylePlugin: new p(i.stylePlugin), styleTitle: new p(""), settings: this.fb.array(i.settings !== void 0 ? i.settings.map(a => this.convertToGroup(a)) : []), panes: this.fb.array([]), columnSetting: this.fb.group({ settings: this.fb.array(i.columnSetting ? i.columnSetting.settings.map(a => this.convertToGroup(a)) : []) }) })), i.stylePlugin && i.stylePlugin !== "" && this.spm.getPlugin(i.stylePlugin).subscribe(a => { this.panels.at(n).get("styleTitle").setValue(a.title); }), this.nested && this.panelPanes(this.panels.length - 1).valueChanges.pipe(pe(5), je(1)).subscribe((a => () => { if (this.gridLayout !== void 0) {
    ...
    addContent(t) { console.log(this.panels.at(t)), this.pageBuilderFacade.getPage$.pipe(b(i => this.panelsContextService.allActivePageContexts({ panelPage: i })), G(1)).subscribe(i => { this.bs.open(Mr, { data: { panelForm: this.panels.at(t), panelIndex: t, contexts: [...this.rootContext ? [this.rootContext] : [], ...this.contexts, ...i] } }); }); }
    editPanelProps(t) { let i = this.panels.at(t).get("name"), n = this.panels.at(t).get("label"); this.dialog.open(jr, { data: { props: new Yt({ name: i.value, label: n.value }) } }).afterClosed().subscribe(a => { a && (i.setValue(a.name), n.setValue(a.label)); }); }
    editPaneProps(t, i) { let n = this.panelPane(t, i).get("name"), a = this.panelPane(t, i).get("label"); this.dialog.open(Or, { data: { props: new Xt({ name: n.value, label: a.value }) } }).afterClosed().subscribe(o => { o && (n.setValue(o.name), a.setValue(o.label)); }); }
    applyStyle(t) { this.bs.open($r, { data: { panelForm: this.panels.controls[t], panelIndex: t, contexts: this.contexts } }); }
    removeStyle(t) { this.panels.controls[t].get("stylePlugin").setValue(""), this.panels.controls[t].get("styleTitle").setValue(""); }
    onItemAdded() { console.log("item added"), this.panels.push(this.fb.group({ name: new p(""), label: new p(""), stylePlugin: new p(""), styleTitle: new p(""), settings: new q([]), panes: this.fb.array([]), columnSetting: this.fb.group({ settings: this.fb.array([]) }) })), this.nested && this.gridLayout !== void 0 && setTimeout(() => { this.paneContainers.forEach((t, i) => { this.gridLayout.setItemContentHeight(i, t.nativeElement.offsetHeight); }); }), this.panelPanes(this.panels.length - 1).valueChanges.pipe(T(() => this.nested && this.gridLayout !== void 0), pe(5), je(1)).subscribe((t => () => { let i = this.paneContainers.find((n, a) => a === t); this.gridLayout.setItemContentHeight(t, i.nativeElement.offsetHeight); })(this.panels.length - 1)), this.layoutEditorRef && (this.layoutEditorRef.instance.columnSettings = this.columnSettings); }
    ...
    onDeleteClick() { this.delete.emit(); }
    onRulesClick() { this.rules.emit(); }
    onPropertiesClick() { this.props.emit(), this.dialog.open(Rr, { data: { props: this.pageProperties } }).afterClosed().subscribe(t => { t && (this.pageProperties = new xe(_({}, t)), this.contentForm.get("name").setValue(t.name), this.contentForm.get("title").setValue(t.title)); }); }
    onPrerenderClick() { this.dialog.open(Nr, { data: { props: this.prerenderProperties } }).afterClosed().subscribe(t => { t && (this.prerenderProperties = new we(_({}, t))); }); }
    onRulesPane(t, i) { let n = new j(this.panelPane(t, i).value), a = this.panelPane(t, i).get("rule").value !== "" ? this.panelPane(t, i).get("rule").value : void 0, [o] = this.editablePanes.filter((s, c) => s.name === n.name); this.pageBuilderFacade.getPage$.pipe(F(() => { this.pageBuilderFacade.setSelectionPath([...this.ancestory, t, i]); }), b(s => this.panelsContextService.allActivePageContexts({ panelPage: s })), b(s => this.dialog.open(Dr, { data: { rule: a, contexts: [...o.rootContext ? [o.rootContext] : this.rootContext ? [this.rootContext] : [], ...this.contexts, ...s] } }).afterClosed()), G(1)).subscribe(s => { this.panelPane(t, i).get("rule").setValue(s || a || void 0); }); }
    onDeletePane(t, i) { console.log(`delete nested pane: ${t} | ${i}`); }
    onAddContextClick() { let t = this.packageFormData(); this.pageBuilderFacade.setPage(t), this.dialog.open(Dt, { data: {} }).afterClosed().subscribe(i => { i && (this.contexts = [...this.contexts, i]); }); }
    onEditContext(t) { let i = this.contexts.find(n => n.name === t); if (console.log(i), i) {
        let n = this.packageFormData();
        this.pageBuilderFacade.setPage(n), this.dialog.open(Dt, { data: { context: i } }).afterClosed().subscribe(a => { a && (this.contexts = this.contexts.map(o => o.name === t ? new ue(a) : o)); });
    } }
    ...
    resolvePaneContexts(t, i) { let n = new j(this.panelPane(t, i).value), a = this.panelPanes(t).controls; this.cpm.getPlugin(n.contentPlugin).pipe(T(o => o.handler !== void 0 && o.handler.isDynamic(n.settings)), b(o => o.handler.fetchDynamicData(n.settings, new Map([["tag", W()], ["contexts", [...this.contexts]]])).pipe(m(s => new ue({ name: "_root", adaptor: "data", data: s.length !== 0 ? s.results[0] : {} })), b(s => o.handler.getBindings(n.settings, "pane").pipe(m(c => [s, c.map(u => a.findIndex(C => new j(C.value).name === u.id))])))))).subscribe(([o, s]) => { this.editablePanes.forEach((c, u) => { s.findIndex(C => C === u) > -1 && (c.rootContext = o); }); }); }
    onPersistenceClick() { this.dialog.open(Zi, { data: { persistence: this.persistence, contexts: this.contexts } }).afterClosed().subscribe(t => { console.log("persistence closed", t), this.persistence = t || this.persistence; }); }
    onInteractionsClick() { this.dialog.open(en, { data: { interactions: this.interactions, contexts: this.contexts }, maxWidth: "100vw", maxHeight: "100vh", height: "100%", width: "100%" }).afterClosed().subscribe(t => { console.log("interactions closed", t), this.interactions = t || this.interactions; }); }
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(qe), e.\u0275\u0275directiveInject(ve.ContentPluginManager), e.\u0275\u0275directiveInject(y.StylePluginManager), e.\u0275\u0275directiveInject(Ht.LayoutPluginManager), e.\u0275\u0275directiveInject(A.ContextPluginManager), e.\u0275\u0275directiveInject(l.UntypedFormBuilder), e.\u0275\u0275directiveInject(be.MatBottomSheet), e.\u0275\u0275directiveInject(h.MatDialog), e.\u0275\u0275directiveInject(y.PanelContentHandler), e.\u0275\u0275directiveInject(N.TokenizerService), e.\u0275\u0275directiveInject(e.ComponentFactoryResolver), e.\u0275\u0275directiveInject(y.PageBuilderFacade), e.\u0275\u0275directiveInject(ut), e.\u0275\u0275directiveInject(y.PanelsContextService)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-content-editor"]], contentQueries: function (i, n, a) { if (i & 1 && e.\u0275\u0275contentQuery(a, $n, 5), i & 2) {
            let o;
            e.\u0275\u0275queryRefresh(o = e.\u0275\u0275loadQuery()) && (n.extraActionsAreaTmpl = o.first);
        } }, viewQuery: function (i, n) { if (i & 1 && (e.\u0275\u0275viewQuery(Ri, 5), e.\u0275\u0275viewQuery(ji, 5), e.\u0275\u0275viewQuery(Rt, 5), e.\u0275\u0275viewQuery(Dn, 7), e.\u0275\u0275viewQuery(Rn, 7), e.\u0275\u0275viewQuery(jn, 5), e.\u0275\u0275viewQuery(Ot, 5)), i & 2) {
            let a;
    ...
    constructor(t, i, n, a, o, s, c) { this.route = t, this.pageBuilderFacade = i, this.routerStore = n, this.asyncApiCallHelperSvc = a, this.crudDataHelperService = o, this.entityDefinitionService = s, this.paramMapSub = this.route.paramMap.pipe(F(() => console.log("param map panelPageId")), m(u => u.get("panelPageId")), T(u => u !== void 0), b(() => this.route.data), Pt(this.routerStore.pipe(K(pt(u => u.router).selectCurrentRoute), m(u => u.params), G(1))), F(([u, C]) => { console.log("route page"); let w = "/pages/panelpage/" + u.panelPageListItem.id; this.pageBuilderFacade.setPageInfo(new Ve({ id: u.panelPageListItem.id, realPath: w, path: u.panelPageListItem.path, args: C })), this.panelPageId = u.panelPageListItem.id; })).subscribe(), this.panelPageService = c.getEntityCollectionService("PanelPage"); }
    ngOnInit() { let { selectCurrentRoute: t } = pt(i => i.router); this.route.paramMap.pipe(F(() => console.log("param map page builder facade info")), Pt(this.pageBuilderFacade.getPageInfo$), T(([i, n]) => n !== void 0 && i.get("panelPageId") !== void 0 && i.get("panelPageId") === n.id), b(([i, n]) => this.routerStore.pipe(K(t), m(a => [n, a.params]), G(1)))).subscribe(([i, n]) => { this.pageBuilderFacade.setPageInfo(new Ve(S(_({}, i), { args: n }))); }); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(se.ActivatedRoute), e.\u0275\u0275directiveInject(y.PageBuilderFacade), e.\u0275\u0275directiveInject(oe.Store), e.\u0275\u0275directiveInject(X.AsyncApiCallHelperService), e.\u0275\u0275directiveInject(Ee.CrudDataHelperService), e.\u0275\u0275directiveInject(M.EntityDefinitionService), e.\u0275\u0275directiveInject(M.EntityServices)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-panel-page-router"]], standalone: !1, decls: 1, vars: 1, consts: [[3, "id"]], template: function (i, n) { i & 1 && e.\u0275\u0275element(0, "classifieds-ui-panel-page", 0), i & 2 && e.\u0275\u0275property("id", n.panelPageId); }, dependencies: [$e.PanelPageComponent], encapsulation: 2 }); }
} return r; })(), Vr = (() => { class r {
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(M.EntityServices)); }; }
    ...
    ngOnInit() { this.route.paramMap.pipe(m(t => t.get("panelPageId")), T(t => t !== void 0), ht(), b(t => this.panelPageService.getByKey(t)), b(t => t ? We(t.contexts.filter(i => i.plugin === "module").map(i => this.moduleLoader.loadModule(() => xt({ remoteEntry: i.data.remoteEntry, remoteName: "plugin", exposedModule: i.data.exposedModule }).then(n => n[i.data.moduleName])))).pipe(je(1), m(() => t), vt(t)) : f(t)), b(t => this.routerStore.pipe(K(pt(i => i.router).selectCurrentRoute), m(i => [t, i.params]), G(1))), F(([t, i]) => this.pageBuilderFacade.setPageInfo(new Ve({ id: t.id, realPath: `/pages/panelpage/${t.id}`, path: t.path, args: i })))).subscribe(([t]) => { console.log(t), this.panelPage = t; }); }
    onSubmit(t) { console.log("submitted"), this.panelPageService.update(new ye(S(_({}, t), { id: this.panelPage.id }))).subscribe(() => { alert("panel page updated"); }); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(se.ActivatedRoute), e.\u0275\u0275directiveInject(y.PageBuilderFacade), e.\u0275\u0275directiveInject(oe.Store), e.\u0275\u0275directiveInject(X.ModuleLoaderService), e.\u0275\u0275directiveInject(M.EntityServices)); }; }
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(be.MatBottomSheetRef), e.\u0275\u0275directiveInject(re), e.\u0275\u0275directiveInject(l.UntypedFormBuilder), e.\u0275\u0275directiveInject(h.MatDialog), e.\u0275\u0275directiveInject(ve.ContentPluginManager), e.\u0275\u0275directiveInject(P.WidgetPluginManager)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-attribute-selector"]], inputs: { panelFormGroup: "panelFormGroup" }, standalone: !1, decls: 4, vars: 5, consts: [["mat-list-item", "", "mat-list-item", "", 3, "click", 4, "ngFor", "ngForOf"], ["mat-list-item", "", "mat-list-item", "", 3, "click"], ["mat-line", ""]], template: function (i, n) { i & 1 && (e.\u0275\u0275elementStart(0, "mat-nav-list"), e.\u0275\u0275template(1, Ln, 3, 1, "a", 0), e.\u0275\u0275pipe(2, "async"), e.\u0275\u0275pipe(3, "keyvalue"), e.\u0275\u0275elementEnd()), i & 2 && (e.\u0275\u0275advance(), e.\u0275\u0275property("ngForOf", e.\u0275\u0275pipeBind1(3, 3, e.\u0275\u0275pipeBind1(2, 1, n.attributeWidgets)))); }, dependencies: [v.NgForOf, Qe.MatLine, Z.MatNavList, Z.MatListItem, v.AsyncPipe, v.KeyValuePipe], encapsulation: 2 }); }
} return r; })(), Ar = (() => { class r {
    ...
    ngOnInit() { let t = this.data.pane.settings.find(a => a.name === "value"); this.attributes = [new qt(S(_({}, this.widget.schema), { widget: this.widget.name, label: "Value", name: "value" }))]; let i = this.data.panelFormGroup.get("panes").at(this.data.paneIndex).get("name").value, n = this.data.panelFormGroup.get("panes").at(this.data.paneIndex).get("label").value; this.attributesFormGroup.get("name").setValue(i), this.attributesFormGroup.get("label").setValue(n), t !== void 0 ? (this.attributeValues = this.handler.valueSettings(this.data.pane.settings), console.log(this.attributeValues)) : this.attributeValues = [new ae({ name: "value", type: this.widget.schema.type, displayName: "Value", value: "", computedValue: "", intValue: 0, attributes: [] })]; }
    ...
    ngOnInit() { this.attributes = [new qt(S(_({}, this.widgets.find(t => t.name === this.settings.find(i => i.name === "widget").value).schema), { name: "value", label: "Value" }))], this.attributeValues = this.handler.valueSettings(this.settings), this.tokens = this.tokenizerService.generateTokens(this.attributeValues), this.handler.rendererSnippet(this.settings).subscribe(t => { this.rendererOverride = t, t !== void 0 && (this.rendererSettings = this.handler.rendererOverrideSettings(t)[0].attributes); }); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(Ut), e.\u0275\u0275directiveInject(re), e.\u0275\u0275directiveInject(N.TokenizerService), e.\u0275\u0275directiveInject(l.UntypedFormBuilder), e.\u0275\u0275directiveInject(l.ControlContainer, 8)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-attribute-pane-renderer"]], inputs: { settings: "settings", appearance: "appearance", name: "name", label: "label", displayType: "displayType" }, standalone: !1, decls: 3, vars: 2, consts: [["overrideTpl", ""], ["settingsTmpl", ""], [4, "ngIf", "ngIfElse"], [4, "ngIf"], [3, "formGroup", 4, "ngIf"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], [4, "ngFor", "ngForOf"], [3, "formGroup"], ["formControlName", "settings", 3, "attributes", "attributeValues"], [3, "settings", "tokens"]], template: function (i, n) { if (i & 1 && e.\u0275\u0275template(0, Zn, 3, 2, "div", 2)(1, er, 1, 2, "ng-template", null, 0, e.\u0275\u0275templateRefExtractor), i & 2) {
            let a = e.\u0275\u0275reference(2);
            e.\u0275\u0275property("ngIf", !n.rendererOverride)("ngIfElse", a);
        } }, dependencies: [v.NgForOf, v.NgIf, v.NgTemplateOutlet, l.NgControlStatus, l.NgControlStatusGroup, l.FormGroupDirective, l.FormControlName, P.AttributesBuilderComponent, oi, P.AttributePipe], styles: [".override[_ngcontent-%COMP%]{position:absolute;top:.5em;right:.5em}"] }); }
} return r; })(), ge = (() => { class r {
    ...
    editorOptions(t) { return f(new le); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(gt.FilesService), e.\u0275\u0275inject(P.AttributeSerializerService)); }; }
    static { this.\u0275prov = e.\u0275\u0275defineInjectable({ token: r, factory: r.\u0275fac }); }
} return r; })(), Br = (() => { class r {
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(k), e.\u0275\u0275directiveInject(h.MatDialogRef), e.\u0275\u0275directiveInject(l.UntypedFormBuilder), e.\u0275\u0275directiveInject(gt.FilesService), e.\u0275\u0275directiveInject(ge)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-media-editor"]], standalone: !1, decls: 4, vars: 3, consts: [[3, "change", "multiple", "accept"], [3, "removable", "file", "removed", 4, "ngIf"], [3, "removed", "removable", "file"]], template: function (i, n) { i & 1 && (e.\u0275\u0275elementStart(0, "ngx-dropzone", 0), e.\u0275\u0275listener("change", function (o) { return n.onSelectMedia(o); }), e.\u0275\u0275elementStart(1, "ngx-dropzone-label"), e.\u0275\u0275text(2, "Drag and Drop Media Here"), e.\u0275\u0275elementEnd(), e.\u0275\u0275template(3, tr, 3, 4, "ngx-dropzone-image-preview", 1), e.\u0275\u0275elementEnd()), i & 2 && (e.\u0275\u0275property("multiple", !1)("accept", n.mediaTypes), e.\u0275\u0275advance(3), e.\u0275\u0275property("ngIf", n.media)); }, dependencies: [v.NgIf, he.NgxDropzoneComponent, he.NgxDropzoneLabelDirective, he.NgxDropzoneImagePreviewComponent], encapsulation: 2 }); }
} return r; })(), Lr = (() => { class r {
    constructor(t, i, n, a) { this.mediaSettings = t, this.handler = i, this.attributeSerializer = n, this.settings = [], this.ancestory = [], this.state = {}, this.stateChange = new $, this.panelPageStateService = a.getEntityCollectionService("PanelPageState"); }
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(Ii), e.\u0275\u0275directiveInject(ge), e.\u0275\u0275directiveInject(P.AttributeSerializerService), e.\u0275\u0275directiveInject(M.EntityServices)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-media-pane-renderer"]], viewQuery: function (i, n) { if (i & 1 && e.\u0275\u0275viewQuery(ir, 7), i & 2) {
            let a;
    ...
    isData(t) { return !1; }
    fetchDynamicData(t, i) { let n = new B; return this.toObject(t).pipe(b(a => this.urlGeneratorService.getUrl(a.url, a.params, i).pipe(m(o => [a, o])))).subscribe(([a, o]) => { this.pageBuilderFacade.loadRestData(`${i.get("tag")}`, new me(S(_({}, a), { url: o }))), this.store.pipe(K(Oe(`${i.get("tag")}`)), T(s => s !== void 0)).subscribe(s => { n.next(s), n.complete(); }); }), n; }
    buildDynamicItems(t, i) { let n = new B; return console.log("build dynamic items rest"), this.toObject(t).pipe(b(a => this.urlGeneratorService.getUrl(a.url, a.params, i).pipe(m(o => [a, o])))).subscribe(([a, o]) => { console.log("Load in rest data"), this.pageBuilderFacade.loadRestData(`${i.get("tag")}`, new me(S(_({}, a), { url: o }))), this.store.pipe(K(Oe(`${i.get("tag")}`)), T(s => s !== void 0), b(s => this.getBindings(t, "pane").pipe(m(c => [s, c]))), b(([s, c]) => Pe(() => s.results.length !== 0 && c.length > 0, new ke(u => { We(s.results.map(C => qi(c).pipe(m(w => i.get("panes").find(D => D.name === w.id)), b(w => Pe(() => w.rule && w.rule !== null && w.rule.condition !== "", this.rulesResolver.evaluate(w.rule, [...i.get("contexts"), ...w.contexts !== void 0 ? w.contexts : [], new ue({ name: "_root", adaptor: "data", data: C })]).pipe(m(D => [w, D])), f(!1).pipe(m(D => [w, D])))), T(([w, D]) => D), m(([w, D]) => w.name), vt(c[0].id), G(1)))).pipe(m(C => [s, C])).subscribe(C => { u.next(C), u.complete(); }); }), new ke(u => { u.next([s]), u.complete(); }))), m(([s, c]) => a.renderer.type === "pane" ? s.results.map((u, C) => { let w = i.get("panes").find(V => V.name === c[C]), D = W(); return new j(S(_({}, w), { rule: void 0, label: D, contexts: [...i.get("contexts"), new ue({ name: "_root", adaptor: "data", data: u })] })); }) : s.results.map(u => new j({ contentPlugin: "snippet", name: W(), label: void 0, contexts: [...i.get("contexts"), new ue({ name: "_root", adaptor: "data", data: u })], settings: this.snippetHandler.buildSettings(S(_({}, a.renderer.data), { content: a.renderer.data.content })) }))), m(s => new Ke({ stylePlugin: void 0, settings: [], panes: s, columnSetting: new O })), m(s => this.panelHandler.buildSettings(new ye({ id: void 0, layoutType: "grid", displayType: "page", site: this.siteName, gridItems: [], layoutSetting: new O, rowSettings: [], panels: [s] })))).subscribe(s => { n.next(s.find(c => c.name === "panels").attributes[0].attributes.find(c => c.name === "panes").attributes), n.complete(); }); }), n; }
    buildSelectOptionItems(t, i) { return this.toObject(t).pipe(b(n => this.urlGeneratorService.getUrl(n.url, n.params, i).pipe(m(a => [n, a]))), m(([n, a]) => new me(S(_({}, n), { url: a })))).subscribe(n => { this.pageBuilderFacade.loadRestData(`${i.get("tag")}`, n); }), this.store.pipe(K(Oe(`${i.get("tag")}`)), T(n => n !== void 0), m(n => [n, n.results.map(a => this.tokenizerService.generateGenericTokens(a))]), m(([n, a]) => [n, a, new Kt(JSON.parse(i.get("snippet").content))]), m(([n, a, o]) => a.map((s, c) => new Qi({ dataItem: n.results[c], value: o.value === "[.]" ? this.attributeSerializer.serialize(n.results[c], "value") : this.attributeSerializer.serialize(this.tokenizerService.replaceTokens(o.value, s), "value"), label: this.tokenizerService.replaceTokens(o.label, s) })))); }
    ...
    editorOptions(t) { return f(new le); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(qe), e.\u0275\u0275inject(ne), e.\u0275\u0275inject(y.PageBuilderFacade), e.\u0275\u0275inject(oe.Store), e.\u0275\u0275inject(N.TokenizerService), e.\u0275\u0275inject(y.PanelContentHandler), e.\u0275\u0275inject(bt.UrlGeneratorService), e.\u0275\u0275inject(P.AttributeSerializerService), e.\u0275\u0275inject(Ye.RulesResolverService)); }; }
    static { this.\u0275prov = e.\u0275\u0275defineInjectable({ token: r, factory: r.\u0275fac }); }
} return r; })(), qr = (() => { class r {
    ...
    constructor(t, i) { this.fb = t, this.tokenizerService = i, this.panes = [], this.submitted = new $, this.contexts = [], this.forms = [], this.snippetValidation = !0, this.restForm = this.fb.group({ source: this.fb.control(""), renderer: this.fb.group({ type: "snippet", query: this.fb.control(""), trackBy: this.fb.control(""), data: this.fb.control(""), bindings: this.fb.array([]), select: this.fb.group({ value: this.fb.control(""), label: this.fb.control(""), id: this.fb.control(""), multiple: this.fb.control(""), limit: this.fb.control("") }) }) }); }
    ...
    submit() { let t = new me(S(_({}, this.restForm.value), { url: this.restForm.value.source.url, params: this.restForm.value.source.params, method: this.restForm.value.source.method, body: this.restForm.value.source.body })); this.submitted.emit(t); }
    ...
    constructor(t, i, n) { this.fb = t, this.attributeSerializer = i, this.tokenizerService = n, this.searchChange = new $, this.selectionForm = this.fb.group({ attributes: this.fb.array([]) }), this.onTouched = () => { }, this.displayAuto = a => n.replaceTokens(this.selectMapping.label, this.tokenizerService.generateGenericTokens(a.dataItem)); }
    ngOnInit() { this.attributesArray.push(this.fb.group({ name: new p("value", g.required), type: new p(ie.Array, g.required), displayName: new p("Value", g.required), value: new p(""), attributes: ["checkboxgroup"].findIndex(t => t === this.renderType) > -1 ? this.fb.array([]) : new p("") })), this.renderType === "autocomplete" && (this.attributesArray.at(0).addControl("_proxy", this.fb.control("")), this.attributesArray.at(0).get("_proxy").valueChanges.pipe(ht(), pe(500)).subscribe(t => { this.searchChange.emit(t); })); }
    ...
    isData(t) { return !1; }
    fetchDynamicData(t, i) { return f(new H); }
    buildDynamicItems(t, i) { return this.toObject(t).pipe(m(n => [n, i.get("contexts").find(a => a.name === n.context)]), b(([n, a]) => this.extractDataArray(a, n.query).pipe(m(o => [n, a, o]))), b(([n, a, o]) => this.transformDataArray(o, n.plugin)), m(n => new Ke({ stylePlugin: void 0, settings: [], panes: n, columnSetting: new O })), m(n => this.panelHandler.buildSettings(new ye({ id: void 0, layoutType: "grid", displayType: "page", site: this.siteName, gridItems: [], layoutSetting: new O, rowSettings: [], panels: [n] }))), m(n => n.find(a => a.name === "panels").attributes[0].attributes.find(a => a.name === "panes").attributes)); }
    ...
    convertToGroup(t) { let i = this.fb.group({ name: new p(t.name, g.required), type: new p(t.type, g.required), displayName: new p(t.displayName, g.required), value: new p(t.value, g.required), computedValue: new p(t.value, g.required), attributes: new q([]) }); return t.attributes && t.attributes.length > 0 && t.attributes.forEach(n => { i.get("attributes").push(this.convertToGroup(n)); }), i; }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(k), e.\u0275\u0275directiveInject(h.MatDialogRef), e.\u0275\u0275directiveInject(l.UntypedFormBuilder), e.\u0275\u0275directiveInject(Ne)); }; }
    ...
    ngOnInit() { this.panes = new Ke(this.data.panelFormGroup.value).panes; }
    ...
    ngOnInit() { this.controlContainer.control.addControl("adaptor", this.fb.control("data", g.required)), this.controlContainer.control.addControl("data", this.fb.control("")), this.pageBuilderFacade.getPage$.pipe(G(1)).subscribe(t => { this.panelPage = t; }); }
    ...
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-page-state-editor"]], viewQuery: function (i, n) { if (i & 1 && e.\u0275\u0275viewQuery(Nt, 7), i & 2) {
            let a;
            e.\u0275\u0275queryRefresh(a = e.\u0275\u0275loadQuery()) && (n.restSourceFormComp = a.first);
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(l.UntypedFormBuilder), e.\u0275\u0275directiveInject(P.AttributeSerializerService)); }; }
...
} return r; })(), ia = r => new Te({ id: "snippet", title: "Snippet", selectionComponent: void 0, editorComponent: kr, renderComponent: oi, handler: r }), na = r => new Te({ id: "attribute", title: "Attribute", selectionComponent: Gr, editorComponent: Ar, renderComponent: zr, handler: r }), ra = r => new Te({ id: "media", title: "Media", selectionComponent: void 0, editorComponent: Br, renderComponent: Lr, handler: r }), aa = r => new Te({ id: "rest", title: "REST", selectionComponent: void 0, editorComponent: Ur, renderComponent: Qr, handler: r }), oa = r => new Te({ id: "slice", title: "Slice", selectionComponent: void 0, editorComponent: Jr, renderComponent: void 0, handler: r }), sa = r => { let d = { path: "" }; return new Me({ id: "page", name: "page", title: "Page", global: !0, group: "pages", baseObject: d, resolver: r }); }, la = r => { let d = { dataset: new H }; return new Me({ id: "rest", name: "rest", title: "Rest", baseObject: d, resolver: r, editorComponent: Kr }); }, ca = r => { let d = { dataset: new H }; return new Me({ id: "form", name: "form", title: "Form", baseObject: d, resolver: r }); }, da = r => { let d = new Ie({ state: new ae }); return new Me({ id: "panestate", name: "panestate", title: "Pane State", internal: !0, baseObject: d, resolver: r }); }, pa = r => { let d = new Ie({ state: new ae }); return new Me({ id: "pagestate", name: "pagestate", title: "Page State", internal: !0, baseObject: d, resolver: r, editorComponent: Zr }); }, ua = r => new dt({ id: "tabs", name: "tabs", title: "Tabs", handler: r, editorComponent: Yr, renderComponent: Xr }), ma = (r, d, t) => new rn({ id: "form", title: "Form", usedContexts: ({ param: i, metadata: n }) => f([`form__${i.mapping.value.substr(0, i.mapping.value.indexOf("."))}`]), evalParam: ({ param: i, metadata: n }) => { let a = i.mapping.value.substr(0, i.mapping.value.indexOf(".")), o = i.mapping.value.substr(i.mapping.value.indexOf(".") + 1); return console.log(`form: ${a} || ${o}`), t.getForm$(a).pipe(G(1), m(s => s || new Ge), m(s => d.serializeForm(s)), m(s => r.generateGenericTokens(s)), F(s => console.log(s)), m(s => s.has(`.${o}`) ? r.replaceTokens(`[.${o}]`, s) : ""), F(s => { console.log("form value"), console.log(s); })); } }), ga = r => new Gi({ id: "form", title: "Form", resolve: () => r.getFormNames$.pipe(b(d => d.length === 0 ? f([]) : fe(d.map(t => r.getForm$(t).pipe(m(i => [t, i]))))), m(d => d.reduce((t, [i, n]) => S(_({}, t), { [`form__${i}`]: n }), {}))), resolveSingle: () => r.getFormNames$.pipe(b(d => Jt(...d.map(t => r.getForm$(t).pipe(m(i => [`form__${t}`, i])))))) }), fa = r => new on({ id: "pages_form", title: "Pages Form", build: () => { sn.prototype.serializePageForm = d => new Promise(t => { t(r.serializeForm(d)); }); } }), ha = (r, d) => new tn({ id: "panelpageform_serialize", title: "Panelpageform Serialize", create: ({ object: t }) => f({ success: !1, entity: d.serializeForm(new Ge(t)) }), read: ({}) => f({ success: !1 }), update: ({}) => f({ success: !1 }), delete: ({}) => f({ success: !1 }) }), va = (r, d, t) => new Wi({ id: "form", title: "Form", editor: ta, fetch: ({ settings: i }) => f(new H).pipe(m(() => new ct(r.deserializeAsObject(i))), b(n => d.getForm$(n.name).pipe(m(a => [n, a || new Ge]), vt([n, new Ge]), G(1))), m(([n, a]) => [n, t.serializeForm(a)]), m(([n, a]) => new H({ results: Xe.JSONPath({ path: `$.${n.field}.*`, json: a }) }))), getBindings: ({ settings: i, metadata: n }) => f([]).pipe(m(() => new ct(r.deserializeAsObject(i))), m(a => [new He({ id: `form__${a.name}`, type: "context" })])) }), ba = r => d => { if (("/" + d.map(t => t.path).join("/")).indexOf(r.path) === 0) {
    let t = r.path.substr(1).split("/").length;
    return { consumed: d, posParams: d.reduce((i, n, a) => a === 0 ? S(_({}, i), { panelPageId: new lt(r.id, {}) }) : a > t - 1 ? S(_({}, i), { [`arg${a - t}`]: new lt(n.path, {}) }) : _({}, i), {}) };
}
else
    return null; }, ya = r => d => { if (("/" + d.map(t => t.path).join("/")).indexOf(r.path) === 0 && d.map(t => t.path).join("/").indexOf("/manage") > -1) {
    let t = r.path.substr(1).split("/").length;
    return { consumed: d, posParams: d.reduce((i, n, a) => a === 0 ? S(_({}, i), { panelPageId: new lt(r.id, {}) }) : _({}, i), {}) };
}
else
    return null; };
var _a = (() => { class r {
    ...
    ngOnInit() { this.paneDatasource.pageChange$.pipe(Ui(1), b(t => this.panelResolverService.resolvePanes({ panes: this.originPanes.map(i => new j(S(_({}, i), { metadata: new Map([...i.metadata ? i.metadata : [], ["page", t], ["limit", this.paneDatasource.pageSize]]) }))), contexts: this.contexts, resolvedContext: this.resolvedContext })), b(({ resolvedPanes: t, originMappings: i }) => this.styleResolverService.alterResolvedPanes({ panel: this.panel, resolvedPanes: t, originMappings: i }))).subscribe(({ resolvedPanes: t, originMappings: i }) => { this.originMappings = i, this.paneDatasource.panes = t; }), this.paneDatasource.panes = this.panes, this.trackByTpl = "[._root.id]"; }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(N.TokenizerService), e.\u0275\u0275directiveInject(y.PanelResolverService), e.\u0275\u0275directiveInject(y.StyleResolverService), e.\u0275\u0275directiveInject(y.PaneDatasourceService)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["classifieds-ui-virtual-list-panel-renderer"]], inputs: { settings: "settings", panes: "panes", originPanes: "originPanes", originMappings: "originMappings", contexts: "contexts", resolvedContext: "resolvedContext", panel: "panel" }, standalone: !1, features: [e.\u0275\u0275ProvidersFeature([Zt])], decls: 2, vars: 2, consts: [[1, "panes-viewport", 3, "itemSize"], ["class", "pane-item", 4, "cdkVirtualFor", "cdkVirtualForOf"], [1, "pane-item"], [3, "pluginName", "settings", "contexts", "resolvedContext"]], template: function (i, n) { i & 1 && (e.\u0275\u0275elementStart(0, "cdk-virtual-scroll-viewport", 0), e.\u0275\u0275template(1, Sr, 2, 4, "div", 1), e.\u0275\u0275elementEnd()), i & 2 && (e.\u0275\u0275property("itemSize", 75), e.\u0275\u0275advance(), e.\u0275\u0275property("cdkVirtualForOf", n.paneDatasource)); }, dependencies: [Ce.CdkFixedSizeVirtualScroll, Ce.CdkVirtualForOf, Ce.CdkVirtualScrollViewport, $e.RenderPaneComponent], styles: ["[_nghost-%COMP%]{position:relative}.panes-viewport[_ngcontent-%COMP%]{height:100%;width:100%}"] }); }
} return r; })(), Ca = (() => { class r {
    constructor(t) { this.router = t; }
    ngOnInit() { }
    onClick() { this.router.navigateByUrl(this.href); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(se.Router)); }; }
    ...
    ngOnInit() { }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(oe.Store), e.\u0275\u0275directiveInject(se.Router), e.\u0275\u0275directiveInject(M.EntityServices)); }; }
    ...
    canActivate(t, i) { return this.pagesSettings.disableRouting ? new Promise(n => n(!0)) : new Promise(n => { let a = i.url; a.indexOf("?") !== -1 && (a = i.url.substr(0, a.indexOf("?"))); let o = "path=" + a.substr(1).split("/").reduce((s, c, u) => [...s, u === 0 ? `/${c}` : `${s[u - 1]}/${c}`], []).map(s => this.encodePathComponent(s)).join("&path=") + `&site=${encodeURIComponent(`{"term":{"site.keyword":{"value":"${this.siteName}"}}}`)}`; setTimeout(() => { }), We([Pe(() => !this.routesLoaded, this.panelPageListItemsService.getWithQuery(`site=${encodeURIComponent(`{"term":{"site.keyword":{"value":"${this.siteName}"}}}`)}&path={"wildcard":{"path.keyword":{"value":"*"}}}`).pipe(F(() => console.log("loaded page list items")), m(s => s.filter(c => c.path !== void 0 && c.path !== "")), m(s => s.map(c => new ye(c)).sort((c, u) => c.path.split("/").length === u.path.split("/").length ? c.path.split("/")[c.path.split("/").length - 1] > u.path.split("/")[u.path.split("/").length - 1] ? -1 : 1 : c.path.split("/").length > u.path.split("/").length ? -1 : 1)), F(s => s.sort((c, u) => c.path.length > u.path.length ? 1 : -1)), F(s => { let c = this.router.config; s.forEach(u => { c.unshift({ matcher: ya(u), component: li }), c.unshift({ matcher: ba(u), component: si, data: { panelPageListItem: u } }), console.log(`panels matcher: ${u.path}`); }), this.routesLoaded = !0; }), m(() => [])), f([])), this.panelPageListItemsService.getWithQuery(o).pipe(Hi(s => f([])), F(() => console.log("loaded specific matched")), m(s => s.reduce((c, u) => c === void 0 || c.path.split("/").length < u.path.split("/").length ? u : c, void 0)), m(s => { let c = i.url.substr(1).split("/").slice(s.path.split("/").length - 1).join("/"); return [s, c]; }))]).pipe(m(([s, [c, u]]) => [c, u])).subscribe(([s, c]) => { let u = `${s.path}${c === "" ? "" : `/${c}`}?${$t.stringify(t.queryParams)}`, C = this.router.parseUrl(u); console.log(`panels garud navigate: ${s.path}${c === "" ? "" : `/${c}`}?${$t.stringify(t.queryParams)}`), n(C); }); }); }
    encodePathComponent(t) { return `{"term":{"path.keyword":{"value":"${t}"}}}`; }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(qe), e.\u0275\u0275inject(Sa), e.\u0275\u0275inject(se.Router), e.\u0275\u0275inject(M.EntityServices)); }; }
    static { this.\u0275prov = e.\u0275\u0275defineInjectable({ token: r, factory: r.\u0275fac }); }
} return r; })(), Vt = (() => { class r {
    ...
    resolve(t, i) { let n = new me(i); return (n.params && Array.isArray(n.params) && n.params.length > 0 ? this.changePipeline(n.params) : f([])).pipe(b(() => n.params && Array.isArray(n.params) && n.params.length > 0 ? this.rebuildParams(n.params) : f([])), m(a => [a, new Map([["tag", W()]])]), b(([a, o]) => this.urlGeneratorService.getUrl(n.url, a, o).pipe(m(s => [s, o]))), b(([a, o]) => (this.pageBuilderFacade.loadRestData(`${o.get("tag")}`, new me(S(_({}, n), { url: a }))), this.store.pipe(K(Oe(`${o.get("tag")}`)), T(s => s !== void 0), m(s => s.results), G(1))))); }
    ...
    queryStringChange(t) { return new B; }
    ...
    testParams(t) { let i = [], n = t.length; for (let a = 0; a < n; a++)
        t[a].mapping.type === "route" ? i.push(new Et(S(_({}, t[a]), { mapping: { type: "static", value: t[a].mapping.testValue, context: void 0, testValue: void 0 } }))) : i.push(new Et(t[a])); return i; }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(y.PageBuilderFacade), e.\u0275\u0275inject(oe.Store), e.\u0275\u0275inject(bt.UrlGeneratorService), e.\u0275\u0275inject(oe.Store)); }; }
    static { this.\u0275prov = e.\u0275\u0275defineInjectable({ token: r, factory: r.\u0275fac }); }
} return r; })(), At = (() => { class r {
    constructor(t) { this.pageBuilderFacade = t; }
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(y.PageBuilderFacade)); }; }
    static { this.\u0275prov = e.\u0275\u0275defineInjectable({ token: r, factory: r.\u0275fac }); }
} return r; })(), wa = (() => { class r extends Ki {
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(N.TokenizerService), e.\u0275\u0275directiveInject(y.PaneDatasourceService)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: r, selectors: [["lib-table-panel-renderer"]], standalone: !1, features: [e.\u0275\u0275ProvidersFeature([Zt]), e.\u0275\u0275InheritDefinitionFeature], decls: 4, vars: 4, consts: [["mat-table", "", "matSort", "", 3, "dataSource"], [3, "matColumnDef", 4, "ngFor", "ngForOf"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], [3, "matColumnDef"], ["mat-header-cell", "", "mat-sort-header", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["mat-header-cell", "", "mat-sort-header", ""], ["mat-cell", ""], ["mat-header-row", ""], ["mat-row", ""]], template: function (i, n) { i & 1 && (e.\u0275\u0275elementStart(0, "table", 0), e.\u0275\u0275template(1, Pr, 3, 1, "ng-container", 1)(2, Fr, 1, 0, "tr", 2)(3, Ir, 1, 0, "tr", 3), e.\u0275\u0275elementEnd()), i & 2 && (e.\u0275\u0275property("dataSource", n.paneDatasource), e.\u0275\u0275advance(), e.\u0275\u0275property("ngForOf", n.displayedColumns), e.\u0275\u0275advance(), e.\u0275\u0275property("matHeaderRowDef", n.displayedColumns), e.\u0275\u0275advance(), e.\u0275\u0275property("matRowDefColumns", n.displayedColumns)); }, dependencies: [v.NgForOf, it.MatSort, it.MatSortHeader, I.MatTable, I.MatHeaderCellDef, I.MatHeaderRowDef, I.MatColumnDef, I.MatCellDef, I.MatRowDef, I.MatHeaderCell, I.MatCell, I.MatHeaderRow, I.MatRow], encapsulation: 2 }); }
} return r; })(), Pa = (() => { class r {
    ...
    wrapPanel(t) { return new Ke({ stylePlugin: void 0, settings: [], panes: t, columnSetting: new O }); }
    stateDefinition(t) { return f({}); }
    editorOptions(t) { return f(new le); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(P.AttributeSerializerService)); }; }
    ...
    alterResolvedPanes({ settings: t, resolvedPanes: i, originMappings: n }) { let a = this.attributeSerializer.deserialize(new ae({ name: "", displayName: "", computedValue: "", type: ie.Complex, value: "", intValue: 0, attributes: t })), o = a && a.labels !== void 0 && Array.isArray(a.labels) ? a.labels.map(c => new It(c.mapping)) : [], s = []; if (o.length === 0)
        return f({ resolvedPanes: i, originMappings: n }); return i.length !== o.length ? s = i.map((c, u) => new It(S(_({}, u < o.length ? o[u] : o[o.length - 1]), { pane: u }))).map(c => this.flattenSelector(c)) : s = o.map(c => this.flattenSelector(c)), We(i.map((c, u) => this.panelsLoaderService.reducePanes([], c, 0)[0])).pipe(m(c => c.reduce((u, [C, w]) => [...u, w], [])), m(c => { let u = s.map(E => this.selectWithTarget(E)), C = s.map(E => this.selectWithoutTarget(E)), w = u.map((E, R) => this.panelsSelectorService.rebuildPage(c[s[R][0]], E.slice(1))), D = C.map((E, R) => this.panelsSelectorService.rebuildPage(c[s[R][0]], E.slice(1))), V = [], ee = i.length; for (let E = 0; E < ee; E++)
        V.push(new j(S(_({}, i[E]), { settings: this.panelHandler.buildSettings(w[E]) }))), V.push(new j(S(_({}, i[E]), { settings: this.panelHandler.buildSettings(D[E]) }))); return { resolvedPanes: V, originMappings: n }; })); return console.log("TabsStyleHandler::alterResolvedPanes"), console.log(i), console.log(n), f({ resolvedPanes: i, originMappings: n }); }
    stateDefinition(t) { return f({}); }
    flattenSelector(t) { let i = []; return t.panel !== void 0 && t.panel !== null && i.push(t.panel), t.pane !== void 0 && t.pane !== null && i.push(t.pane), t.nested !== void 0 && t.nested !== null && typeof t.nested == "object" && this.flattenSelector(t.nested).forEach(n => i.push(n)), i; }
    selectWithTarget(t) { return t.map(i => i + 1); }
    selectWithoutTarget(t) { return t.map((i, n) => n === t.length - 1 ? (i + 1) * -1 : 0); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(Pa), e.\u0275\u0275inject(P.AttributeSerializerService), e.\u0275\u0275inject(y.PanelsLoaderService), e.\u0275\u0275inject(y.PanelsSelectorService)); }; }
    static { this.\u0275prov = e.\u0275\u0275defineInjectable({ token: r, factory: r.\u0275fac }); }
} return r; })(), zt = (() => { class r {
    ...
    get panelPage$() { return fe([this.pageBuilderFacade.getPageInfo$, this.entityServices.getEntityCollectionService("PanelPage").entities$]).pipe(m(([t, i]) => t && t.id !== void 0 && t.id !== "" && t.id !== null && i.findIndex(n => n.id === t.id) !== -1 ? i.find(n => n.id === t.id) : void 0)); }
    ...
    resolve$(t, i) { return fe([this.panelPage$, this.entities$]).pipe(m(([n, a]) => [n, n && a.findIndex(o => o.id === n.id) !== -1 ? a.find(o => o.id === n.id) : new Tt]), b(([n, a]) => this.pageBuilderFacade.getSelectionPath$.pipe(m(o => i && i.selectionPath ? i.selectionPath : o), F(o => o.join(",")), m(o => o.map((s, c) => `${(c + 1) % 2 === 0 ? "panes" : (c === 0 ? "" : "nestedPage.") + "panels"}[${s}]`)), m(o => o.length === 0 ? void 0 : "$." + o.join(".")), m(o => [n, a, o]))), F(([n, a, o]) => { console.log("page state context resolver"), console.log(n), console.log("query: " + o); }), b(([n, a, o]) => Pe(() => !!n && !a, this.panelStateConverterService.convertPageToState(n).pipe(m(s => new Tt(S(_({}, s), { panels: s.panels.map(c => new Yi(S(_({}, c), { panes: c.panes.map(u => new Ie(S(_({}, u), { state: this.attributeSerializer.serialize({ displayAssociatedPane: "y" }, "root") }))) }))) }))), m(s => [s, o])), f([a, o]))), F(([n, a]) => { console.log("rebuilt state from realtime page"), console.log(n); }), m(([n, a]) => a ? Xe.JSONPath({ path: a, json: n }) : this.emptyPaneState), m(n => n && Array.isArray(n) && n.length !== 0 ? n[0] : this.emptyPaneState), F(n => { console.log("json path match"), console.log(n); }), m(n => this.attributeSerializer.deserializeAsObject(n.state)), F(n => { console.log("final state"), console.log(n); })); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(M.EntityServices), e.\u0275\u0275inject(y.PageBuilderFacade), e.\u0275\u0275inject(y.PanelStateConverterService), e.\u0275\u0275inject(P.AttributeSerializerService)); }; }
    static { this.\u0275prov = e.\u0275\u0275defineInjectable({ token: r, factory: r.\u0275fac }); }
} return r; })();
var Fa = [{ path: "pages", children: [{ path: "create-panel-page", component: Vr }, { path: "panelpage/:panelPageId/manage", component: li }] }], Eo = (() => { class r {
    constructor(t, i, n, a, o, s, c, u, C, w, D, V, ee, E, R, Se, De, ce, Ct, Ia, Ta, Ma, ci, Ea, $a, di, pi, ui, Da) { s.registerMetadataMap(Tr), [sa(E), la(R), ca(Se), da(De), pa(ce)].forEach(te => { a.register(te); }), t.forEach(te => n.register(te)), i.forEach(te => o.register(te)), c.register(ma(D, V, ee)), u.register(ga(ee)), Ct.register(fa(V)), Ct.getPlugin("pages_form").subscribe(te => te.build()), ci.register(ha(di, V)), pi.register(va(ui, ee, V)); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(de), e.\u0275\u0275inject(Re), e.\u0275\u0275inject(ve.ContentPluginManager), e.\u0275\u0275inject(A.ContextPluginManager), e.\u0275\u0275inject(y.StylePluginManager), e.\u0275\u0275inject(M.EntityDefinitionService), e.\u0275\u0275inject(tt.ParamPluginManager), e.\u0275\u0275inject(A.ResolvedContextPluginManager), e.\u0275\u0275inject(ni.PluginConfigurationManager), e.\u0275\u0275inject(A.ContextManagerService), e.\u0275\u0275inject(N.TokenizerService), e.\u0275\u0275inject(y.FormService), e.\u0275\u0275inject(y.PageBuilderFacade), e.\u0275\u0275inject(Vt), e.\u0275\u0275inject(Gt), e.\u0275\u0275inject(At), e.\u0275\u0275inject(ut), e.\u0275\u0275inject(zt), e.\u0275\u0275inject(ii.BridgeBuilderPluginManager), e.\u0275\u0275inject(ri.HttpClient), e.\u0275\u0275inject(M.Pluralizer), e.\u0275\u0275inject(M.DefaultDataServiceConfig), e.\u0275\u0275inject(Ee.CrudAdaptorPluginManager), e.\u0275\u0275inject(M.EntityDefinitionService), e.\u0275\u0275inject(M.EntityDataService), e.\u0275\u0275inject(tt.ParamEvaluatorService), e.\u0275\u0275inject(Je.DatasourcePluginManager), e.\u0275\u0275inject(P.AttributeSerializerService), e.\u0275\u0275inject(Ee.CrudDataHelperService)); }; }
    static { this.\u0275mod = e.\u0275\u0275defineNgModule({ type: r }); }
    static { this.\u0275inj = e.\u0275\u0275defineInjector({ providers: [xa, Vt, Gt, At, ut, zt, { provide: rt, useValue: Ca, multi: !0 }, { provide: rt, useValue: Ci, multi: !0 }, { provide: rt, useValue: si, multi: !0 }, { provide: ne, useClass: ne }, { provide: re, useClass: re }, { provide: ge, useClass: ge }, { provide: Fe, useClass: Fe }, { provide: Ne, useClass: Ne }, { provide: st, useClass: st }, { provide: de, useFactory: ia, multi: !0, deps: [ne] }, { provide: de, useFactory: na, multi: !0, deps: [re] }, { provide: de, useFactory: ra, multi: !0, deps: [ge] }, { provide: de, useFactory: aa, multi: !0, deps: [Fe] }, { provide: de, useFactory: oa, multi: !0, deps: [Ne] }, { provide: Re, useValue: new dt({ id: "virtuallist", name: "virtuallist", title: "Virtual List", editorComponent: void 0, renderComponent: _a }), multi: !0 }, { provide: Re, useFactory: ua, multi: !0, deps: [st] }, { provide: Re, useValue: new dt({ id: "table", name: "table", title: "Table", editorComponent: void 0, renderComponent: wa }), multi: !0 }], imports: [hi, bi, yi, wi, Si, vi.forChild(Fa), Pi, _i.forChild(), xi, Li, Ei, $i, Ai, Di, Mi, Oi, Fi, Xi, Ni, ki, an, ln, Ji, nn] }); }
} return r; })();
...
//# sourceMappingURL=_rollthecloudinc_pages.FDifTyVumd.js.map
