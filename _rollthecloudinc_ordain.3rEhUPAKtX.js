...
import { NG_VALUE_ACCESSOR as k, NG_VALIDATORS as P, Validators as p, UntypedFormControl as z, FormsModule as B, ReactiveFormsModule as H } from "@angular/forms";
import { MaterialModule as Q } from "@rollthecloudinc/material";
import * as x from "@rollthecloudinc/dparam";
import { Param as K, DparamModule as J } from "@rollthecloudinc/dparam";
import { BehaviorSubject as f, Subject as C, combineLatest as V, of as l, map as T, switchMap as W, Observable as X } from "rxjs";
import * as _ from "@rollthecloudinc/plugin";
import { Plugin as Y, BasePluginManager as Z, PluginDef as ee } from "@rollthecloudinc/plugin";
import { debounceTime as te, tap as m, filter as S, delay as ie, map as u, switchMap as G } from "rxjs/operators";
import re from "qs";
...
import * as U from "@rollthecloudinc/token";
...
var c = class extends Y {
    ...
    constructor(o) { this.params = [], o && (this.paramsString = o.paramsString, o.params && Array.isArray(o.params) && (this.params = o.params.map(t => new K(t)))); }
}, I = class {
    ...
    constructor(t) { this.fb = t, this.contexts = [], this.settings$ = new f(void 0), this.afterViewInit$ = new C, this.paramValues$ = new f([]), this.formGroup = this.fb.group({ paramsString: this.fb.control(""), params: this.fb.control([]) }), this.paramsStringChangeSub = this.formGroup.get("paramsString").valueChanges.pipe(te(500)).subscribe(i => { let n = re.parse("?" + i); this.paramsParsed = n; }), this.settingsSub = this.settings$.pipe(m(i => { i && this.formGroup.get("paramsString").setValue(i.paramsString ? i.paramsString : ""); })).subscribe(), this.settingsParamsSub = V([this.settings$, this.formGroup.get("paramsString").valueChanges]).pipe(S(([i]) => i !== void 0), ie(1), m(([i]) => this.paramValues$.next(i.params))).subscribe(), this.onTouched = () => { }; }
    ...
    resolveParams({ v: t }) { return l({}).pipe(T(() => ({ paramNames: t.paramSettings.paramsString ? t.paramSettings.paramsString.split("&").filter(i => i.indexOf("=:") !== -1).map(i => i.split("=", 2)[1].substr(1)) : [] })), W(({ paramNames: i }) => this.paramEvaluatorService.paramValues(t.paramSettings.params.reduce((n, a, d) => new Map([...n, [i[d], a]]), new Map)).pipe(T(n => Array.from(n).reduce((a, [d, h]) => y($({}, a), { [d]: h }), {}))))); }
    rebuildControl({ c: t, serialized: i }) { return i ? new z(this.attributesSerializerService.deserializeAsObject(t.value).value) : t; }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(x.ParamEvaluatorService), e.\u0275\u0275inject(j.AttributeSerializerService)); }; }
    static { this.\u0275prov = e.\u0275\u0275defineInjectable({ token: r, factory: r.\u0275fac, providedIn: "root" }); }
} return r; })(), q = (() => { class r extends Z {
    constructor(t, i, n) { super(i, n), this.addDiscovery(new D(this, t)); }
    pluginDef() { return l(new ee({ name: "validation" })); }
    discovery() { super.discovery(); }
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275inject(le), e.\u0275\u0275inject(_.PluginConfigurationManager), e.\u0275\u0275inject(R.ModuleLoaderService)); }; }
    static { this.\u0275prov = e.\u0275\u0275defineInjectable({ token: r, factory: r.\u0275fac, providedIn: "root" }); }
} return r; })(), de = (() => { class r {
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(s.UntypedFormBuilder), e.\u0275\u0275directiveInject(q), e.\u0275\u0275directiveInject(e.ComponentFactoryResolver)); }; }
    ...
    resolveContexts({ errors: t }) { return new X(i => { let n = new Map(this.tokenizerService.generateGenericTokens(t, "")); if (this.resolvedContext$.value)
    ...
    static { this.\u0275fac = function (i) { return new (i || r)(e.\u0275\u0275directiveInject(q), e.\u0275\u0275directiveInject(U.TokenizerService)); }; }
    ...
    static { this.\u0275inj = e.\u0275\u0275defineInjector({ imports: [L, B, H, Q, J] }); }
} return r; })();
export { ye as DefaultValidationError, I as FormValidation, Ge as OrdainModule, $e as ValidationEditorComponent, v as ValidationParamsEditorComponent, c as ValidationPlugin, q as ValidationPluginManager, E as ValidationValidator, F as ValidationValidatorSettings };
//# sourceMappingURL=_rollthecloudinc_ordain.3rEhUPAKtX.js.map
