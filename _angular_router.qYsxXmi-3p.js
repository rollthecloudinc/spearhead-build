import { a as h, b as N, k as cr } from "@nf-internal/chunk-GL2BOVXA";
...
import { isObservable as Hn, from as $, of as d, BehaviorSubject as U, combineLatest as Wt, EmptyError as Vn, concat as Gn, defer as Qt, pipe as Wn, throwError as Rt, EMPTY as W, ConnectableObservable as lr, Subject as Me, Observable as Qn, Subscription as Kn } from "rxjs";
...
var f = "primary", $e = Symbol("RouteTitle"), Ut = class {
    params;
...
function H(t) { return Hn(t) ? t : On(t) ? $(Promise.resolve(t)) : d(t); }
...
function Dr(t, n, e, r) { if (t.segments.length > e.length) {
    ...
    return !te(t.segments, i) || !Ye(t.segments, i, r) || !t.children[f] ? !1 : Dr(t.children[f], n, o, r);
} }
...
function ii(t, n) { let e = []; return Object.entries(t.children).forEach(([r, i]) => { r === f && (e = e.concat(n(i, r))); }), Object.entries(t.children).forEach(([r, i]) => { r !== f && (e = e.concat(n(i, r))); }), e; }
var J = (() => { class t {
...
function be(t, n) { if (!t.hasChildren())
    return Ze(t); if (n) {
    let e = t.children[f] ? be(t.children[f], !1) : "", r = [];
    return Object.entries(t.children).forEach(([i, o]) => { i !== f && r.push(`${i}:${be(o, !1)}`); }), r.length > 0 ? `${e}(${r.join("//")})` : e;
}
else {
    let e = ii(t, (r, i) => i === f ? [be(t.children[f], !1)] : [`${i}:${be(r, !1)}`]);
    return Object.keys(t.children).length === 1 && t.children[f] != null ? `${Ze(t)}/${e[0]}` : `${Ze(t)}/(${e.join("//")})`;
} }
...
function Pr(t) { return t.segments.length > 0 ? new v([], { [f]: t }) : t; }
...
function vi(t) { if (t.numberOfChildren === 1 && t.children[f]) {
    let n = t.children[f];
...
function Si(t) { return Ne(t[0]) ? t[0].outlets : { [f]: t }; }
function $r(t, n, e) { if (t ??= new v([], {}), t.segments.length === 0 && t.hasChildren())
    ...
    return o.children[f] = new v(t.segments.slice(r.pathIndex), t.children), Ee(o, 0, i);
}
else
...
function zr(t) { let n = Ti(t), e = new U([new Q("", {})]), r = new U({}), i = new U({}), o = new U({}), s = new U(""), a = new q(e, r, o, s, i, f, t, n.root); return a.snapshot = n.root, new _e(new T(a, []), n); }
function Ti(t) { let n = {}, e = {}, r = {}, o = new re([], n, r, "", e, f, t, null, {}); return new xe("", new T(o, [])); }
var q = class {
    urlSubject;
    paramsSubject;
    queryParamsSubject;
...
var Br = new ie(""), Yt = (() => { class t {
    ...
    subscribeToRouteData(e) { let { activatedRoute: r } = e, i = Wt([r.queryParams, r.params, r.data]).pipe(E(([o, s, a], u) => (a = h(h(h({}, o), s), a), u === 0 ? d(a) : Promise.resolve(a)))).subscribe(o => { if (!e.isActivated || !e.activatedComponentRef || e.activatedRoute !== r || r.component === null) {
...
function Xt(t) { let n = t.children && t.children.map(Xt), e = n ? N(h({}, t), { children: n }) : h({}, t); return !e.component && !e.loadComponent && (n || e.loadChildren) && e.outlet && e.outlet !== f && (e.component = Jt), e; }
...
function Bi(t, n) { return _(e => { let { targetSnapshot: r, currentSnapshot: i, guards: { canActivateChecks: o, canDeactivateChecks: s } } = e; return s.length === 0 && o.length === 0 ? d(N(h({}, e), { guardsResult: !0 })) : Hi(s, r, i, t).pipe(_(a => a && Li(a) ? Vi(r, o, t, n) : d(a)), R(a => N(h({}, e), { guardsResult: a }))); }); }
...
function Gi(t, n) { return t !== null && n && n(new lt(t)), d(!0); }
function Wi(t, n) { return t !== null && n && n(new ut(t)), d(!0); }
function Qi(t, n, e) { let r = n.routeConfig ? n.routeConfig.canActivate : null; if (!r || r.length === 0)
    return d(!0); let i = r.map(o => Qt(() => { let s = Ce(n) ?? e, a = we(o, s), u = ki(a) ? a.canActivate(n, t) : x(s, () => a(n, t)); return H(u).pipe(oe()); })); return d(i).pipe(Se()); }
function Ki(t, n, e) { let r = n[n.length - 1], o = n.slice(0, n.length - 1).reverse().map(s => Pi(s)).filter(s => s !== null).map(s => Qt(() => { let a = s.guards.map(u => { let c = Ce(s.node) ?? e, g = we(u, c), S = $i(g) ? g.canActivateChild(r, t) : x(c, () => g(r, t)); return H(S).pipe(oe()); }); return d(a).pipe(Se()); })); return d(o).pipe(Se()); }
function Yi(t, n, e, r, i) { let o = n && n.routeConfig ? n.routeConfig.canDeactivate : null; if (!o || o.length === 0)
    return d(!0); let s = o.map(a => { let u = Ce(n) ?? i, c = we(a, u), g = zi(c) ? c.canDeactivate(t, n, e, r) : x(u, () => c(t, n, e, r)); return H(g).pipe(oe()); }); return d(s).pipe(Se()); }
function Zi(t, n, e, r) { let i = n.canLoad; if (i === void 0 || i.length === 0)
    return d(!0); let o = i.map(s => { let a = we(s, t), u = ji(a) ? a.canLoad(n, e) : x(t, () => a(n, e)); return H(u); }); return d(o).pipe(Se(), Qr(r)); }
function Qr(t) { return Wn(C(n => { if (typeof n != "boolean")
    throw gt(t, n); }), R(n => n === !0)); }
function Ji(t, n, e, r) { let i = n.canMatch; if (!i || i.length === 0)
    return d(!0); let o = i.map(s => { let a = we(s, t), u = Fi(a) ? a.canMatch(n, e) : x(t, () => a(n, e)); return H(u); }); return d(o).pipe(Se(), Qr(r)); }
var je = class {
    segmentGroup;
...
function to(t, n, e) { if (typeof t == "string")
    return d(t); let r = t, { queryParams: i, fragment: o, routeConfig: s, url: a, outlet: u, params: c, data: g, title: S } = n; return H(x(e, () => r({ params: c, data: g, queryParams: i, fragment: o, routeConfig: s, url: a, outlet: u, title: S }))); }
var Bt = { matched: !1, consumedSegments: [], remainingSegments: [], parameters: {}, positionalParamSegments: {} };
function ro(t, n, e, r, i) { let o = Kr(t, n, e); return o.matched ? (r = Ii(n, r), Ji(r, n, e, i).pipe(R(s => s === !0 ? o : h({}, Bt)))) : d(o); }
...
function oo(t, n) { let e = {}; e[f] = n; for (let r of t)
    if (r.path === "" && P(r) !== f) {
        let i = new v([], {});
        e[P(r)] = i;
    } return e; }
function so(t, n, e) { return e.some(r => yt(t, n, r) && P(r) !== f); }
...
var lo = 31, Vt = class {
    ...
    match(n) { let e = new re([], Object.freeze({}), Object.freeze(h({}, this.urlTree.queryParams)), this.urlTree.fragment, Object.freeze({}), f, this.rootComponentType, null, {}); return this.processSegmentGroup(this.injector, this.config, n, f, e).pipe(R(r => ({ children: r, rootSnapshot: e })), Te(r => { if (r instanceof ke)
    ...
    processChildren(n, e, r, i) { let o = []; for (let s of Object.keys(r.children))
        ...
        return ce(r); let a = Yr(s); return ho(a), d(a); })); }
    processSegment(n, e, r, i, o, s, a) { return $(e).pipe(Xe(u => this.processSegmentAgainstRoute(u._injector ?? n, e, u, r, i, o, s, a).pipe(Te(c => { if (c instanceof je)
        return d(null); throw c; }))), oe(u => !!u), Te(u => { if (Wr(u))
        return uo(r, i, o) ? d(new Ht) : ce(r); throw u; })); }
    processSegmentAgainstRoute(n, e, r, i, o, s, a, u) { return P(r) !== s && (s === f || !yt(i, o, r)) ? ce(i) : r.redirectTo === void 0 ? this.matchSegmentAgainstRoute(n, i, r, o, s, u) : this.allowRedirects && a ? this.expandSegmentAgainstRouteUsingRedirect(n, i, e, r, o, s, u) : ce(i); }
    ...
    matchSegmentAgainstRoute(n, e, r, i, o, s) { let a = ro(e, r, i, n, this.urlSerializer); return r.path === "**" && (e.children = {}), a.pipe(E(u => u.matched ? (n = r._injector ?? n, this.getChildConfig(n, r, i).pipe(E(({ routes: c }) => { let g = r._loadedInjector ?? n, { parameters: S, consumedSegments: D, remainingSegments: G } = u, A = new re(D, S, Object.freeze(h({}, this.urlTree.queryParams)), this.urlTree.fragment, Rr(r), P(r), r.component ?? r._loadedComponent ?? null, r, yr(r)), ue = pt(A, s, this.paramsInheritanceStrategy); A.params = Object.freeze(ue.params), A.data = Object.freeze(ue.data); let { segmentGroup: ee, slicedSegments: Tt } = mr(e, D, G, c); if (Tt.length === 0 && ee.hasChildren())
        ...
        return d(new T(A, [])); let Tn = P(r) === o; return this.processSegment(g, c, ee, Tt, Tn ? f : o, !0, A).pipe(R(Ge => new T(A, Ge instanceof T ? [Ge] : []))); }))) : ce(e))); }
    getChildConfig(n, e, r) { return e.children ? d({ routes: e.children, injector: n }) : e.loadChildren ? e._loadedRoutes !== void 0 ? d({ routes: e._loadedRoutes, injector: e._loadedInjector }) : Zi(n, e, r, this.urlSerializer).pipe(_(i => i ? this.configLoader.loadChildren(n, e).pipe(C(o => { e._loadedRoutes = o.routes, e._loadedInjector = o.injector; })) : eo(e))) : d({ routes: [], injector: n }); }
};
function ho(t) { t.sort((n, e) => n.value.outlet === f ? -1 : e.value.outlet === f ? 1 : n.value.outlet.localeCompare(e.value.outlet)); }
...
function go(t, n) { return _(e => { let { targetSnapshot: r, guards: { canActivateChecks: i } } = e; if (!i.length)
    ...
    if (!s.has(u))
        for (let c of Zr(u))
            s.add(c); let a = 0; return $(s).pipe(Xe(u => o.has(u) ? vo(u, r, t, n) : (u.data = pt(u, u.parent, t).resolve, d(void 0))), C(() => a++), wr(1), _(u => a === s.size ? d(e) : W)); }); }
...
function mo(t, n, e, r) { let i = Pt(t); if (i.length === 0)
    return d({}); let o = {}; return $(i).pipe(_(s => Ro(t[s], n, e, r).pipe(oe(), C(a => { if (a instanceof ye)
...
function Dt(t) { return E(n => { let e = t(n); return e ? $(e).pipe(R(() => n)) : d(n); }); }
var er = (() => { class t {
    ...
    loadComponent(e, r) { if (this.componentLoaders.get(r))
        ...
        return d(r._loadedComponent); this.onLoadStartListener && this.onLoadStartListener(r); let i = H(x(e, () => r.loadComponent())).pipe(R(en), E(tn), C(s => { this.onLoadEndListener && this.onLoadEndListener(r), r._loadedComponent = s; }), Nt(() => { this.componentLoaders.delete(r); })), o = new lr(i, () => new Me).pipe(hr()); return this.componentLoaders.set(r, o), o; }
    loadChildren(e, r) { if (this.childrenLoaders.get(r))
        return this.childrenLoaders.get(r); if (r._loadedRoutes)
        return d({ routes: r._loadedRoutes, injector: r._loadedInjector }); this.onLoadStartListener && this.onLoadStartListener(r); let o = Xr(r, this.compiler, e, this.onLoadEndListener).pipe(Nt(() => { this.childrenLoaders.delete(r); })), s = new lr(o, () => new Me).pipe(hr()); return this.childrenLoaders.set(r, s), s; }
    static \u0275fac = function (r) { return new (r || t); };
    static \u0275prov = m.\u0275\u0275defineInjectable({ token: t, factory: t.\u0275fac, providedIn: "root" });
} return t; })();
function Xr(t, n, e, r) { return H(x(e, () => t.loadChildren())).pipe(R(en), E(tn), _(i => i instanceof Ln || Array.isArray(i) ? d(i) : $(n.compileModuleAsync(i))), R(i => { r && r(t); let o, s, a = !1; return Array.isArray(i) ? (s = i, a = !0) : (o = i.create(e).injector, s = o.get(X, [], { optional: !0, self: !0 }).flat()), { routes: s.map(Xt), injector: o }; })); }
function yo(t) { return t && typeof t == "object" && "default" in t; }
function en(t) { return yo(t) ? t.default : t; }
function tn(t) { return d(t); }
var Ct = (() => { class t {
    static \u0275fac = function (r) { return new (r || t); };
...
var wt = new ie(""), qe = (() => { class t {
    ...
    setupNavigations(e) { return this.transitions = new U(null), this.transitions.pipe(he(r => r !== null), E(r => { let i = !1; return d(r).pipe(E(o => { if (this.navigationId > r.id)
        ...
        return this.currentTransition = r = N(h({}, o), { targetSnapshot: A, urlAfterRedirects: c, extras: N(h({}, D), { skipLocationChange: !1, replaceUrl: !1 }) }), this.currentNavigation.update(ue => (ue.finalUrl = c, ue)), d(r);
    }
    else
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=_angular_router.qYsxXmi-3p.js.map
