import { a as d } from "@nf-internal/chunk-63HOYYOF";
import { a as f } from "@nf-internal/chunk-NESBZC3K";
import { a as _ } from "@nf-internal/chunk-YACJ2ZK5";
import { b as m } from "@nf-internal/chunk-F5JC75QQ";
import { a as g, b as y, c as b, d as I, e as S, f as c, g as p, h as M } from "@nf-internal/chunk-OA2EVVL5";
...
var H = ["button", "checkbox", "file", "hidden", "image", "radio", "range", "reset", "submit"], L = new N("MAT_INPUT_CONFIG"), he = (() => { class a {
    ...
    constructor() { let e = s(q, { optional: !0 }), t = s(w, { optional: !0 }), i = s(m), n = s(f, { optional: !0, self: !0 }), o = this._elementRef.nativeElement, h = o.nodeName.toLowerCase(); n ? V(n.value) ? this._signalBasedValueAccessor = n : this._inputValueAccessor = n : this._inputValueAccessor = o, this._previousNativeValue = this.value, this.id = this.id, this._platform.IOS && this._ngZone.runOutsideAngular(() => { this._cleanupIosKeyup = this._renderer.listen(o, "keyup", this._iOSKeyupListener); }), this._errorStateTracker = new _(i, this.ngControl, t, e, this.stateChanges), this._isServer = !this._platform.isBrowser, this._isNativeSelect = h === "select", this._isTextarea = h === "textarea", this._isInFormField = !!this._formField, this.disabledInteractive = this._config?.disabledInteractive || !1, this._isNativeSelect && (this.controlType = o.multiple ? "mat-native-select-multiple" : "mat-native-select"), this._signalBasedValueAccessor && R(() => { this._signalBasedValueAccessor.value(), this.stateChanges.next(); }); }
