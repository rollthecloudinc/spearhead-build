import { a as f } from "@nf-internal/chunk-HOKO2ONL";
import { a as p } from "@nf-internal/chunk-ARUHDGKS";
import { a as g } from "@nf-internal/chunk-4UKDDKDA";
import { f as d } from "@nf-internal/chunk-O2ECDXRI";
import { a as u } from "@nf-internal/chunk-4MZRILT7";
import { b as h } from "@nf-internal/chunk-RXMLTE5A";
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    class o {
        ...
        _text;
        _stateChanges = new I;
        constructor() { let e = l(V); e.load(u), e.load(T), this._signalDisableRipple = !!this._parent && E(this._parent.disableRipple); }
...
var ut = (() => { class o {
    ...
    static \u0275inj = c.\u0275\u0275defineInjector({ imports: [g, h, f, k] });
} return o; })();
