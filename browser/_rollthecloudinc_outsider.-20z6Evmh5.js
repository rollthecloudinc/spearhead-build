...
import { CommonModule as N } from "@angular/common";
import * as e from "@angular/core";
import { ViewContainerRef as E } from "@angular/core";
import * as r from "@angular/forms";
import { Validators as u, UntypedFormControl as f, ReactiveFormsModule as w } from "@angular/forms";
import { MaterialModule as I } from "@rollthecloudinc/material";
import * as d from "@angular/material/dialog";
import { MAT_DIALOG_DATA as G } from "@angular/material/dialog";
import { Pane as O } from "@rollthecloudinc/panels";
import * as y from "@rollthecloudinc/content";
import { ContentPluginEditorOptions as j, ContentPlugin as D } from "@rollthecloudinc/content";
import { Dataset as A } from "@rollthecloudinc/datasource";
import { of as a, BehaviorSubject as h, map as g, tap as b, skip as F, switchMap as R, Observable as z } from "rxjs";
import * as c from "@rollthecloudinc/attributes";
import * as v from "@angular/material/autocomplete";
import * as M from "@angular/material/button";
import * as p from "@angular/material/input";
import * as C from "@angular/material/select";
import { loadRemoteModule as $ } from "@softarc/native-federation-runtime";
...
var q = ["appContainer"], l = class {
    ...
    fetchDynamicData(t, i) { return a(new A); }
    ...
    editorOptions(t) { return a(new j); }
    ...
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: n, selectors: [["druid-outsider-outside-app-renderer"]], viewQuery: function (i, o) { if (i & 1 && e.\u0275\u0275viewQuery(q, 7, E), i & 2) {
            let m;
...
} return n; })(), P = ({ handler: n }) => new D({ id: "outside_app", title: "Outside App", selectionComponent: void 0, editorComponent: _, renderComponent: T, handler: n }), re = (() => { class n {
    constructor(t, i) { t.register(P({ handler: i })); }
    static { this.\u0275fac = function (i) { return new (i || n)(e.\u0275\u0275inject(y.ContentPluginManager), e.\u0275\u0275inject(S)); }; }
    static { this.\u0275mod = e.\u0275\u0275defineNgModule({ type: n }); }
    static { this.\u0275inj = e.\u0275\u0275defineInjector({ imports: [N, I, w] }); }
} return n; })();
export { S as OutsideAppContentHandler, _ as OutsideAppEditorComponent, T as OutsideAppRendererComponent, l as OutsideAppSettings, re as OutsiderModule };
//# sourceMappingURL=_rollthecloudinc_outsider.-20z6Evmh5.js.map
